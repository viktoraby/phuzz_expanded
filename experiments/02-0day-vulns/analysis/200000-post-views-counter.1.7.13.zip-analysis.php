...
*Overview: {'handle_test_email_ajax': {'pvc_send_test_email'}, 'dashboard_post_views_chart': {'pvc_dashboard_post_views_chart'}, 'ajax_column_chart': {'pvc_column_chart'}, 'check_post_js': {'nopriv_pvc-check-post', 'pvc-check-post'}, 'queue_count': {'pvc-view-posts', 'nopriv_pvc-view-posts'}, 'save_bulk_post_views': {'save_bulk_post_views'}, 'dismiss_notice': {'pvc_dismiss_notice'}, 'update_dashboard_user_options': {'pvc_dashboard_user_options'}, 'dashboard_post_most_viewed': {'pvc_dashboard_post_most_viewed'}}
*
***/
