...
*Overview: {'update_options_for_inherit': {'save_settings_tab_inherit'}, 'breeze_check_the_files_permission': {'breeze_file_permission_check'}, 'compatibility_warning_close': {'compatibility_warning_close'}, 'update_options_for_heartbeat': {'save_settings_tab_heartbeat'}, 'Breeze_Configuration': {'breeze_purge_opcache', 'breeze_reset_default', 'breeze_purge_database', 'breeze_check_cdn_url'}, 'export_json_settings': {'breeze_export_json'}, 'update_options_for_tools': {'save_settings_tab_tools'}, 'update_options_for_cdn': {'save_settings_tab_cdn'}, 'Breeze_One_Click_Optimization': {'breeze_apply_optimization', 'breeze_restore_settings', 'breeze_check_compatibility', 'breeze_hide_optimization_notice'}, 'update_options_for_varnish': {'save_settings_tab_varnish'}, 'update_options_for_file': {'save_settings_tab_file'}, 'wp_ajax_breeze_purge_file': {'breeze_purge_varnish'}, 'update_options_for_advanced': {'save_settings_tab_advanced'}, 'update_options_for_basic': {'save_settings_tab_basic'}, 'update_options_for_database': {'save_settings_tab_database'}, 'store_update_count': {'store_update_count'}, 'clear_breeze_cache': {'shortpixel_ai_handle_page_action'}, 'update_options_for_faq': {'save_settings_tab_faq'}, 'breeze_woocs_fetch_currency': {'nopriv_breeze_woocs_currency_get', 'breeze_woocs_currency_get'}, 'breeze_dismiss_cache_notice': {'breeze_dismiss_cache_notice'}, 'import_json_settings': {'breeze_import_json'}, 'update_options_for_preload': {'save_settings_tab_preload'}, 'regenerate_breeze_api_key': {'refresh_api_token_key'}, 'breeze_option_tab_display': {'breeze_load_options_tab'}}
*
***/
...
/** Function Breeze_Configuration() called by wp_ajax hooks: {'breeze_purge_opcache', 'breeze_reset_default', 'breeze_purge_database', 'breeze_check_cdn_url'} **/
/** No function found :-/ **/
...
/** Function Breeze_One_Click_Optimization() called by wp_ajax hooks: {'breeze_apply_optimization', 'breeze_restore_settings', 'breeze_check_compatibility', 'breeze_hide_optimization_notice'} **/
/** No function found :-/ **/
