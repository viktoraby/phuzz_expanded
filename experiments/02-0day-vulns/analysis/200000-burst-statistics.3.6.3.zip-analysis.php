...
*Overview: {'rest_api_fallback': {'burst_autoinstaller_rest_api_fallback'}, 'rest_api_fallback_get_action': {'burst_rest_api_fallback_get_action'}, 'log_tracking_error': {'nopriv_burst_tracking_error', 'burst_tracking_error'}, 'ajax_toggle_low_traffic_auto_update': {'burst_toggle_low_traffic_auto_update'}, 'dismiss_review_notice_callback': {'dismiss_review_notice'}, 'rest_api_fallback_do_action': {'burst_rest_api_fallback_do_action'}}
*
***/
