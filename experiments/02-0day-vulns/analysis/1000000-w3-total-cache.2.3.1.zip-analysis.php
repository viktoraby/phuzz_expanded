...
*Overview: {'action_verify_plugin_license_key': {'w3tc_verify_plugin_license_key'}, 'w3tc_ajax_ustats_access_log_test': {'ustats_access_log_test'}, 'ajax_revert': {'w3tc_imageservice_revert'}, 'ajax_get_usage': {'w3tc_imageservice_usage'}, 'ajax_convert_all': {'w3tc_imageservice_all'}, 'action_cloudflare_api_request': {'w3tc_cloudflare_api_request'}, 'wp_ajax_w3tc_ajax': {'w3tc_ajax'}, 'ajax_get_counts': {'w3tc_imageservice_counts'}, 'ajax_get_postmeta': {'w3tc_imageservice_postmeta'}, 'ajax_submit': {'w3tc_imageservice_submit'}, 'action_widget_latest_news_ajax': {'w3tc_widget_latest_news_ajax'}, 'action_widget_latest_ajax': {'w3tc_widget_latest_ajax'}, 'ajax_revert_all': {'w3tc_imageservice_revertall'}}
*
***/

/** Function action_verify_plugin_license_key() called by wp_ajax hooks: {'w3tc_verify_plugin_license_key'} **/
/** No params detected :-/ **/
...
/** Function action_cloudflare_api_request() called by wp_ajax hooks: {'w3tc_cloudflare_api_request'} **/
/** No params detected :-/ **/
