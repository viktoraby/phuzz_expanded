...
*Overview: {'wpconsent_ajax_manage_cookie': {'wpconsent_manage_cookie'}, 'dismiss': {'wpconsent_notification_dismiss'}, 'wpconsent_ajax_add_category': {'wpconsent_add_category'}, 'wpconsent_ajax_save_banner_layout': {'wpconsent_save_banner_layout'}, 'wpconsent_ajax_delete_cookie': {'wpconsent_delete_cookie'}, 'wpconsent_ajax_search_pages': {'wpconsent_search_pages'}, 'ajax_toggle_setting': {'wpconsent_toggle_setting'}, 'wpconsent_ajax_verify_ssl': {'wpconsent_verify_ssl'}, 'generate_url': {'wpconsent_connect_url'}, 'ajax_add_cookie': {'wpconsent_inspector_add_cookie'}, 'ajax_save_for_review': {'wpconsent_inspector_save_for_review'}, 'wpconsent_ajax_save_scanner_items': {'wpconsent_save_scanner_items'}, 'dismiss_ajax': {'wpconsent_notice_dismiss'}, 'wpconsent_ajax_get_services': {'wpconsent_get_services'}, 'ajax_dismiss_suggestion': {'wpconsent_dismiss_suggestion'}, 'wpconsent_ajax_delete_category': {'wpconsent_delete_category'}, 'ajax_install_plugin': {'wpconsent_install_plugin'}, 'wpconsent_ajax_edit_category': {'wpconsent_edit_category'}, 'wpconsent_ajax_search_content': {'wpconsent_search_content'}, 'wpconsent_ajax_manage_service': {'wpconsent_manage_service'}, 'process': {'nopriv_wpconsent_connect_process'}, 'wpconsent_ajax_delete_service': {'wpconsent_delete_service'}, 'ajax_deactivate': {'wpconsent_inspector_deactivate'}, 'ajax_dismiss_cookie': {'wpconsent_inspector_dismiss_cookie'}, 'wpconsent_ajax_generate_cookie_policy': {'wpconsent_generate_cookie_policy'}, 'ajax_scan_page': {'wpconsent_scan_page'}, 'wpconsent_ajax_save_usage_tracking': {'wpconsent_save_usage_tracking'}, 'ajax_scan_website': {'wpconsent_scan_website'}, 'wpconsent_ajax_auto_configure': {'wpconsent_auto_configure'}, 'wpconsent_ajax_reset_to_defaults': {'wpconsent_reset_to_defaults'}, 'wpconsent_ajax_complete_onboarding': {'wpconsent_complete_onboarding'}}
*
***/
