...
*Overview: {'ctAjaxCheckUsers': {'ajax_check_users'}, 'ctAjaxTrashAll': {'ajax_trash_all'}, 'apbct_action_adjust_reverse': {'apbct_action_adjust_reverse'}, 'detailsOrderAction': {'apbct_details_spam_order'}, 'apbct_react_access_key_check': {'apbct_react_access_key_check'}, 'settingsTemplatesResetAjax': {'settings_templates_reset'}, 'ctAjaxInfo': {'ajax_info_users', 'ajax_info_comments'}, 'settingsTemplatesExportAjax': {'settings_templates_export'}, 'apbct_form__seedprod_coming_soon__testSpam': {'seed_cspv5_subscribe_callback', 'nopriv_seed_cspv5_subscribe_callback', 'seed_cspv5_contactform_callback', 'nopriv_seed_cspv5_contactform_callback'}, 'apbct_settings__get_key_auto': {'apbct_get_key_auto'}, 'apbct_comment__send_feedback': {'nopriv_ct_feedback_comment', 'ct_feedback_comment'}, 'apbct_react_send_feedback': {'apbct_react_send_feedback'}, 'apbct_react_run_adjusting_env': {'apbct_react_run_adjusting_env'}, 'ct_ajax_hook': {'wysija_ajax', 'mymail_form_submit', 'send_message', 'tmpl_submit_form_recaptcha_validation', 'nopriv_submit_form_recaptcha_validation', 'nopriv_vfb_submit', 'nopriv_tevolution_submit_from_preview', 'wpuf_submit_register', 'td_mod_register', 'nopriv_cs_registration_validation', 'cs_registration_validation', 'nopriv_frm_entries_create', 'tmpl_ajax_check_user_email', 'zn_do_login', 'nopriv_uwp_ajax_register', 'nopriv_smuzform-storage', 'tevolution_submit_from_preview', 'nopriv_tmpl_ajax_check_user_email', 'nopriv_rwp_ajax_action_rating', 'frm_entries_create', 'nopriv_request_appointment', 'nopriv_mymail_form_submit', 'nopriv_woocommerce_checkout', 'nopriv_wpuf_submit_register', 'nopriv_send_message', 'request_appointment', 'nopriv_wysija_ajax', 'vfb_submit', 'woocommerce_checkout', 'nopriv_zn_do_login', 'nopriv_td_mod_register'}, 'restoreOrderAction': {'apbct_restore_spam_order'}, 'getOptionsTemplateAjax': {'get_options_template'}, 'ct_validate_email_ajaxlogin': {'validate_email', 'nopriv_validate_email'}, 'apbct_form__inevio__testSpam': {'nopriv_contact_form_handler', 'contact_form_handler'}, 'apbct_user__send_feedback': {'nopriv_ct_feedback_user', 'ct_feedback_user'}, '\\Cleantalk\\ApbctWP\\FindSpam\\UsersChecker': {'ajax_insert_users'}, 'ctAjaxClearComments': {'ajax_clear_comments'}, 'apbct_react_sfw_update': {'apbct_react_sfw_update'}, 'apbct_settings__save_key': {'apbct_save_key'}, 'apbct_settings__update_account_email': {'apbct_update_account_email'}, 'ctAjaxCheckComments': {'ajax_check_comments'}, 'apbct_react_sync_end': {'apbct_react_sync_end'}, 'ctAjaxClearUsers': {'ajax_clear_users'}, 'apbct_settings__check_renew_banner': {'apbct_settings__check_renew_banner'}, 'apbct_form__the7_contact_form': {'nopriv_dt_send_mail', 'dt_send_mail'}, 'apbct_settings__get__long_description': {'apbct_settings__get__long_description'}, 'apbct_react_brief_data': {'apbct_react_brief_data'}, 'settingsTemplatesImportAjax': {'settings_templates_import'}, 'ajaxDecodeEmailHandler': {'apbct_decode_email', 'nopriv_apbct_decode_email'}, 'apbct_action_adjust_change': {'apbct_action_adjust_change'}, 'ctGetCsvFile': {'ajax_ct_get_csv_file'}, 'setNoticeDismissed': {'cleantalk_dismiss_notice'}, 'ctAjaxSpamAll': {'ajax_spam_all'}, 'apbct_settings__sync': {'apbct_sync'}, 'ctAjaxDeleteAllUsers': {'ajax_delete_all_users'}}
*
***/
...
/** Function apbct_form__seedprod_coming_soon__testSpam() called by wp_ajax hooks: {'seed_cspv5_subscribe_callback', 'nopriv_seed_cspv5_subscribe_callback', 'seed_cspv5_contactform_callback', 'nopriv_seed_cspv5_contactform_callback'} **/
/** No params detected :-/ **/
...
/** Function ct_ajax_hook() called by wp_ajax hooks: {'wysija_ajax', 'mymail_form_submit', 'send_message', 'tmpl_submit_form_recaptcha_validation', 'nopriv_submit_form_recaptcha_validation', 'nopriv_vfb_submit', 'nopriv_tevolution_submit_from_preview', 'wpuf_submit_register', 'td_mod_register', 'nopriv_cs_registration_validation', 'cs_registration_validation', 'nopriv_frm_entries_create', 'tmpl_ajax_check_user_email', 'zn_do_login', 'nopriv_uwp_ajax_register', 'nopriv_smuzform-storage', 'tevolution_submit_from_preview', 'nopriv_tmpl_ajax_check_user_email', 'nopriv_rwp_ajax_action_rating', 'frm_entries_create', 'nopriv_request_appointment', 'nopriv_mymail_form_submit', 'nopriv_woocommerce_checkout', 'nopriv_wpuf_submit_register', 'nopriv_send_message', 'request_appointment', 'nopriv_wysija_ajax', 'vfb_submit', 'woocommerce_checkout', 'nopriv_zn_do_login', 'nopriv_td_mod_register'} **/
...
/** Function apbct_form__the7_contact_form() called by wp_ajax hooks: {'nopriv_dt_send_mail', 'dt_send_mail'} **/
/** No params detected :-/ **/
...
/** Function ajaxDecodeEmailHandler() called by wp_ajax hooks: {'apbct_decode_email', 'nopriv_apbct_decode_email'} **/
/** No params detected :-/ **/
