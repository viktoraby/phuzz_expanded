...
*Overview: {'wordfence::ajax_lh_callback': {'wordfence_lh', 'nopriv_wordfence_lh'}, 'wordfence::ajax_doScan_callback': {'nopriv_wordfence_doScan', 'wordfence_doScan'}, 'wordfence::ajax_remoteVerifySwitchTo2FANew_callback': {'nopriv_wordfence_remoteVerifySwitchTo2FANew'}, 'wordfence::ajax_wafStatus_callback': {'wordfence_wafStatus', 'nopriv_wordfence_wafStatus'}, 'wordfence::ajax_testAjax_callback': {'wordfence_testAjax', 'nopriv_wordfence_testAjax'}}
*
***/
