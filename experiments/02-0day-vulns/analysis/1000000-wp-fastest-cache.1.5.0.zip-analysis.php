...
*Overview: {'wpfc_get_list_csp_callback': {'wpfc_get_list_csp'}, 'wpfc_cache_path_save_settings_callback': {'wpfc_cache_path_save_settings'}, 'clear_cache_column': {'wpfc_clear_cache_column'}, 'wpfc_toolbar_save_settings_callback': {'wpfc_toolbar_save_settings'}, 'wpfc_toolbar_get_settings_callback': {'wpfc_toolbar_get_settings'}, 'wpfc_start_cdn_integration_ajax_request_callback': {'wpfc_start_cdn_integration'}, 'wpfc_wppolls_ajax_request': {'wpfc_wppolls_ajax_request', 'nopriv_wpfc_wppolls_ajax_request'}, 'wpfc_clear_cache_of_allsites_callback': {'wpfc_clear_cache_of_allsites'}, 'wpfc_cdn_options_ajax_request_callback': {'wpfc_cdn_options'}, 'wpfc_db_fix_callback': {'wpfc_db_fix'}, 'wpfc_check_url_ajax_request_callback': {'wpfc_check_url'}, 'deleteCssAndJsCacheToolbar': {'wpfc_delete_cache_and_minified'}, 'wpfc_purgecache_varnish_callback': {'wpfc_purgecache_varnish'}, 'wpfc_cache_statics_get_callback': {'wpfc_cache_statics_get'}, 'deleteCacheToolbar': {'wpfc_delete_cache'}, 'wpfc_preload_single_callback': {'wpfc_preload_single'}, 'wpfc_pause_cdn_integration_ajax_request_callback': {'wpfc_pause_cdn_integration'}, 'wpfc_save_cdn_integration_ajax_request_callback': {'wpfc_save_cdn_integration'}, 'wpfc_save_csp_callback': {'wpfc_save_csp'}, 'wpfc_save_timeout_pages_callback': {'wpfc_save_timeout_pages'}, 'wpfc_pause_varnish_callback': {'wpfc_pause_varnish'}, 'wpfc_start_varnish_callback': {'wpfc_start_varnish'}, 'wpfc_cdn_template_ajax_request_callback': {'wpfc_cdn_template'}, 'wpfc_save_varnish_callback': {'wpfc_save_varnish'}, 'wpfc_preload_single_save_settings_callback': {'wpfc_preload_single_save_settings'}, 'wpfc_save_exclude_pages_callback': {'wpfc_save_exclude_pages'}, 'wpfc_db_statics_callback': {'wpfc_db_statics'}, 'wpfc_remove_varnish_callback': {'wpfc_remove_varnish'}, 'wpfc_remove_csp_callback': {'wpfc_remove_csp'}, 'wpfc_remove_cdn_integration_ajax_request_callback': {'wpfc_remove_cdn_integration'}, 'delete_current_page_cache': {'wpfc_delete_current_page_cache'}}
*
***/
...
/** Function wpfc_wppolls_ajax_request() called by wp_ajax hooks: {'wpfc_wppolls_ajax_request', 'nopriv_wpfc_wppolls_ajax_request'} **/
...
/** Parameters found in function wpfc_cdn_options_ajax_request_callback(): {"request": ["nonce"]} **/
function wpfc_cdn_options_ajax_request_callback(){
			if(!wp_verify_nonce($_REQUEST["nonce"], 'cdn-nonce')){
				die( 'Security check' );
			}
...
/** Parameters found in function wpfc_db_fix_callback(): {"request": ["nonce"], "get": ["type"]} **/
...
/** Parameters found in function wpfc_cache_statics_get_callback(): {"request": ["nonce"]} **/
function wpfc_cache_statics_get_callback(){
			if(!wp_verify_nonce($_REQUEST["nonce"], 'wpfc')){
				die( 'Security check' );
			}
