...
*Overview: {'auto_detect_forms': {'auto_detect_forms'}, 'pp_ajax_save': {'save_pp_options'}, 'iub_dismiss_general_notice': {'iubenda_dismiss_general_notice'}, 'toggle_services': {'toggle_services'}, 'ask_radar_to_send_request': {'radar_percentage_reload'}, 'quick_generator_api': {'quick_generator_api'}, 'dismiss_rating_notice': {'iubenda_dismiss_rating_notice'}, 'get_dashboard_compliance_content': {'dashboard_compliance'}, 'integrate_setup': {'integrate_setup'}, 'force_reload_radar_config': {'force_reload_radar_config'}, 'synchronize_products': {'synchronize_products'}, 'cs_ajax_save': {'save_cs_options'}, 'plugin_settings_ajax_save': {'save_plugin_settings_options'}, 'cons_ajax_save': {'save_cons_options'}, 'tc_ajax_save': {'save_tc_options'}, 'get_frontpage_main_box': {'frontpage_main_box'}, 'check_frontend_auto_blocking_by_code': {'check_frontend_auto_blocking_status'}}
*
***/
...
/** Function pp_ajax_save() called by wp_ajax hooks: {'save_pp_options'} **/
/** No params detected :-/ **/
...
/** Function toggle_services() called by wp_ajax hooks: {'toggle_services'} **/
/** No params detected :-/ **/
...
/** Function quick_generator_api() called by wp_ajax hooks: {'quick_generator_api'} **/
/** No params detected :-/ **/
...
/** Function force_reload_radar_config() called by wp_ajax hooks: {'force_reload_radar_config'} **/
/** No params detected :-/ **/
