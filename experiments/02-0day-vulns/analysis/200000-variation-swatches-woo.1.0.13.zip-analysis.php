...
*Overview: {'reset_swatches': {'cfvsw_reset_product_swatches_data'}, 'save_swatches': {'cfvsw_save_product_swatches_data'}, 'cfvsw_update_settings': {'cfvsw_update_settings'}, 'update_swatches': {'cfvsw_update_product_swatches_data'}, 'cfvsw_ajax_add_to_cart': {'cfvsw_ajax_add_to_cart', 'nopriv_cfvsw_ajax_add_to_cart'}}
*
***/
