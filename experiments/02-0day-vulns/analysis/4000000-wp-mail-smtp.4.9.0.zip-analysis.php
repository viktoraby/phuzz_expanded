...
*Overview: {'wizard_steps_started': {'wp_mail_smtp_vue_wizard_steps_started'}, 'update_settings': {'wp_mail_smtp_vue_update_settings'}, 'upgrade_plugin': {'wp_mail_smtp_vue_upgrade_plugin'}, 'ajax_snippet_code': {'wp_mail_smtp_get_wpcode_snippet_code'}, 'get_connected_data': {'wp_mail_smtp_vue_get_connected_data'}, 'send_feedback': {'wp_mail_smtp_vue_send_feedback'}, 'ajax_init_connect': {'wp_mail_smtp_sendlayer_connect'}, 'ajax_snippet_install_url': {'wp_mail_smtp_get_wpcode_snippet_install_url'}, 'process_ajax': {'wp_mail_smtp_ajax'}, 'email_domain_check_test': {'health-check-email-domain_check_test'}, 'process_ajax_delete_all_debug_events': {'wp_mail_smtp_delete_all_debug_events'}, 'notice_bar_ajax_dismiss': {'wp_mail_smtp_notice_bar_dismiss'}, 'import_settings': {'wp_mail_smtp_vue_import_settings'}, 'review_dismiss': {'wp_mail_smtp_review_dismiss'}, 'get_settings': {'wp_mail_smtp_vue_get_settings'}, 'check_mailer_configuration': {'wp_mail_smtp_vue_check_mailer_configuration'}, 'ajax_generate_url': {'wp_mail_smtp_connect_url'}, 'ajax_check_plugin_status': {'wp_mail_smtp_page_check_{$plugin}_status'}, 'process_ajax_debug_event_preview': {'wp_mail_smtp_debug_event_preview'}, 'ajax_dismiss': {'wp_mail_smtp_email_sending_errors_dismiss', 'wp_mail_smtp_activelayer_wc_dismiss'}, 'get_partner_plugins_info': {'wp_mail_smtp_vue_get_partner_plugins_info'}, 'install_plugin': {'wp_mail_smtp_vue_install_plugin'}, 'init_migrations_ajax_handler': {'nopriv_wp_mail_smtp_init_migrations'}, 'subscribe_to_newsletter': {'wp_mail_smtp_vue_subscribe_to_newsletter'}, 'process': {'nopriv_wp_mail_smtp_connect_process'}, 'dismiss': {'wp_mail_smtp_notification_dismiss'}, 'ajax_disconnect': {'wp_mail_smtp_sendlayer_disconnect'}, 'remove_oauth_connection': {'wp_mail_smtp_vue_remove_oauth_connection'}, 'get_oauth_url': {'wp_mail_smtp_vue_get_oauth_url'}}
*
***/
