...
*Overview: {'update_settings': {'wp_mail_smtp_vue_update_settings'}, 'get_connected_data': {'wp_mail_smtp_vue_get_connected_data'}, 'notice_bar_ajax_dismiss': {'wp_mail_smtp_notice_bar_dismiss'}, 'process_ajax_debug_event_preview': {'wp_mail_smtp_debug_event_preview'}, 'email_domain_check_test': {'health-check-email-domain_check_test'}, 'init_migrations_ajax_handler': {'nopriv_wp_mail_smtp_init_migrations'}, 'import_settings': {'wp_mail_smtp_vue_import_settings'}, 'ajax_snippet_code': {'wp_mail_smtp_get_wpcode_snippet_code'}, 'check_mailer_configuration': {'wp_mail_smtp_vue_check_mailer_configuration'}, 'process': {'nopriv_wp_mail_smtp_connect_process'}, 'ajax_generate_url': {'wp_mail_smtp_connect_url'}, 'review_dismiss': {'wp_mail_smtp_review_dismiss'}, 'subscribe_to_newsletter': {'wp_mail_smtp_vue_subscribe_to_newsletter'}, 'ajax_dismiss': {'wp_mail_smtp_email_sending_errors_dismiss', 'wp_mail_smtp_activelayer_wc_dismiss'}, 'process_ajax': {'wp_mail_smtp_ajax'}, 'ajax_disconnect': {'wp_mail_smtp_sendlayer_disconnect'}, 'remove_oauth_connection': {'wp_mail_smtp_vue_remove_oauth_connection'}, 'get_settings': {'wp_mail_smtp_vue_get_settings'}, 'get_oauth_url': {'wp_mail_smtp_vue_get_oauth_url'}, 'install_plugin': {'wp_mail_smtp_vue_install_plugin'}, 'get_partner_plugins_info': {'wp_mail_smtp_vue_get_partner_plugins_info'}, 'process_ajax_delete_all_debug_events': {'wp_mail_smtp_delete_all_debug_events'}, 'wizard_steps_started': {'wp_mail_smtp_vue_wizard_steps_started'}, 'ajax_snippet_install_url': {'wp_mail_smtp_get_wpcode_snippet_install_url'}, 'ajax_init_connect': {'wp_mail_smtp_sendlayer_connect'}, 'ajax_check_plugin_status': {'wp_mail_smtp_page_check_{$plugin}_status'}, 'dismiss': {'wp_mail_smtp_notification_dismiss'}, 'send_feedback': {'wp_mail_smtp_vue_send_feedback'}, 'upgrade_plugin': {'wp_mail_smtp_vue_upgrade_plugin'}}
*
***/
