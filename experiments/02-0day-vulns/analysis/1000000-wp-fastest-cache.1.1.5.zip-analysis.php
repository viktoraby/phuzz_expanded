...
*Overview: {'wpfc_save_exclude_pages_callback': {'wpfc_save_exclude_pages'}, 'wpfc_get_list_csp_callback': {'wpfc_get_list_csp'}, 'wpfc_cache_path_save_settings_callback': {'wpfc_cache_path_save_settings'}, 'wpfc_save_timeout_pages_callback': {'wpfc_save_timeout_pages'}, 'wpfc_save_cdn_integration_ajax_request_callback': {'wpfc_save_cdn_integration'}, 'wpfc_remove_cdn_integration_ajax_request_callback': {'wpfc_remove_cdn_integration'}, 'wpfc_cache_statics_get_callback': {'wpfc_cache_statics_get'}, 'wpfc_check_url_ajax_request_callback': {'wpfc_check_url'}, 'wpfc_pause_varnish_callback': {'wpfc_pause_varnish'}, 'wpfc_save_csp_callback': {'wpfc_save_csp'}, 'wpfc_pause_cdn_integration_ajax_request_callback': {'wpfc_pause_cdn_integration'}, 'wpfc_save_varnish_callback': {'wpfc_save_varnish'}, 'wpfc_toolbar_save_settings_callback': {'wpfc_toolbar_save_settings'}, 'wpfc_preload_single_callback': {'wpfc_preload_single'}, 'wpfc_start_varnish_callback': {'wpfc_start_varnish'}, 'wpfc_purgecache_varnish_callback': {'wpfc_purgecache_varnish'}, 'wpfc_toolbar_get_settings_callback': {'wpfc_toolbar_get_settings'}, 'clear_cache_column': {'wpfc_clear_cache_column'}, 'wpfc_cdn_options_ajax_request_callback': {'wpfc_cdn_options'}, 'wpfc_db_statics_callback': {'wpfc_db_statics'}, 'wpfc_start_cdn_integration_ajax_request_callback': {'wpfc_start_cdn_integration'}, 'delete_current_page_cache': {'wpfc_delete_current_page_cache'}, 'wpfc_cdn_template_ajax_request_callback': {'wpfc_cdn_template'}, 'deleteCacheToolbar': {'wpfc_delete_cache'}, 'wpfc_preload_single_save_settings_callback': {'wpfc_preload_single_save_settings'}, 'deleteCssAndJsCacheToolbar': {'wpfc_delete_cache_and_minified'}, 'wpfc_remove_varnish_callback': {'wpfc_remove_varnish'}, 'wpfc_clear_cache_of_allsites_callback': {'wpfc_clear_cache_of_allsites'}, 'wpfc_db_fix_callback': {'wpfc_db_fix'}, 'wpfc_wppolls_ajax_request': {'nopriv_wpfc_wppolls_ajax_request', 'wpfc_wppolls_ajax_request'}, 'wpfc_remove_csp_callback': {'wpfc_remove_csp'}}
*
***/
