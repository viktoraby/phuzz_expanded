...
*Overview: {'dismiss_pointer': {'eb_dismiss_pointer'}, 'wp_ajax$action': set(), 'eb_save_quick_setup': {'eb_save_quick_setup'}, 'eb_save_quick_toolbar_blocks': {'eb_save_quick_toolbar_blocks'}, 'get': {'get_eb_admin_options'}, 'save': {'save_eb_admin_options'}, 'hide_pattern_library': {'hide_pattern_library'}, 'eb_quick_setup_save_tracking': {'eb_quick_setup_save_tracking'}, 'reset': {'reset_eb_admin_options'}, 'callback': {'nopriv_$action', '$action'}, 'template_count': {'get_eb_admin_template_count'}, 'eb_admin_promotion': {'eb_admin_promotion'}, 'templates': {'get_eb_admin_templates'}}
*
***/
