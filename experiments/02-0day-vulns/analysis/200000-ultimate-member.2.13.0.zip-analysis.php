...
*Overview: {'ajax_remove_file': {'nopriv_um_remove_file', 'um_remove_file'}, 'ajax_get_packages': {'um_get_packages'}, 'load_comments': {'nopriv_um_ajax_paginate_comments', 'um_ajax_paginate_comments'}, 'update_field': {'um_update_field'}, 'same_page_update_ajax': {'um_same_page_update'}, 'ajax_muted_action': {'um_muted_action'}, 'ajax_image_upload': {'nopriv_um_imageupload', 'um_imageupload'}, 'dynamic_modal_content': {'um_dynamic_modal_content'}, 'ajax_delete_cover_photo': {'um_delete_cover_photo'}, 'search_widget_request': {'nopriv_um_search_widget_request', 'um_search_widget_request'}, 'do_ajax_action': {'um_do_ajax_action'}, 'update_builder': {'um_update_builder'}, 'ajax_delete_profile_photo': {'um_delete_profile_photo'}, 'um_request_user_data': {'um_request_user_data'}, 'update_order': {'um_update_order'}, 'populate_dropdown_options': {'um_populate_dropdown_options'}, 'dismiss_notice': {'um_dismiss_notice'}, 'ajax_select_options': {'nopriv_um_select_options', 'um_select_options'}, 'get_pages_list': {'um_get_pages_list'}, 'ajax_resize_image': {'nopriv_um_resize_image', 'um_resize_image'}, 'get_icons': {'um_get_icons'}, 'ajax_paginate': {'um_ajax_paginate'}, 'ajax_scanner': {'um_secure_scan_affected_users'}, 'ajax_run_package': {'um_run_package'}, 'ultimatemember_rated': {'um_rated'}, 'ajax_file_upload': {'nopriv_um_fileupload', 'um_fileupload'}, 'default_filter_settings': {'um_member_directory_default_filter_settings'}, 'load_posts': {'nopriv_um_ajax_paginate_posts', 'um_ajax_paginate_posts'}, 'get_users': {'um_get_users'}, 'ajax_get_members': {'nopriv_um_get_members', 'um_get_members'}}
*
***/
...
/** Function search_widget_request() called by wp_ajax hooks: {'nopriv_um_search_widget_request', 'um_search_widget_request'} **/
...
/** Function load_posts() called by wp_ajax hooks: {'nopriv_um_ajax_paginate_posts', 'um_ajax_paginate_posts'} **/
