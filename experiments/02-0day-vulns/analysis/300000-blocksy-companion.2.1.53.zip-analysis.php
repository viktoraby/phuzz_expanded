...
*Overview: {'blocksy_companion_get_trending_posts': {'blocksy_get_trending_posts', 'nopriv_blocksy_get_trending_posts'}, 'implement_user_registration': {'blc_implement_user_registration', 'nopriv_blc_implement_user_registration'}, 'get_lists': {'blocksy_ext_newsletter_subscribe_maybe_get_lists'}, 'conditions': {'blc_retrieve_conditions_data'}, 'edit_theme_options': {'blocksy_fs_connect_again'}, 'implement_user_login': {'blc_implement_user_login', 'nopriv_blc_implement_user_login'}, 'dashboard': {'blocksy_dashboard_handle_incorrect_license'}, 'save_credentials': {'blocksy_ext_newsletter_subscribe_maybe_save_credentials'}, 'manage_options': {'blocksy_customizer_import', 'blocksy_blocks_retrieve_breadcrumbs_data_descriptor', 'blocksy_blocks_retrieve_dynamic_data_descriptor', 'blocksy_customizer_copy_options', 'blocksy_customizer_wipe_caches', 'blocksy_get_terms_block_patterns', 'blocksy_dynamic_data_block_custom_field_data', 'blocksy_get_posts_block_patterns'}, 'implement_user_lostpassword': {'nopriv_blc_implement_user_lostpassword', 'blc_implement_user_lostpassword'}, 'load_cookies_consent_scripts': {'blocksy_companion_load_cookies_consent_scripts', 'nopriv_blocksy_companion_load_cookies_consent_scripts'}, 'nonce': {'blocksy_customizer_export'}, 'newsletter_subscribe_process_ajax_subscribe': {'blc_newsletter_subscribe_process_ajax_subscribe', 'nopriv_blc_newsletter_subscribe_process_ajax_subscribe'}, 'edit_posts': {'blocksy_get_posts_block_data', 'blocksy_get_dynamic_block_view', 'blocksy_get_tax_block_data'}, 'get_actual_lists': {'blocksy_ext_newsletter_subscribe_get_actual_lists'}}
*
***/
...
/** Function manage_options() called by wp_ajax hooks: {'blocksy_customizer_import', 'blocksy_blocks_retrieve_breadcrumbs_data_descriptor', 'blocksy_blocks_retrieve_dynamic_data_descriptor', 'blocksy_customizer_copy_options', 'blocksy_customizer_wipe_caches', 'blocksy_get_terms_block_patterns', 'blocksy_dynamic_data_block_custom_field_data', 'blocksy_get_posts_block_patterns'} **/
/** No function found :-/ **/
...
/** Function edit_posts() called by wp_ajax hooks: {'blocksy_get_posts_block_data', 'blocksy_get_dynamic_block_view', 'blocksy_get_tax_block_data'} **/
/** No function found :-/ **/
