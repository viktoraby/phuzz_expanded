...
*Overview: {'cff_deactivate_license': {'cff_deactivate_license'}, 'preview': {'sb_facebookfeed_divi_preview'}, 'create_temp_user_ajax_call': {'cff_create_temp_user'}, 'cff_lite_dismiss': {'cff_lite_dismiss'}, 'review_notice_consent': {'cff_review_notice_consent_update'}, 'CustomFacebookFeed\\Builder\\CFF_Feed_Saver_Manager': {'cff_feed_saver_manager_importer', 'cff_feed_saver_manager_delete_feeds', 'cff_feed_saver_manager_get_feed_list_page', 'cff_feed_saver_manager_clear_single_feed_cache', 'cff_feed_saver_manager_get_locations_page', 'cff_feed_saver_manager_fly_preview', 'cff_feed_saver_manager_retrieve_comments', 'cff_feed_saver_manager_delete_source', 'cff_feed_saver_manager_get_feed_settings', 'cff_feed_saver_manager_builder_update', 'cff_feed_saver_manager_duplicate_feed'}, 'cff_deactivate_addon': {'cff_deactivate_addon'}, 'disable_facebook_oembed': {'disable_facebook_oembed'}, 'oembed_connect_init': {'cff_oembed_connect_init'}, 'install_plugin': {'am_recommended_block_install'}, 'cff_review_notice_dismiss': {'cff_review_notice_dismiss'}, 'dismiss': {'cff_dashboard_notification_dismiss'}, 'cff_export_settings_json': {'cff_export_settings_json'}, 'ajax_record_event': {'cff_smash_usage_record_event'}, 'delete_temp_user_ajax_call': {'cff_delete_temp_user'}, 'cff_clear_cache': {'cff_clear_cache'}, 'process_wizard_data': {'cff_feed_saver_manager_process_wizard'}, 'handle_ajax': {'sb_feature_suggestion', 'sb_deactivation_feedback'}, 'cff_deactivate_extension_license': {'cff_deactivate_extension_license'}, 'cff_activate_addon': {'cff_activate_addon'}, 'cff_dismiss_custom_cssjs_notice': {'cff_dismiss_custom_cssjs_notice'}, 'cff_activate_license': {'cff_activate_license'}, 'cff_import_settings_json': {'cff_import_settings_json'}, 'ajax_record_session': {'cff_smash_usage_record_session'}, 'CustomFacebookFeed\\Builder\\CFF_Feed_Builder': {'sb_other_plugins_modal', 'cff_dismiss_onboarding'}, 'cff_oembed_disable': {'cff_oembed_disable'}, 'dismiss_critical_notice': {'cff_dismiss_critical_notice'}, 'cff_ppca_token_check_flag': {'cff_ppca_token_check_flag'}, 'cff_clear_image_resize_cache': {'cff_clear_image_resize_cache'}, 'cff_install_addon': {'cff_install_addon'}, 'cff_test_connection': {'cff_test_connection'}, 'cff_dpa_reset': {'cff_dpa_reset'}, 'cff_feed_locator': {'feed_locator', 'nopriv_feed_locator'}, 'dismiss_wizard': {'cff_feed_saver_manager_dismiss_wizard'}, 'CustomFacebookFeed\\Builder\\CFF_Source': {'cff_source_builder_update', 'cff_source_builder_update_multiple', 'cff_source_get_page', 'cff_source_get_playlist_post_preview', 'cff_source_get_featured_post_preview'}, 'cff_activate_extension_license': {'cff_activate_extension_license'}, 'disable_instagram_oembed': {'disable_instagram_oembed'}, 'handle_unused_feed_usage': {'cff_reset_unused_feed_usage'}, 'cff_save_settings': {'cff_save_settings'}, 'CustomFacebookFeed\\Admin\\CFF_Upgrader': {'cff_maybe_upgrade_redirect', 'nopriv_cff_run_one_click_upgrade'}, 'dismiss_upgrade_notice': {'cff_dismiss_upgrade_notice'}}
*
***/
...
/** Function CustomFacebookFeed\Builder\CFF_Feed_Saver_Manager() called by wp_ajax hooks: {'cff_feed_saver_manager_importer', 'cff_feed_saver_manager_delete_feeds', 'cff_feed_saver_manager_get_feed_list_page', 'cff_feed_saver_manager_clear_single_feed_cache', 'cff_feed_saver_manager_get_locations_page', 'cff_feed_saver_manager_fly_preview', 'cff_feed_saver_manager_retrieve_comments', 'cff_feed_saver_manager_delete_source', 'cff_feed_saver_manager_get_feed_settings', 'cff_feed_saver_manager_builder_update', 'cff_feed_saver_manager_duplicate_feed'} **/
/** No function found :-/ **/
...
/** Function cff_feed_locator() called by wp_ajax hooks: {'feed_locator', 'nopriv_feed_locator'} **/
...
/** Function CustomFacebookFeed\Builder\CFF_Source() called by wp_ajax hooks: {'cff_source_builder_update', 'cff_source_builder_update_multiple', 'cff_source_get_page', 'cff_source_get_playlist_post_preview', 'cff_source_get_featured_post_preview'} **/
/** No function found :-/ **/
...
/** Function CustomFacebookFeed\Admin\CFF_Upgrader() called by wp_ajax hooks: {'cff_maybe_upgrade_redirect', 'nopriv_cff_run_one_click_upgrade'} **/
/** No function found :-/ **/
