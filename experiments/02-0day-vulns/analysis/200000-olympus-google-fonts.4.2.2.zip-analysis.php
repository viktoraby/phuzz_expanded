...
*Overview: {'ajax_save_typekit_key': {'ogf_save_typekit_key'}, 'ajax_refresh_typekit': {'ogf_refresh_typekit'}, 'ajax_reset_all_fonts': {'ogf_reset_all_fonts'}, 'ajax_save_custom_font': {'ogf_save_custom_font'}, 'ajax_delete_custom_font': {'ogf_delete_custom_font'}, 'dismiss_guide': {'ogf_dismiss_guide'}, 'ajax_toggle_typekit_kit': {'ogf_toggle_typekit_kit'}, 'ajax_clear_font_cache': {'ogf_clear_font_cache'}, 'ajax_save_font_loading': {'ogf_save_font_loading'}, 'dismiss_notice': {'ogf_dismiss_notice'}, 'ajax_save_settings': {'ogf_save_settings'}}
*
***/
