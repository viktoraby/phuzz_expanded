...
*Overview: {'elementskit_admin_action': {'ekit_admin_action'}, 'generate_navigation_markup': {'generate_navigation_markup'}, 'elementskit_onboard_plugins': {'ekit_onboard_plugins'}, 'handle_feedback': {'elementskit_deactivation_feedback'}, 'handle_dismiss': {'elementskit_dismiss_auto_install_notice'}, 'ask_me_later_message': {'wpmet_rating_ask_me_later_message'}, 'handle_confirm': {'elementskit_confirm_auto_install_notice'}, 'never_show_message': {'wpmet_rating_never_show_message'}, 'dismiss_ajax_call': {'wpmet-notices'}, 'ekit_widgetarea_content': {'ekit_widgetarea_content', 'nopriv_ekit_widgetarea_content'}}
*
***/
...
/** Function handle_dismiss() called by wp_ajax hooks: {'elementskit_dismiss_auto_install_notice'} **/
/** No params detected :-/ **/
...
/** Function handle_confirm() called by wp_ajax hooks: {'elementskit_confirm_auto_install_notice'} **/
/** No params detected :-/ **/
