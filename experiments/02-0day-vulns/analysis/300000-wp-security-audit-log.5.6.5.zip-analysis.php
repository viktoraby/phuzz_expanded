...
*Overview: {'store_old_cliet_data': {'mainwp_clients_add_client'}, 'ajax_get_all_event_types': {'wsal_ajax_get_all_event_types'}, 'reset_settings': {'wsal_reset_settings'}, 'ajax_get_all_cpts': {'AjaxGetAllCPT'}, 'ajax_disable_custom_field': {'AjaxDisableCustomField'}, 'ajax_check_security_token': {'AjaxCheckSecurityToken'}, 'dismiss_setup_modal': {'wsal_dismiss_setup_modal'}, 'dismiss_upgrade_notice': {'wsal_dismiss_upgrade_notice'}, '\\WSAL\\Writers\\CSV_Writer': {'wsal_export_csv_results'}, 'dismiss_learndash_update_notice': {'dismiss_learndash_update_notice'}, 'manage_options': {'wsal_settings_get_posts_titles', 'wsal_settings_get_sites', 'wsal_settings_get_ips', 'wsal_settings_get_users', 'wsal_settings_get_posts', 'wsal_settings_get_roles', 'wsal_settings_get_posts_ids'}, 'ajax_switch_db': {'AjaxSwitchDB'}, 'dismiss_melapress_survey': {'dismiss_melapress_survey'}, 'dismiss_missing_aws_sdk_nudge': {'wsal_dismiss_missing_aws_sdk_nudge'}, 'dismiss_wp_pointer': {'wsal_dismiss_wp_pointer'}, 'ajax_retrieve_events_manually': {'retrieve_events_manually'}, 'setup_check_security_token': {'setup_check_security_token'}, 'ajax_get_all_roles': {'AjaxGetAllRoles'}, 'on_destroy_user_session': {'destroy-sessions'}, 'ajax_get_all_severities': {'wsal_ajax_get_all_severities'}, 'ajax_get_all_object_types': {'wsal_ajax_get_all_object_types'}, 'save_settings_ajax': {'notifications_data_save'}, 'take_melapress_survey': {'take_melapress_survey'}, 'ajax_run_cleanup': {'AjaxRunCleanup'}, 'ajax_get_all_users': {'AjaxGetAllUsers'}, 'dismiss_ebook_notice': {'wsal_dismiss_ebook_notice'}, 'dismiss_helper_plugin_needed_nudge': {'wsal_dismiss_helper_plugin_needed_nudge'}, 'store_slack_api_key_ajax': {'wsal_store_slack_api_key'}, 'dismiss_feature_highlight_notice': {'wsal_dismiss_feature_highlight_notice'}, 'wsal_download_failed_login_log': {'wsal_download_failed_login_log'}, 'ajax_get_all_stati': {'AjaxGetAllStatuses'}, 'ajax_search_site': {'AjaxSearchSite'}, 'ajax_get_all_event_ids': {'wsal_ajax_get_all_event_ids'}, 'send_daily_summary': {'send_daily_summary_now'}, 'dismiss_black_friday': {'dismiss_black_friday'}, 'purge_activity': {'wsal_purge_activity'}, 'ajax_dismiss_notice': {'AjaxDismissNotice'}, 'store_twilio_api_key_ajax': {'wsal_store_twilio_api_key'}, 'send_test_email': {'wsal_send_notifications_test_email'}, 'process_report_download': {'wsal_report_download'}, 'run_addon_install': {'wsal_run_addon_install'}, 'dismiss_notice_addon_available': {'wsal_dismiss_notice_addon_available'}, 'AjaxInspector': {'AjaxInspector'}, 'dismiss_yearly_survey': {'dismiss_yearly_survey'}, 'ajax_disable_by_code': {'AjaxDisableByCode'}}
*
***/
...
/** Function manage_options() called by wp_ajax hooks: {'wsal_settings_get_posts_titles', 'wsal_settings_get_sites', 'wsal_settings_get_ips', 'wsal_settings_get_users', 'wsal_settings_get_posts', 'wsal_settings_get_roles', 'wsal_settings_get_posts_ids'} **/
/** No function found :-/ **/
