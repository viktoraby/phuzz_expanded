...
*Overview: {'ajax_edit': {'blc_edit'}, 'ajax_dashboard_status': {'blc_dashboard_status'}, 'ajax_unlink': {'blc_unlink'}, 'ajax_undismiss': {'blc_undismiss'}, 'ajax_recheck': {'blc_recheck'}, 'ajax_full_status': {'blc_full_status'}, 'ajax_discard': {'blc_discard'}, 'ajax_current_load': {'blc_current_load'}, 'ajax_link_details': {'blc_link_details'}, 'ajax_dismiss': {'blc_dismiss'}, 'ajax_work': {'blc_work'}, 'dismiss_multisite_notification': {'wpmudev_blc_multisite_notification_dismiss'}, 'ajax_deredirect': {'blc_deredirect'}}
*
***/
