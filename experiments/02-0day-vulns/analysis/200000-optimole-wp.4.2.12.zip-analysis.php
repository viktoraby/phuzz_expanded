...
*Overview: {'dismiss_license_notice': {'themeisle_sdk_dismiss_license_notice'}, 'dismiss': {'themeisle_sdk_dismiss_notice'}, 'replace_file': {'optml_replace_file'}, 'dismiss_promotion': {'tisdk_update_option'}, 'ThemeisleSDK\\Modules\\Notification::dismiss': {'themeisle_sdk_dismiss_notice'}, 'dismiss_notice': {'optml_dismiss_conflict_notice'}, 'fetch_logs_ajax_handler': {'optml_fetch_logs'}, 'disable_notification_ajax': {'themeisle_sdk_dismiss_black_friday_notice'}}
*
***/
