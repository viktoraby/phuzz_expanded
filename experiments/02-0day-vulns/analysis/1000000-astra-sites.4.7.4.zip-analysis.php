...
*Overview: {'import_block_categories': {'astra-sites-import-block-categories'}, 'sse_import': {'astra-wxr-import'}, 'get_all_categories_and_tags': {'astra-sites-get-all-categories-and-tags'}, 'bsf_analytics_optin_status': {'astra_sites_usage_optin_status'}, 'import_sites': {'astra-sites-import-sites'}, 'activate_plugin': {'ast_block_templates_activate_plugin'}, 'import_prepare_xml': {'astra-sites-import_prepare_xml'}, 'toggle_assistant_status_ajax': {'zip_ai_toggle_assistant_status_ajax'}, 'blocks_requests_count': {'astra-sites-get-blocks-request-count'}, 'hide_notices': {'ast_block_templates_hide_notices'}, 'save_user_details': {'ast-block-templates-ai-content'}, 'skip_spectra_pro_onboarding': {'ast_skip_zip_ai_onboarding'}, 'import_cart_abandonment_recovery': {'astra-sites-import-cart-abandonment-recovery'}, 'disabler_ajax': {'zip_ai_disabler_ajax'}, 'generate_ai_content': {'ast-block-templates-regenerate'}, 'import_all_categories_and_tags': {'astra-sites-import-all-categories-and-tags'}, 'send_plugin_deactivate_feedback': {'uds_plugin_deactivate_feedback'}, 'get_color_palette': {'ast_block_templates_color_palette'}, 'get_all_categories': {'astra-sites-get-all-categories'}, 'get_fresh_credit_details': {'zip_ai_get_fresh_credit_details'}, 'ajax_import_sites': {'ast-block-templates-import-sites'}, 'dismiss_woopayments_notice': {'dismiss_woopayments_notice'}, 'reset_business_details': {'ast-block-templates-reset-business-details'}, 'import_template_kit': {'ast_block_templates_import_template_kit'}, 'save_page_builder_on_ajax': {'astra-sites-change-page-builder'}, 'import_wpforms': {'ast_block_templates_import_wpforms', 'astra-sites-import-wpforms'}, 'import_latepoint': {'astra-sites-import-latepoint'}, 'import_page_builders': {'astra-sites-import-page-builders'}, 'import_blocks': {'astra-sites-import-blocks'}, 'handle_dismiss_notice_ajax': {'dismiss_gs_notice'}, 'download_selected_image': {'astra-sites-download-image'}, 'dismiss_ai_promotion': {'astra-sites-dismiss-ai-promotion'}, 'import_all_categories': {'astra-sites-import-all-categories'}, 'update_library_complete': {'astra-sites-update-library-complete'}, 'import_block': {'ast_block_templates_import_block'}, 'ajax_sites_requests_count': {'ast-block-templates-get-sites-request-count'}, 'update_library': {'astra-sites-update-library'}, 'api_request': {'ast_block_templates_data_option'}, 'verify_authenticity': {'zip_ai_verify_authenticity'}, 'verify_required_plugins': {'astra-sites-verify-required-plugins'}, 'zipwp_insert_image': {'zipwp_images_insert_image'}, 'ajax_import_blocks': {'ast-block-templates-import-blocks'}, 'set_woopayments_analytics': {'astra_sites_set_woopayments_analytics'}, 'template_importer': {'ast_block_templates_importer', 'ast_block_templates_kit_importer'}, 'sync_via_ajax': {'ast-block-templates-check-sync-library-status'}, 'import_sureforms': {'ast_block_templates_import_sureforms'}, 'track_onboarding_step': {'astra_sites_track_onboarding_step'}, 'get_all_sites': {'astra-sites-get-all-sites'}, 'get_latest_credit_details': {'zip_ai_get_latest_credit_details'}, 'dismiss_notice': {'astra-notice-dismiss'}, 'sites_requests_count': {'astra-sites-get-sites-request-count'}, 'save_auto_open_setting': {'ast_block_templates_save_auto_open_setting'}, 'enable_other_builders': {'astra-sites-show-other-builders'}, 'import_cartflows': {'astra-sites-import-cartflows'}}
*
***/
