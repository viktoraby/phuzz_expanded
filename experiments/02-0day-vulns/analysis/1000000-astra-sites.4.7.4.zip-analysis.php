...
*Overview: {'get_latest_credit_details': {'zip_ai_get_latest_credit_details'}, 'ajax_sites_requests_count': {'ast-block-templates-get-sites-request-count'}, 'import_page_builders': {'astra-sites-import-page-builders'}, 'import_template_kit': {'ast_block_templates_import_template_kit'}, 'import_wpforms': {'ast_block_templates_import_wpforms', 'astra-sites-import-wpforms'}, 'verify_authenticity': {'zip_ai_verify_authenticity'}, 'verify_required_plugins': {'astra-sites-verify-required-plugins'}, 'template_importer': {'ast_block_templates_kit_importer', 'ast_block_templates_importer'}, 'get_all_categories': {'astra-sites-get-all-categories'}, 'get_all_categories_and_tags': {'astra-sites-get-all-categories-and-tags'}, 'update_library_complete': {'astra-sites-update-library-complete'}, 'activate_plugin': {'ast_block_templates_activate_plugin'}, 'download_selected_image': {'astra-sites-download-image'}, 'reset_business_details': {'ast-block-templates-reset-business-details'}, 'get_all_sites': {'astra-sites-get-all-sites'}, 'import_blocks': {'astra-sites-import-blocks'}, 'get_fresh_credit_details': {'zip_ai_get_fresh_credit_details'}, 'import_block_categories': {'astra-sites-import-block-categories'}, 'sse_import': {'astra-wxr-import'}, 'track_onboarding_step': {'astra_sites_track_onboarding_step'}, 'toggle_assistant_status_ajax': {'zip_ai_toggle_assistant_status_ajax'}, 'hide_notices': {'ast_block_templates_hide_notices'}, 'save_user_details': {'ast-block-templates-ai-content'}, 'import_block': {'ast_block_templates_import_block'}, 'ajax_import_blocks': {'ast-block-templates-import-blocks'}, 'import_sureforms': {'ast_block_templates_import_sureforms'}, 'blocks_requests_count': {'astra-sites-get-blocks-request-count'}, 'sites_requests_count': {'astra-sites-get-sites-request-count'}, 'disabler_ajax': {'zip_ai_disabler_ajax'}, 'set_woopayments_analytics': {'astra_sites_set_woopayments_analytics'}, 'dismiss_woopayments_notice': {'dismiss_woopayments_notice'}, 'handle_dismiss_notice_ajax': {'dismiss_gs_notice'}, 'generate_ai_content': {'ast-block-templates-regenerate'}, 'zipwp_insert_image': {'zipwp_images_insert_image'}, 'dismiss_ai_promotion': {'astra-sites-dismiss-ai-promotion'}, 'import_prepare_xml': {'astra-sites-import_prepare_xml'}, 'import_all_categories_and_tags': {'astra-sites-import-all-categories-and-tags'}, 'skip_spectra_pro_onboarding': {'ast_skip_zip_ai_onboarding'}, 'import_latepoint': {'astra-sites-import-latepoint'}, 'api_request': {'ast_block_templates_data_option'}, 'save_auto_open_setting': {'ast_block_templates_save_auto_open_setting'}, 'import_all_categories': {'astra-sites-import-all-categories'}, 'dismiss_notice': {'astra-notice-dismiss'}, 'import_cartflows': {'astra-sites-import-cartflows'}, 'save_page_builder_on_ajax': {'astra-sites-change-page-builder'}, 'send_plugin_deactivate_feedback': {'uds_plugin_deactivate_feedback'}, 'enable_other_builders': {'astra-sites-show-other-builders'}, 'bsf_analytics_optin_status': {'astra_sites_usage_optin_status'}, 'import_cart_abandonment_recovery': {'astra-sites-import-cart-abandonment-recovery'}, 'sync_via_ajax': {'ast-block-templates-check-sync-library-status'}, 'get_color_palette': {'ast_block_templates_color_palette'}, 'update_library': {'astra-sites-update-library'}, 'ajax_import_sites': {'ast-block-templates-import-sites'}, 'import_sites': {'astra-sites-import-sites'}}
*
***/
