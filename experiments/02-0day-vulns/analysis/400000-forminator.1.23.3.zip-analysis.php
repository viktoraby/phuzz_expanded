...
*Overview: {'save_import_form_gravity': {'forminator_save_import_form_gravity_popup'}, 'save_appearance_preset': {'forminator_save_appearance_preset'}, 'process_action': {'wpmudev_notices_action'}, 'dismiss_admin_notice': {'forminator_dismiss_notice'}, 'save_dashboard_settings': {'forminator_save_dashboard_settings_popup'}, 'delete_poll_submissions': {'forminator_delete_poll_submissions'}, 'promote_remind_later': {'forminator_promote_remind_later'}, 'save_uninstall_form': {'forminator_save_uninstall_settings_popup'}, 'load_import_form_ninja': {'forminator_load_import_form_ninja_popup'}, 'search_users': {'forminator_search_users'}, 'load_export': {'forminator_load_export_form_popup', 'forminator_load_export_poll_popup', 'forminator_load_export_quiz_popup'}, 'clear_exports': {'forminator_clear_exports_popup'}, 'preview_module': {'forminator_load_preview_quizzes_popup', 'forminator_load_preview_cforms_popup', 'forminator_load_preview_polls_popup'}, 'save_accessibility_settings': {'forminator_save_accessibility_settings_popup'}, 'update_payment_amount': {'forminator_update_payment_amount', 'nopriv_forminator_update_payment_amount'}, 'get_avatar': {'forminator_get_avatar'}, 'load_privacy_settings': {'forminator_load_privacy_settings_popup'}, 'save_poll_form': {'forminator_save_poll'}, 'save_import_form_cf7': {'forminator_save_import_form_cf7_popup'}, 'load_captcha': {'forminator_load_captcha_popup'}, 'save_quiz': {'forminator_save_quiz_knowledge', 'forminator_save_quiz_nowrong'}, 'paypal_update_page': {'forminator_paypal_update_page'}, 'addons_page_actions': {'$action'}, 'paypal_settings_modal': {'forminator_paypal_settings_modal'}, 'stripe_settings_modal': {'forminator_stripe_settings_modal'}, 'save_report': {'forminator_save_report'}, 'dismiss_welcome': {'nopriv_forminator_dismiss_welcome', 'forminator_dismiss_welcome'}, 'get_nonce': {'forminator_get_nonce', 'nopriv_forminator_get_nonce'}, 'save_pagination_listings': {'forminator_save_pagination_listings_popup'}, 'stripe_disconnect': {'forminator_disconnect_stripe'}, 'save_captcha': {'forminator_save_captcha_popup'}, 'get_module_addons': {'forminator_addon_get_module_addons'}, 'load_pagination_entries': {'forminator_load_pagination_entries_popup'}, 'delete_unconfirmed_user': {'forminator_delete_unconfirmed_user_popup'}, 'module_search': {'forminator_module_search'}, 'stripe_update_page': {'forminator_stripe_update_page'}, 'apply_appearance_preset': {'forminator_apply_appearance_preset'}, 'load_import': {'forminator_load_import_poll_popup', 'forminator_load_import_form_popup', 'forminator_load_import_quiz_popup'}, 'load_import_form_gravity': {'forminator_load_import_form_gravity_popup'}, 'hubspot_support_request': {'forminator_hubspot_support_request'}, 'dismiss_notice': {'forminator_dismiss_notification'}, 'resend_activation_link': {'forminator_resend_activation_link'}, 'update_report_status': {'forminator_report_update_status'}, 'load_pagination_listings': {'forminator_load_pagination_listings_popup'}, 'load_exports': {'forminator_load_exports_popup'}, 'reset_tracking_data': {'forminator_reset_tracking_data'}, 'Forminator_Poll_Front': {'nopriv_forminator_load_poll', 'forminator_load_poll'}, 'approve_user': {'forminator_approve_user_popup'}, 'deactivate': {'forminator_addon_deactivate'}, 'load_currency': {'forminator_load_currency_popup'}, 'save_currency': {'forminator_save_currency_popup'}, 'refresh_email_lists': {'forminator_refresh_email_lists'}, 'save_login': {'forminator_save_login'}, 'module_settings': {'forminator_addon_module_settings'}, 'Forminator_QForm_Front': {'forminator_load_quiz', 'nopriv_forminator_reload_quiz', 'nopriv_forminator_load_quiz', 'forminator_reload_quiz'}, 'load_uninstall_form': {'forminator_load_uninstall_settings_popup'}, 'later_notice': {'forminator_later_notification'}, 'load_email_form': {'forminator_load_email_settings_popup'}, 'delete_appearance_preset': {'forminator_delete_appearance_preset'}, 'load_import_form_cf7': {'forminator_load_import_form_cf7_popup'}, 'fallback_email': {'forminator_2fa_fallback_email', 'nopriv_forminator_2fa_fallback_email'}, 'Forminator_CForm_Front': {'nopriv_forminator_load_form', 'forminator_load_form'}, 'get_addons': {'forminator_addon_get_addons'}, 'resend_notification_email': {'forminator_resend_notification_email'}, 'save_pagination_entries': {'forminator_save_pagination_entries_popup'}, 'save_privacy_settings': {'forminator_save_privacy_settings_popup'}, 'save_import_form_ninja': {'forminator_save_import_form_ninja_popup'}, 'load_recaptcha_preview': {'forminator_load_recaptcha_preview'}, 'save_import': {'forminator_save_import_form_popup', 'forminator_save_import_quiz_popup', 'forminator_save_import_poll_popup'}, 'search_emails': {'forminator_builder_search_emails'}, 'save_payments': {'forminator_save_payments_settings_popup'}, 'load_hcaptcha_preview': {'forminator_load_hcaptcha_preview'}, 'settings': {'forminator_addon_settings'}, 'create_appearance_preset': {'forminator_create_appearance_preset'}, 'save_builder': {'forminator_save_builder'}, 'save_register': {'forminator_save_register'}, 'deactivate_for_module': {'forminator_addon_deactivate_for_module'}, 'paypal_disconnect': {'forminator_disconnect_paypal'}, 'load_google_fonts': {'forminator_load_google_fonts'}, 'create_paypal_order': {'nopriv_forminator_pp_create_order', 'forminator_pp_create_order'}, 'ajax_group_interests': {'forminator_mailchimp_get_group_interests'}, 'multiple_file_upload': {'nopriv_forminator_multiple_file_upload', 'forminator_multiple_file_upload'}, 'submit_email_draft_link': {'forminator_email_draft_link', 'nopriv_forminator_email_draft_link'}, 'fetch_report': {'forminator_fetch_report'}, 'filter_report_data': {'forminator_filter_report_data'}}
*
***/
...
/** Function Forminator_CForm_Front() called by wp_ajax hooks: {'nopriv_forminator_load_form', 'forminator_load_form'} **/
/** No function found :-/ **/
...
/** Function save_import() called by wp_ajax hooks: {'forminator_save_import_form_popup', 'forminator_save_import_quiz_popup', 'forminator_save_import_poll_popup'} **/
