...
*Overview: {'settingsTemplatesImportAjax': {'settings_templates_import'}, 'ctAjaxCheckComments': {'ajax_check_comments'}, 'apbct_settings__sync': {'apbct_sync'}, 'apbct_form__seedprod_coming_soon__testSpam': {'seed_cspv5_contactform_callback', 'nopriv_seed_cspv5_contactform_callback', 'seed_cspv5_subscribe_callback', 'nopriv_seed_cspv5_subscribe_callback'}, 'apbct_action_adjust_change': {'apbct_action_adjust_change'}, 'ajaxDecodeEmailHandler': {'nopriv_apbct_decode_email', 'apbct_decode_email'}, 'ct_validate_email_ajaxlogin': {'validate_email', 'nopriv_validate_email'}, 'apbct_react_sync_end': {'apbct_react_sync_end'}, 'ctAjaxTrashAll': {'ajax_trash_all'}, 'apbct_comment__send_feedback': {'ct_feedback_comment', 'nopriv_ct_feedback_comment'}, 'ct_ajax_hook': {'nopriv_rwp_ajax_action_rating', 'nopriv_zn_do_login', 'nopriv_td_mod_register', 'nopriv_smuzform-storage', 'nopriv_submit_form_recaptcha_validation', 'tmpl_ajax_check_user_email', 'nopriv_tmpl_ajax_check_user_email', 'nopriv_cs_registration_validation', 'nopriv_send_message', 'nopriv_woocommerce_checkout', 'woocommerce_checkout', 'nopriv_uwp_ajax_register', 'nopriv_wpuf_submit_register', 'vfb_submit', 'nopriv_tevolution_submit_from_preview', 'nopriv_wysija_ajax', 'wysija_ajax', 'tevolution_submit_from_preview', 'nopriv_mymail_form_submit', 'nopriv_request_appointment', 'cs_registration_validation', 'nopriv_vfb_submit', 'request_appointment', 'wpuf_submit_register', 'mymail_form_submit', 'send_message', 'tmpl_submit_form_recaptcha_validation', 'zn_do_login', 'td_mod_register', 'nopriv_frm_entries_create', 'frm_entries_create'}, 'detailsOrderAction': {'apbct_details_spam_order'}, 'apbct_form__inevio__testSpam': {'nopriv_contact_form_handler', 'contact_form_handler'}, 'getOptionsTemplateAjax': {'get_options_template'}, 'apbct_react_access_key_check': {'apbct_react_access_key_check'}, 'apbct_react_sfw_update': {'apbct_react_sfw_update'}, 'ctAjaxCheckUsers': {'ajax_check_users'}, '\\Cleantalk\\ApbctWP\\FindSpam\\UsersChecker': {'ajax_insert_users'}, 'apbct_settings__get__long_description': {'apbct_settings__get__long_description'}, 'apbct_react_run_adjusting_env': {'apbct_react_run_adjusting_env'}, 'apbct_settings__update_account_email': {'apbct_update_account_email'}, 'ctAjaxSpamAll': {'ajax_spam_all'}, 'ctAjaxInfo': {'ajax_info_comments', 'ajax_info_users'}, 'ctAjaxClearComments': {'ajax_clear_comments'}, 'apbct_react_brief_data': {'apbct_react_brief_data'}, 'apbct_react_send_feedback': {'apbct_react_send_feedback'}, 'apbct_settings__get_key_auto': {'apbct_get_key_auto'}, 'apbct_action_adjust_reverse': {'apbct_action_adjust_reverse'}, 'ctAjaxClearUsers': {'ajax_clear_users'}, 'setNoticeDismissed': {'cleantalk_dismiss_notice'}, 'apbct_settings__check_renew_banner': {'apbct_settings__check_renew_banner'}, 'settingsTemplatesExportAjax': {'settings_templates_export'}, 'settingsTemplatesResetAjax': {'settings_templates_reset'}, 'apbct_form__the7_contact_form': {'nopriv_dt_send_mail', 'dt_send_mail'}, 'apbct_user__send_feedback': {'nopriv_ct_feedback_user', 'ct_feedback_user'}, 'ctAjaxDeleteAllUsers': {'ajax_delete_all_users'}, 'apbct_settings__save_key': {'apbct_save_key'}, 'ctGetCsvFile': {'ajax_ct_get_csv_file'}, 'restoreOrderAction': {'apbct_restore_spam_order'}}
*
***/
...
/** Function apbct_form__seedprod_coming_soon__testSpam() called by wp_ajax hooks: {'seed_cspv5_contactform_callback', 'nopriv_seed_cspv5_contactform_callback', 'seed_cspv5_subscribe_callback', 'nopriv_seed_cspv5_subscribe_callback'} **/
/** No params detected :-/ **/
...
/** Function apbct_comment__send_feedback() called by wp_ajax hooks: {'ct_feedback_comment', 'nopriv_ct_feedback_comment'} **/
/** No params detected :-/ **/


/** Function ct_ajax_hook() called by wp_ajax hooks: {'nopriv_rwp_ajax_action_rating', 'nopriv_zn_do_login', 'nopriv_td_mod_register', 'nopriv_smuzform-storage', 'nopriv_submit_form_recaptcha_validation', 'tmpl_ajax_check_user_email', 'nopriv_tmpl_ajax_check_user_email', 'nopriv_cs_registration_validation', 'nopriv_send_message', 'nopriv_woocommerce_checkout', 'woocommerce_checkout', 'nopriv_uwp_ajax_register', 'nopriv_wpuf_submit_register', 'vfb_submit', 'nopriv_tevolution_submit_from_preview', 'nopriv_wysija_ajax', 'wysija_ajax', 'tevolution_submit_from_preview', 'nopriv_mymail_form_submit', 'nopriv_request_appointment', 'cs_registration_validation', 'nopriv_vfb_submit', 'request_appointment', 'wpuf_submit_register', 'mymail_form_submit', 'send_message', 'tmpl_submit_form_recaptcha_validation', 'zn_do_login', 'td_mod_register', 'nopriv_frm_entries_create', 'frm_entries_create'} **/
...
/** Function ctAjaxInfo() called by wp_ajax hooks: {'ajax_info_comments', 'ajax_info_users'} **/
/** No params detected :-/ **/
