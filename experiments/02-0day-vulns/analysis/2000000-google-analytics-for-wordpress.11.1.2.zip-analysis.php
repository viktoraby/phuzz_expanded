...
*Overview: {'maybe_delete': {'monsterinsights_maybe_delete'}, 'monsterinsights_ai_charlie_get_saved_chats': {'monsterinsights_ai_charlie_get_saved_chats'}, 'update_settings': {'monsterinsights_vue_update_settings'}, 'get_notes': {'monsterinsights_vue_get_notes'}, 'onboarding_get_install_errors': {'nopriv_onboarding_monsterinsights_onboarding_get_errors'}, 'monsterinsights_ajax_dismiss_seoboost_cta': {'monsterinsights_vue_dismiss_seoboost_cta'}, 'update_settings_bulk': {'monsterinsights_vue_update_settings_bulk'}, 'monsterinsights_vue_dismiss_aiseo_cta': {'monsterinsights_vue_dismiss_aiseo_cta'}, 'get_overview_bundle': {'monsterinsights_vue_get_overview_bundle'}, 'update_filter': {'monsterinsights_update_report_filter'}, 'install_plugin': {'monsterinsights_vue_install_plugin'}, 'delete_categories': {'monsterinsights_vue_delete_categories'}, 'update_measurement_protocol_secret': {'monsterinsights_update_measurement_protocol_secret'}, 'monsterinsights_check_plugin_funnelkit_funnelkit_stripe_woo_gateway_configured': {'monsterinsights_funnelkit_stripe_woo_gateway_configured'}, 'ajax_get_notifications': {'monsterinsights_vue_get_notifications'}, 'capture_last_used_report': {'monsterinsights_vue_capture_last_used_report'}, 'restore_notes': {'monsterinsights_vue_restore_notes'}, 'save_widget_state': {'monsterinsights_save_widget_state'}, 'monsterinsights_ajax_dismiss_wpconsent_notice': {'monsterinsights_dismiss_wpconsent_notice'}, 'save_category': {'monsterinsights_vue_save_category'}, 'delete_filter': {'monsterinsights_delete_report_filter'}, 'get_result': {'monsterinsights_gutenberg_headline_analyzer_get_results'}, 'monsterinsights_dismiss_tracking_notice': {'monsterinsights_dismiss_tracking_notice'}, 'test_check_connection': {'health-check-monsterinsights-test_connection'}, 'dismiss_charitablewp_notice': {'monsterinsights_dismiss_charitablewp_notice'}, 'check_popular_posts_report': {'monsterinsights_vue_grab_popular_posts_report'}, 'MonsterInsights_API_Token': {'monsterinsights_get_bearer_token'}, 'get_notice_status': {'monsterinsights_vue_notice_status'}, 'update_manual_v4': {'monsterinsights_update_manual_v4'}, 'is_installed': {'nopriv_monsterinsights_is_installed'}, 'delete_funnel': {'monsterinsights_overview_report_delete_funnel_filter'}, 'send_test_email': {'monsterinsights_send_test_email'}, 'monsterinsights_ajax_backfill_cache': {'monsterinsights_backfill_cache'}, 'get_posts': {'monsterinsights_get_posts'}, 'get_addons': {'monsterinsights_vue_get_addons'}, 'ajax_get_index_progress': {'monsterinsights_sharedcount_get_index_progress'}, 'delete_notes': {'monsterinsights_vue_delete_notes'}, 'monsterinsights_handle_get_plugin_info': {'nopriv_monsterinsights_get_plugin_info'}, 'rauthenticate': {'nopriv_monsterinsights_rauthenticate'}, 'generate_connect_url': {'monsterinsights_connect_url'}, 'maybe_authenticate': {'monsterinsights_maybe_authenticate'}, 'get_settings': {'monsterinsights_vue_get_settings'}, 'process': {'nopriv_monsterinsights_connect_process'}, 'update_popular_posts_theme_setting': {'monsterinsights_vue_popular_posts_update_theme_setting'}, 'maybe_verify': {'monsterinsights_maybe_verify'}, 'ajax_get_setup_checklist': {'monsterinsights_vue_get_setup_checklist'}, 'install_and_activate_wpforms': {'monsterinsights_onboarding_wpforms_install'}, 'monsterinsights_dismiss_ads_addon_notice_ajax': {'monsterinsights_dismiss_ads_addon_notice'}, 'save_filter': {'monsterinsights_save_report_filter'}, 'get_note': {'monsterinsights_vue_get_note'}, 'monsterinsights_mark_floatbar_hidden': {'monsterinsights_hide_floatbar'}, 'maybe_add_notifications': {'monsterinsights_vue_get_notifications'}, 'monsterinsights_ai_charlie_get_chats': {'monsterinsights_ai_charlie_get_chats'}, 'monsterinsights_get_aiseo_cta_status': {'monsterinsights_get_aiseo_cta_status'}, 'save_notification': {'monsterinsights_notification_save'}, 'mark_read': {'monsterinsights_notification_mark_read'}, 'get_taxonomy_terms': {'monsterinsights_get_terms'}, 'review_dismiss': {'monsterinsights_review_dismiss'}, 'update_included_metrics': {'monsterinsights_vue_update_included_metrics'}, 'save_note': {'monsterinsights_vue_save_note'}, 'handle_relay_mp_token_push': {'nopriv_monsterinsights_push_mp_token'}, 'dismiss_promo': {'monsterinsights_vue_dismiss_promo'}, 'handle_settings_import': {'monsterinsights_handle_settings_import'}, 'ajax_generate_setup_wizard_url': {'monsterinsights_generate_setup_wizard_url'}, 'monsterinsights_ai_charlie_delete_chat': {'monsterinsights_ai_charlie_delete_chat'}, 'get_eea_compliance': {'monsterinsights_vue_get_eea_compliance'}, 'dismiss': {'monsterinsights_notification_dismiss'}, 'maybe_reauthenticate': {'monsterinsights_maybe_reauthenticate'}, 'monsterinsights_ajax_dismiss_notice': {'monsterinsights_ajax_dismiss_notice'}, 'test_check_tracking_code': {'health-check-monsterinsights-test_tracking_code'}, 'empty_cache': {'monsterinsights_popular_posts_empty_cache'}, 'get_ajax_output': {'nopriv_monsterinsights_popular_posts_get_widget_output', 'monsterinsights_popular_posts_get_widget_output'}, 'update_funnel': {'monsterinsights_overview_report_update_funnel_filter'}, 'manual_check': {'monsterinsights_manual_product_feed_check'}, 'get_report_data': {'monsterinsights_vue_get_report_data'}, 'get_funnels': {'monsterinsights_overview_report_get_funnel_filters'}, 'dismiss_notice': {'monsterinsights_vue_notice_dismiss'}, 'save_funnel': {'monsterinsights_overview_report_save_funnel_filter'}, 'delete_all_funnels': {'monsterinsights_overview_report_delete_all_funnel_filters'}, 'get_license': {'monsterinsights_vue_get_license'}, 'monsterinsights_ajax_install_addon': {'monsterinsights_install_addon'}, 'monsterinsights_ajax_activate_addon': {'monsterinsights_activate_addon'}, 'get_filters': {'monsterinsights_get_report_filters'}, 'monsterinsights_report_error': {'monsterinsights_report_error'}, 'onboarding_maybe_authenticate': {'nopriv_onboarding_monsterinsights_maybe_authenticate'}, 'export_notes_to_ga4': {'monsterinsights_vue_export_notes'}, 'trash_notes': {'monsterinsights_vue_trash_notes'}, 'get_categories': {'monsterinsights_vue_get_categories'}, 'monsterinsights_mark_admin_menu_tooltip_hidden': {'monsterinsights_hide_admin_menu_tooltip'}, 'handle_request': {'monsterinsights_get_overview_data'}, 'remind_me': {'monsterinsights_notification_remind_me'}, 'ajax_get_themes': {'monsterinsights_get_popular_posts_themes'}, 'monsterinsights_ai_charlie_save_chat': {'monsterinsights_ai_charlie_save_chat'}, 'get_user_included_metrics': {'monsterinsights_vue_get_user_included_metrics'}, 'dismiss_first_time_notice': {'monsterinsights_vue_dismiss_first_time_notice'}, 'import_notes_from_ga4': {'monsterinsights_vue_import_notes'}, 'monsterinsights_get_seo_boost_cta_status': {'monsterinsights_get_seo_boost_cta_status'}, 'monsterinsights_ai_charlie_pin_chat': {'monsterinsights_ai_charlie_pin_chat'}, 'monsterinsights_dismiss_ai_insights_addon_notice_ajax': {'monsterinsights_dismiss_ai_insights_addon_notice'}, 'check_eea_compliance': {'monsterinsights_vue_check_eea_compliance'}, 'monsterinsights_ai_charlie_load_chat': {'monsterinsights_ai_charlie_load_chat'}, 'monsterinsights_ajax_deactivate_addon': {'monsterinsights_deactivate_addon'}, 'ajax_button_click_track': {'monsterinsights_vue_setup_checklist_click_track'}, 'get_install_errors': {'monsterinsights_onboarding_get_errors'}, '__return_false': {'monsterinsights_user_journey_report_filter_params'}, 'monsterinsights_get_floatbar': {'monsterinsights_get_floatbar'}, 'monsterinsights_user_journey_demo_report_ajax': {'monsterinsights_user_journey_report'}, 'get_post_types': {'monsterinsights_get_post_types'}, 'get_profile': {'monsterinsights_vue_get_profile'}, 'mark_notice_closed': {'monsterinsights_mark_notice_closed'}, 'ajax_optimize': {'monsterinsights_gutenberg_headline_analyzer_optimize'}, 'monsterinsights_ajax_get_backfill_cache': {'monsterinsights_get_backfill_cache'}, 'ajax_start_indexing': {'monsterinsights_sharedcount_start_indexing'}}
*
***/
