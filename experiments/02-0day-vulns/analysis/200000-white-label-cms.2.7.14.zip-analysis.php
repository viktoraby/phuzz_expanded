...
*Overview: {'store_preview': {'wlcms_save_dashboard_preview_settings', 'wlcms_save_login_preview_settings'}, 'search_pages': {'wlcms_search_pages'}, 'search_initial_pages': {'wlcms_inital_search'}, 'hide_vum_dashboard': {'hide_vum_dashboard'}}
*
***/

/** Function store_preview() called by wp_ajax hooks: {'wlcms_save_dashboard_preview_settings', 'wlcms_save_login_preview_settings'} **/
/** No params detected :-/ **/
