...
*Overview: {'kirki_wp_admin_get_apis': {'kirki_wp_admin_get_apis'}, 'kirki_get_apis': {'nopriv_kirki_get_apis', 'kirki_get_apis'}, 'kirki_post_apis_nopriv': {'nopriv_kirki_post_apis_nopriv'}, 'kirki_post_apis': {'kirki_post_apis'}, 'kirki_wp_admin_post_apis': {'kirki_wp_admin_post_apis'}, 'get_standardfonts_json': {'kirki_fonts_standard_all_get', 'nopriv_kirki_fonts_standard_all_get'}, 'kirki_wp_admin_unauthorized': {'nopriv_kirki_wp_admin_get_apis', 'nopriv_kirki_wp_admin_post_apis'}, 'print_googlefonts_json': {'nopriv_kirki_fonts_google_all_get', 'kirki_fonts_google_all_get'}}
*
***/
