...
*Overview: {'ajax_getBackupFolderSize': {'shortpixel_get_backup_size'}, 'ajax_getItemView': {'shortpixel_get_item_view'}, 'deactivatePluginCallback': {'shortpixel_deactivate_plugin'}, 'ajax_getComparerData': {'shortpixel_get_comparer_data'}, 'ajax_processQueue': {'shortpixel_image_processing'}, 'ajax_checkquota': {'shortpixel_check_quota'}, 'ajax_proposeQuotaUpgrade': {'shortpixel_propose_upgrade'}, 'ajaxBrowseContent': {'shortpixel_browse_content'}, 'ajaxRequest': {'shortpixel_ajaxRequest'}}
*
***/
