...
*Overview: {'wpmm_update_sdk_options': {'wpmm_update_sdk_options'}, 'ThemeisleSDK\\Modules\\Notification::dismiss': {'themeisle_sdk_dismiss_notice'}, 'dismiss_license_notice': {'themeisle_sdk_dismiss_license_notice'}, 'subscribers_export': {'wpmm_subscribers_export'}, 'select_page': {'wpmm_select_page'}, 'add_subscriber': {'nopriv_wpmm_add_subscriber', 'wpmm_add_subscriber'}, 'insert_template': {'wpmm_insert_template'}, 'skip_insert_template': {'wpmm_skip_insert_template'}, 'dismiss': {'themeisle_sdk_dismiss_notice'}, 'skip_wizard': {'wpmm_skip_wizard'}, 'dismiss_notices': {'wpmm_dismiss_notices'}, 'dismiss_promotion': {'tisdk_update_option'}, 'reset_plugin_settings': {'wpmm_reset_settings'}, 'subscribers_empty_list': {'wpmm_subscribers_empty_list'}, 'wp_ajax_install_plugin': {'wp_ajax_install_plugin'}, 'send_contact': {'nopriv_wpmm_send_contact', 'wpmm_send_contact'}, 'change_template_category': {'wpmm_change_template_category'}, 'toggle_gutenberg': {'wpmm_toggle_gutenberg'}, 'subscribe_newsletter': {'wpmm_subscribe'}, 'disable_notification_ajax': {'themeisle_sdk_dismiss_black_friday_notice'}}
*
***/
...
/** Function add_subscriber() called by wp_ajax hooks: {'nopriv_wpmm_add_subscriber', 'wpmm_add_subscriber'} **/
...
/** Function skip_insert_template() called by wp_ajax hooks: {'wpmm_skip_insert_template'} **/
/** Parameters found in function skip_insert_template(): {"post": ["_wpnonce"]} **/
function skip_insert_template() {
			// check nonce existence
			if ( empty( $_POST['_wpnonce'] ) ) {
				die( esc_html__( 'The nonce field must not be empty.', 'wp-maintenance-mode' ) );
			}
...
/** Function send_contact() called by wp_ajax hooks: {'nopriv_wpmm_send_contact', 'wpmm_send_contact'} **/
...
/** Parameters found in function subscribe_newsletter(): {"post": ["_wpnonce", "email", "opt_in"]} **/
