...
*Overview: {'insert_template': {'wpmm_insert_template'}, 'toggle_gutenberg': {'wpmm_toggle_gutenberg'}, 'wpmm_update_sdk_options': {'wpmm_update_sdk_options'}, 'ThemeisleSDK\\Modules\\Notification::dismiss': {'themeisle_sdk_dismiss_notice'}, 'dismiss': {'themeisle_sdk_dismiss_notice'}, 'skip_wizard': {'wpmm_skip_wizard'}, 'reset_plugin_settings': {'wpmm_reset_settings'}, 'dismiss_license_notice': {'themeisle_sdk_dismiss_license_notice'}, 'add_subscriber': {'nopriv_wpmm_add_subscriber', 'wpmm_add_subscriber'}, 'subscribers_empty_list': {'wpmm_subscribers_empty_list'}, 'change_template_category': {'wpmm_change_template_category'}, 'subscribe_newsletter': {'wpmm_subscribe'}, 'subscribers_export': {'wpmm_subscribers_export'}, 'send_contact': {'wpmm_send_contact', 'nopriv_wpmm_send_contact'}, 'select_page': {'wpmm_select_page'}, 'dismiss_promotion': {'tisdk_update_option'}, 'dismiss_notices': {'wpmm_dismiss_notices'}, 'skip_insert_template': {'wpmm_skip_insert_template'}, 'disable_notification_ajax': {'themeisle_sdk_dismiss_black_friday_notice'}, 'wp_ajax_install_plugin': {'wp_ajax_install_plugin'}}
*
***/
