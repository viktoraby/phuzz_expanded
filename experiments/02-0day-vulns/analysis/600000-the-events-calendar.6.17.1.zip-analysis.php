...
*Overview: {'handle_dismiss': {'ian_dismiss', 'tec_conditional_content_dismiss'}, 'ajax_convert_ical_settings': {'tribe_convert_legacy_ical_settings'}, 'route': {'tribe_dropdown', 'nopriv_tribe_dropdown'}, 'ajax': {'tribe_aggregator_realtime_update'}, 'ajax_preview_import': {'tribe_aggregator_preview_import'}, 'ajax_fetch_import': {'tribe_aggregator_fetch_import'}, 'ajax_sysinfo_optin': {'tribe_toggle_sysinfo_optin'}, 'handle_ajax_request': {'nopriv_{$action}', '{$action}'}, 'ajax_updater': {'tribe_timezone_update'}, 'ajax_create_import': {'tribe_aggregator_create_import'}, 'maybe_dismiss': {'tribe_notice_dismiss'}, 'listen': {'tribe_logging_controls'}, 'ajax_form_validate': {'tribe_event_validation'}, 'get_feed': {'ian_get_feed'}, 'handle_read': {'ian_read'}, 'handle_request': {'{$js_action}'}, 'handle_read_all': {'ian_read_all'}, 'ajax_save_credentials': {'tribe_aggregator_save_credentials'}, 'opt_in': {'ian_optin'}, 'render_modal': {'tec_qr_code_modal'}, 'ajax_convert_legacy_ignored_events': {'tribe_convert_legacy_ignored_events'}}
*
***/
