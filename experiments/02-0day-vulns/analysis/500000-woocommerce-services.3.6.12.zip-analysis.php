...
*Overview: {'ajax_dismiss_notice': {'wc_connect_dismiss_notice'}, 'handle_survey_dismissal': {'wcs_migration_survey_dismiss'}, 'handle_tax_backup_download': {'wcs_download_tax_backup'}, 'handle_survey_display_tracking': {'wcs_migration_survey_track_display'}, 'handle_survey_submission': {'wcs_migration_survey_submit'}, 'ajax_tracks': {'jetpack_tracks'}}
*
***/
