...
*Overview: {'hfe_plugin_install': {'hfe_recommended_plugin_install'}, 'ajax_save_template_meta': {'hfe_save_template_meta'}, 'update_subscription': {'hfe-update-subscription'}, 'dismiss_notice': {'astra-notice-dismiss'}, 'deactivate_widget': {'hfe_deactivate_widget'}, 'send_plugin_deactivate_feedback': {'uds_plugin_deactivate_feedback'}, 'save_onboarding_analytics': {'hfe_save_onboarding_analytics'}, 'bulk_activate_widgets': {'hfe_bulk_activate_widgets'}, 'save_analytics_option': {'save_analytics_option'}, 'save_hfe_compatibility_option_callback': {'save_theme_compatibility_option'}, 'bulk_deactivate_widgets': {'hfe_bulk_deactivate_widgets'}, 'hfe_flush_permalink_notice': {'hfe_flush_permalink_notice'}, 'update_permalink_notice_option': {'update_permalink_notice_option'}, 'hfe_theme_install': {'hfe_recommended_theme_install'}, 'dismiss_upgrade_notice': {'hfe_dismiss_upgrade_notice'}, 'hfe_get_posts_by_query': {'hfe_get_posts_by_query'}, 'hfe_activate_addon': {'hfe_recommended_plugin_activate'}, 'activate_widget': {'hfe_activate_widget'}, 'hfe_admin_modal': {'hfe_admin_modal'}, 'bulk_deactivate_unused_widgets': {'hfe_bulk_deactivate_unused_widgets'}}
*
***/
...
/** Function ajax_save_template_meta() called by wp_ajax hooks: {'hfe_save_template_meta'} **/
/** Parameters found in function ajax_save_template_meta(): {"post": ["post_id"]} **/
function ajax_save_template_meta() {
