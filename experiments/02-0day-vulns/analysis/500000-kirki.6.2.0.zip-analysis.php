...
*Overview: {'kirki_wp_admin_unauthorized': {'nopriv_kirki_wp_admin_post_apis', 'nopriv_kirki_wp_admin_get_apis'}, 'kirki_wp_admin_get_apis': {'kirki_wp_admin_get_apis'}, 'get_standardfonts_json': {'kirki_fonts_standard_all_get', 'nopriv_kirki_fonts_standard_all_get'}, 'print_googlefonts_json': {'kirki_fonts_google_all_get', 'nopriv_kirki_fonts_google_all_get'}, 'kirki_get_apis': {'nopriv_kirki_get_apis', 'kirki_get_apis'}, 'kirki_wp_admin_post_apis': {'kirki_wp_admin_post_apis'}, 'kirki_post_apis': {'kirki_post_apis'}, 'kirki_post_apis_nopriv': {'nopriv_kirki_post_apis_nopriv'}}
*
***/

/** Function kirki_wp_admin_unauthorized() called by wp_ajax hooks: {'nopriv_kirki_wp_admin_post_apis', 'nopriv_kirki_wp_admin_get_apis'} **/
/** No params detected :-/ **/
...
/** Function get_standardfonts_json() called by wp_ajax hooks: {'kirki_fonts_standard_all_get', 'nopriv_kirki_fonts_standard_all_get'} **/
/** No params detected :-/ **/
