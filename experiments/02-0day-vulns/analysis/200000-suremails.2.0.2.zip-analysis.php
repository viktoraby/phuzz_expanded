...
*Overview: {'activate_theme': {'suremails-activate_theme'}, 'send_plugin_deactivate_feedback': {'uds_plugin_deactivate_feedback'}, 'dismiss_notice': {'astra-notice-dismiss'}, 'handle_activate_plugin': {'suremails-activate_plugin'}}
*
***/
