...
*Overview: {'wizard_steps_started': {'wp_mail_smtp_vue_wizard_steps_started'}, 'dismiss': {'wp_mail_smtp_notification_dismiss'}, 'get_connected_data': {'wp_mail_smtp_vue_get_connected_data'}, 'ajax_generate_url': {'wp_mail_smtp_connect_url'}, 'process': {'nopriv_wp_mail_smtp_connect_process'}, 'review_dismiss': {'wp_mail_smtp_review_dismiss'}, 'send_feedback': {'wp_mail_smtp_vue_send_feedback'}, 'subscribe_to_newsletter': {'wp_mail_smtp_vue_subscribe_to_newsletter'}, 'get_partner_plugins_info': {'wp_mail_smtp_vue_get_partner_plugins_info'}, 'process_ajax_delete_all_debug_events': {'wp_mail_smtp_delete_all_debug_events'}, 'get_settings': {'wp_mail_smtp_vue_get_settings'}, 'get_oauth_url': {'wp_mail_smtp_vue_get_oauth_url'}, 'check_mailer_configuration': {'wp_mail_smtp_vue_check_mailer_configuration'}, 'notice_bar_ajax_dismiss': {'wp_mail_smtp_notice_bar_dismiss'}, 'import_settings': {'wp_mail_smtp_vue_import_settings'}, 'update_settings': {'wp_mail_smtp_vue_update_settings'}, 'upgrade_plugin': {'wp_mail_smtp_vue_upgrade_plugin'}, 'email_domain_check_test': {'health-check-email-domain_check_test'}, 'remove_oauth_connection': {'wp_mail_smtp_vue_remove_oauth_connection'}, 'process_ajax_debug_event_preview': {'wp_mail_smtp_debug_event_preview'}, 'process_ajax': {'wp_mail_smtp_ajax'}, 'install_plugin': {'wp_mail_smtp_vue_install_plugin'}}
*
***/
