...
*Overview: {'set_user_by_email': {'nopriv_mailchimp_set_user_by_email', 'mailchimp_set_user_by_email'}, 'mailchimp_woocommerce_ajax_oauth_finish': {'mailchimp_woocommerce_oauth_finish'}, 'mailchimp_woocommerce_ajax_create_account_check_username': {'mailchimp_woocommerce_create_account_check_username'}, 'mailchimp_woocommerce_ajax_create_account_signup': {'mailchimp_woocommerce_create_account_signup'}, 'mailchimp_woocommerce_ajax_toggle_chimpstatic_script': {'mailchimp_woocommerce_toggle_chimpstatic_script'}, 'connect_account_flow_switch_account': {'mailchimp_woocommerce_switch_account'}, 'get_user_by_hash': {'mailchimp_get_user_by_hash', 'nopriv_mailchimp_get_user_by_hash'}, 'mailchimp_woocommerce_ajax_support_form': {'mailchimp_woocommerce_support_form'}, 'mailchimp_woocommerce_ajax_oauth_start': {'mailchimp_woocommerce_oauth_start'}, 'mailchimp_woocommerce_ajax_oauth_status': {'mailchimp_woocommerce_oauth_status'}, 'mailchimp_woocommerce_communication_status': {'mailchimp_woocommerce_communication_status'}, 'mailchimp_create_additional_runners': {'nopriv_mailchimp_create_additional_runners'}, 'mailchimp_woocommerce_ajax_delete_log_file': {'mailchimp_woocommerce_delete_log_file'}, 'mailchimp_woocommerce_ajax_load_log_file': {'mailchimp_woocommerce_load_log_file'}, 'mailchimp_woocommerce_send_event': {'mailchimp_woocommerce_send_event'}, 'mailchimp_woocommerce_ajax_check_login_session': {'mailchimp_woocommerce_check_login_session'}, 'mailchimp_woocommerce_activate_account_event': {'mailchimp_woocommerce_activate_account_event'}, 'mailchimp_woocommerce_tower_status': {'mailchimp_woocommerce_tower_status'}}
*
***/
