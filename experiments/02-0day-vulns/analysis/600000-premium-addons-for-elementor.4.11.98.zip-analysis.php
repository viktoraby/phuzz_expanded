...
*Overview: {'pa_save_global_btn': {'pa_save_global_btn'}, 'pa_enable_oauth_connect': {'pa_enable_oauth_connect'}, 'pa_disable_elementor_mc_template': {'pa_disable_elementor_mc_template'}, 'handle_live_editor': {'handle_live_editor'}, 'get_woo_products': {'nopriv_get_woo_products', 'get_woo_products'}, 'pa_save_additional_settings': {'pa_save_additional_settings'}, 'handle_pa_woo_cta_actions': {'nopriv_handle_pa_woo_cta_actions', 'handle_pa_woo_cta_actions'}, 'get_posts_query': {'nopriv_pa_get_posts', 'pa_get_posts'}, 'subscribe_newsletter': {'subscribe_newsletter'}, 'pa_disable_unused_widgets': {'pa_disable_unused_widgets'}, 'pa_get_editor_template': {'pa_get_editor_template'}, 'insert_cf_form': {'insert_cf_form'}, 'get_search_results': {'premium_get_search_results', 'nopriv_premium_get_search_results'}, 'get_templates': {'premium_get_templates'}, 'pa_remove_coupon': {'pa_remove_coupon', 'nopriv_pa_remove_coupon'}, 'pa_hide_unused_widgets_dialog': {'pa_hide_unused_widgets_dialog'}, 'get_related_tax': {'premium_update_tax'}, 'get_acf_options': {'pa_acf_options'}, 'check_temp_validity': {'check_temp_validity'}, 'pa_save_menu_item_settings': {'pa_save_menu_item_settings'}, 'get_shape_divider_svg': {'get_shape_divider_svg'}, 'pa_scan_widgets_usage': {'pa_scan_widgets_usage'}, 'update_template_title': {'update_template_title'}, 'add_product_to_cart': {'nopriv_premium_woo_add_cart_product', 'premium_woo_add_cart_product'}, 'get_shape_svgs': {'pa_get_shape_svgs'}, 'pa_save_mega_item_content': {'pa_save_mega_item_content'}, 'cross_cp_fetch_content_data': {'premium_cross_cp_import'}, 'pa_update_mc_qty': {'pa_update_mc_qty', 'nopriv_pa_update_mc_qty'}, 'pa_save_elements_settings': {'pa_save_elements_settings'}, 'pa_clear_cached_assets': {'pa_clear_cached_assets'}, 'get_posts_list': {'premium_update_filter'}, 'get_template_content': {'get_elementor_template_content', 'nopriv_get_elementor_template_content'}, 'get_pinterest_boards': {'get_pinterest_boards'}, 'pa_get_menu_item_settings': {'pa_get_menu_item_settings'}, 'get_tiktok_token': {'get_tiktok_token'}, 'pa_delete_cart_item': {'pa_delete_cart_item', 'nopriv_pa_delete_cart_item'}, 'dismiss_admin_notice': {'pa_dismiss_admin_notice'}, 'pa_apply_coupon': {'nopriv_pa_apply_coupon', 'pa_apply_coupon'}, 'reset_admin_notice': {'pa_reset_admin_notice'}, 'pa_check_unused_widgets': {'pa_check_unused_widgets'}, 'insert_inner_template': {'premium_inner_template'}, 'get_pa_element_data': {'get_pa_element_data'}, 'pa_delete_cart_items': {'pa_delete_cart_items', 'nopriv_pa_delete_cart_items'}, 'get_woo_product_quick_view': {'get_woo_product_qv', 'nopriv_get_woo_product_qv'}, 'pa_disable_oauth_connect': {'pa_disable_oauth_connect'}, 'send': {'pa_handle_feedback_action', 'pa_send_element_feedback'}, 'get_pinterest_token': {'get_pinterest_token'}, 'pa_save_ai_abilities': {'pa_save_ai_abilities'}, 'clear_site_cursor_settings': {'pa_clear_site_cursor_settings'}}
*
***/
...
/** Function get_woo_products() called by wp_ajax hooks: {'nopriv_get_woo_products', 'get_woo_products'} **/
...
/** Function handle_pa_woo_cta_actions() called by wp_ajax hooks: {'nopriv_handle_pa_woo_cta_actions', 'handle_pa_woo_cta_actions'} **/
...
/** Function get_posts_query() called by wp_ajax hooks: {'nopriv_pa_get_posts', 'pa_get_posts'} **/
/** No params detected :-/ **/
...
/** Function get_template_content() called by wp_ajax hooks: {'get_elementor_template_content', 'nopriv_get_elementor_template_content'} **/
...
/** Function pa_delete_cart_item() called by wp_ajax hooks: {'pa_delete_cart_item', 'nopriv_pa_delete_cart_item'} **/
...
/** Function pa_apply_coupon() called by wp_ajax hooks: {'nopriv_pa_apply_coupon', 'pa_apply_coupon'} **/
...
/** Function pa_delete_cart_items() called by wp_ajax hooks: {'pa_delete_cart_items', 'nopriv_pa_delete_cart_items'} **/
/** No params detected :-/ **/
...
/** Function send() called by wp_ajax hooks: {'pa_handle_feedback_action', 'pa_send_element_feedback'} **/
