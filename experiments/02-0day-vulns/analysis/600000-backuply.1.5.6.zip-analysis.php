...
*Overview: {'backuply_sync_backups': {'backuply_sync_backups'}, 'backuply_update_quota': {'backuply_update_quota'}, 'backuply_get_loc_details': {'backuply_get_loc_details'}, 'backuply_exclude_rule_delete': {'backuply_exclude_rule_delete'}, 'backuply_check_status': {'backuply_check_status'}, 'backuply_do_diagnosis': {'backuply_do_diagnosis'}, 'backuply_load_debug': {'backuply_load_debug'}, 'backuply_get_restore_key': {'backuply_get_restore_key'}, 'backuply_download_bcloud': {'backuply_download_bcloud'}, 'backuply_restore_curl_query': {'backuply_restore_curl_query'}, 'backuply_restore_status_log': {'nopriv_backuply_restore_status_log', 'backuply_restore_status_log'}, 'backuply_get_jstree': {'backuply_get_jstree'}, 'backuply_handle_backup_request': {'backuply_handle_backup'}, 'backuply_verify_trial': {'backuply_verify_trial'}, 'backuply_creating_session': {'backuply_creating_session', 'nopriv_backuply_creating_session'}, 'backuply_close_update_notice': {'backuply_close_update_notice'}, 'backuply_download_backup': {'backuply_download_backup'}, 'backuply_scan_fix_noabort': {'backuply_scan_fix_noabort'}, 'backuply_create_backup': {'backuply_create_backup'}, 'backuply_force_stop': {'backuply_kill_proccess'}, 'backuply_multi_backup_delete': {'backuply_multi_backup_delete'}, 'backuply_backup_progress_status': {'backuply_check_backup_status'}, 'backuply_restore_response': {'nopriv_backuply_restore_response'}, 'backuply_save_excludes': {'backuply_save_excludes'}, 'backuply_retry_htaccess': {'backuply_retry_htaccess'}, 'backuply_trial_settings': {'backuply_trial_settings'}, 'backuply_backup_upload': {'backuply_backup_upload'}, 'backuply_bcloud_trial': {'bcloud_trial'}, 'backuply_close_trial_promo': {'backuply_trial_promo'}, 'backuply_update_serialization_ajax': {'nopriv_backuply_update_serialization'}, 'backuply_stop_backup': {'backuply_stop_backup'}, 'backuply_close_litespeed_notice': {'backuply_close_litespeed_notice'}, 'backuply_get_last_logs': {'backuply_last_logs'}, 'backuply_hide_backup_nag': {'backuply_hide_backup_nag'}, 'backuply_checkrestorestatus_action': {'backuply_checkrestorestatus_action'}}
*
***/
...
/** Function backuply_creating_session() called by wp_ajax hooks: {'backuply_creating_session', 'nopriv_backuply_creating_session'} **/
...
/** Function backuply_scan_fix_noabort() called by wp_ajax hooks: {'backuply_scan_fix_noabort'} **/
/** No params detected :-/ **/
