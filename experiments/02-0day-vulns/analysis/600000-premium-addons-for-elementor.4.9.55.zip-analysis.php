...
*Overview: {'save_pa_mega_item_content': {'save_pa_mega_item_content'}, 'get_pa_menu_item_settings': {'get_pa_menu_item_settings'}, 'subscribe_newsletter': {'subscribe_newsletter'}, 'get_unused_widgets': {'pa_get_unused_widgets'}, 'get_posts_query': {'nopriv_pa_get_posts', 'pa_get_posts'}, 'get_woo_products': {'get_woo_products', 'nopriv_get_woo_products'}, 'clear_cached_assets': {'pa_clear_cached_assets'}, 'add_product_to_cart': {'premium_woo_add_cart_product', 'nopriv_premium_woo_add_cart_product'}, 'get_templates': {'premium_get_templates'}, 'save_pa_menu_item_settings': {'save_pa_menu_item_settings'}, 'check_temp_validity': {'check_temp_validity'}, 'get_posts_list': {'premium_update_filter'}, 'handle_live_editor': {'handle_live_editor'}, 'update_template_title': {'update_template_title'}, 'get_template_content': {'get_elementor_template_content'}, 'cross_cp_fetch_content_data': {'premium_cross_cp_import'}, 'get_acf_options': {'nopriv_pa_get_acf_options', 'pa_acf_options'}, 'get_related_tax': {'premium_update_tax'}, 'reset_admin_notice': {'pa_reset_admin_notice'}, 'insert_inner_template': {'premium_inner_template'}, 'save_additional_settings': {'pa_additional_settings'}, 'save_settings': {'pa_elements_settings'}, 'save_global_btn_value': {'pa_save_global_btn'}, 'dismiss_admin_notice': {'pa_dismiss_admin_notice'}, 'get_woo_product_quick_view': {'get_woo_product_qv', 'nopriv_get_woo_product_qv'}}
*
***/
