...
*Overview: {'ajax_undelete_slide': {'undelete_slide'}, 'ajax_quickstart_slideshow': {'quickstart_slideshow'}, 'import_slideshows': {'ms_import_slideshows'}, 'get_theme_customization': {'ms_get_theme_customization'}, 'ajax_update_slide_image': {'update_slide_image'}, 'search_slideshows': {'ms_search_slideshows'}, 'get_all_free_themes': {'ms_get_all_free_themes'}, 'ajax_quickstart_ads': {'quickstart_ads'}, 'list_slideshows': {'ms_list_slideshows'}, 'import_images': {'ms_import_images'}, 'get_global_settings': {'ms_get_global_settings'}, 'get_custom_themes': {'ms_get_custom_themes'}, 'ajax_permanent_delete_slide': {'permanent_delete_slide'}, 'save_slideshow_default_settings': {'ms_save_slideshow_default_settings'}, 'save_single_slideshow_setting': {'ms_update_single_slideshow_setting'}, 'delete_slideshow': {'ms_delete_slideshow'}, 'get_slideshows': {'ms_get_slideshows'}, 'get_user_details': {'ms_get_user_details'}, 'save_user_setting': {'ms_update_user_setting'}, 'set_theme': {'ms_set_theme'}, 'ajax_duplicate_slide': {'duplicate_slide'}, 'get_single_slideshow': {'ms_get_single_slideshow'}, 'duplicate_slideshow': {'ms_duplicate_slideshow'}, 'save_all_slideshow_settings': {'ms_update_all_slideshow_settings'}, 'save_pro_settings': {'ms_update_pro_settings'}, 'get_single_setting': {'ms_get_single_setting'}, 'save_global_settings': {'ms_update_global_settings'}, 'ajax_create_image_slides': {'create_image_slide'}, 'get_slideshow_default_settings': {'ms_get_slideshow_default_settings'}, 'set_tour_status': {'set_tour_status'}, 'get_image_ids_from_file_name': {'ms_get_image_ids_from_filenames'}, 'get_preview': {'ms_get_preview'}, 'ajax_quickstart_upload': {'quickstart_upload'}, 'ajax_notice_handler': {'notice_handler'}, 'ajax_quickstart_slideshow_v2': {'quickstart_slideshow_v2'}, 'get_pro_settings': {'ms_get_pro_settings'}, 'ajax_delete_slide': {'delete_slide'}, 'ajax_resize_slide': {'resize_image_slide'}, 'ajax_crop_position_image_slide': {'crop_position_image_slide'}, 'export_slideshows': {'ms_export_slideshows'}, 'get_legacy_slideshows': {'ms_get_legacy_slideshows'}, 'save_slideshow': {'ms_save_slideshow'}, 'save_global_settings_single': {'ms_update_global_settings_single'}, 'import_others': {'ms_import_others'}}
*
***/
