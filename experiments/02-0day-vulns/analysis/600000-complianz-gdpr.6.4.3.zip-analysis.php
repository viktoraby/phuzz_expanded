...
*Overview: {'get_scan_progress': {'cmplz_get_scan_progress'}, 'ajax_script_save': {'cmplz_script_save'}, 'ajax_edit_item': {'cmplz_edit_item'}, 'cmplz_generate_preview_css': {'cmplz_generate_preview_css'}, 'listen_for_cancel_tour': {'cmplz_cancel_tour'}, 'process_ajax_install_plugin': {'rsp_upgrade_install_plugin'}, 'ajax_delete_snapshot': {'cmplz_delete_snapshot'}, 'dismiss_review_notice_callback': {'cmplz_dismiss_review_notice'}, 'process_ajax_destination_clear': {'rsp_upgrade_destination_clear'}, 'ajax_load_gridblock': {'cmplz_load_gridblock'}, 'ajax_script_add': {'cmplz_script_add'}, 'download_plugin': {'cmplz_download_plugin'}, 'cmplz_duplicate_cookiebanner': {'cmplz_duplicate_cookiebanner'}, 'activate_plugin': {'cmplz_activate_plugin'}, 'cmplz_delete_cookiebanner': {'cmplz_delete_cookiebanner'}, 'dismiss_warning': {'cmplz_dismiss_admin_notice', 'cmplz_dismiss_warning'}, 'store_console_errors': {'cmplz_store_console_errors'}, 'maybe_install_suggested_plugins': {'cmplz_install_plugin'}, 'process_ajax_activate_license': {'rsp_upgrade_activate_license'}, 'process_ajax_package_information': {'rsp_upgrade_package_information'}, 'ajax_create_pages': {'cmplz_create_pages'}, 'ajax_get_list': {'cmplz_get_list'}, 'amp_endpoint': {'nopriv_cmplz_amp_endpoint', 'cmplz_amp_endpoint'}, 'process_ajax_activate_plugin': {'rsp_upgrade_activate_plugin'}, 'run_sync': {'cmplz_run_sync'}, 'ajax_load_warnings': {'cmplz_load_warnings'}, 'load_detected_cookies': {'load_detected_cookies'}}
*
***/
...
/** Function amp_endpoint() called by wp_ajax hooks: {'nopriv_cmplz_amp_endpoint', 'cmplz_amp_endpoint'} **/
/** No params detected :-/ **/
