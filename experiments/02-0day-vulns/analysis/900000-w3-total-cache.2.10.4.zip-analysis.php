...
*Overview: {'ajax_revert_all': {'w3tc_imageservice_revertall'}, 'ajax_submit': {'w3tc_imageservice_submit'}, 'ajax_get_postmeta': {'w3tc_imageservice_postmeta'}, 'wp_ajax_w3tc_forums_api': {'w3tc_forums_api'}, 'ajax_recheck_license': {'w3tc_recheck_license'}, 'w3tc_ajax_ustats_access_log_test': {'ustats_access_log_test'}, 'ajax_convert_all': {'w3tc_imageservice_all'}, 'action_widget_latest_ajax': {'w3tc_widget_latest_ajax'}, 'ajax_revert': {'w3tc_imageservice_revert'}, 'ajax_get_usage': {'w3tc_imageservice_usage'}, 'action_widget_latest_news_ajax': {'w3tc_widget_latest_news_ajax'}, 'wp_ajax_w3tc_ajax': {'w3tc_ajax'}, 'ajax_dismiss_license_notice': {'w3tc_dismiss_license_notice'}, 'ajax_get_counts': {'w3tc_imageservice_counts'}}
*
***/
