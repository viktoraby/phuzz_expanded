...
*Overview: {'update_dashboard_user_options': {'pvc_dashboard_user_options'}, 'check_post_js': {'nopriv_pvc-check-post', 'pvc-check-post'}, 'handle_test_email_ajax': {'pvc_send_test_email'}, 'dashboard_post_views_chart': {'pvc_dashboard_post_views_chart'}, 'ajax_column_chart': {'pvc_column_chart'}, 'queue_count': {'pvc-view-posts', 'nopriv_pvc-view-posts'}, 'dashboard_post_most_viewed': {'pvc_dashboard_post_most_viewed'}, 'get_queue_runtime_data': {'nopriv_pvc-queue-runtime', 'pvc-queue-runtime'}, 'save_bulk_post_views': {'save_bulk_post_views'}, 'dismiss_notice': {'pvc_dismiss_notice'}}
*
***/
...
/** Function queue_count() called by wp_ajax hooks: {'pvc-view-posts', 'nopriv_pvc-view-posts'} **/
