...
*Overview: {'ajax_restore_notification': {'yoast_restore_notification'}, 'dismiss_notice': {'wpseo_dismiss_plugin_conflict'}, 'ajax_get_notifications': {'yoast_get_notifications'}, 'wpseo_save_all_titles': {'wpseo_save_all_titles'}, 'dismiss_first_time_configuration_notice': {'dismiss_first_time_configuration_notice'}, 'ajax_get_keyword_usage_and_post_types': {'get_focus_keyword_usage_and_post_types'}, 'dismiss_premium_deactivated_notice': {'dismiss_premium_deactivated_notice'}, 'wpseo_save_description': {'wpseo_save_metadesc'}, 'resolve_alert': {'wpseo_resolve_alert'}, 'ajax_get_term_keyword_usage': {'get_term_keyword_usage'}, 'wpseo_set_ignore': {'wpseo_set_ignore'}, 'wpseo_save_all_descriptions': {'wpseo_save_all_descriptions'}, 'save_postdata': {'wpseo_elementor_save'}, 'do_filter': {'wpseo_filter_shortcodes'}, 'Yoast_Notification_Center': {'yoast_dismiss_notification'}, 'wpseo_set_option': {'wpseo_set_option'}, 'ajax_dismiss_notification': {'yoast_dismiss_notification'}, 'wpseo_save_title': {'wpseo_save_title'}}
*
***/
...
/** Function resolve_alert() called by wp_ajax hooks: {'wpseo_resolve_alert'} **/
/** Parameters found in function resolve_alert(): {"post": ["alertId"]} **/
