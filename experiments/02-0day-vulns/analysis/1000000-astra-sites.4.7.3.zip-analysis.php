...
*Overview: {'enable_other_builders': {'astra-sites-show-other-builders'}, 'import_latepoint': {'astra-sites-import-latepoint'}, 'sse_import': {'astra-wxr-import'}, 'disabler_ajax': {'zip_ai_disabler_ajax'}, 'set_woopayments_analytics': {'astra_sites_set_woopayments_analytics'}, 'ajax_sites_requests_count': {'ast-block-templates-get-sites-request-count'}, 'import_prepare_xml': {'astra-sites-import_prepare_xml'}, 'track_onboarding_step': {'astra_sites_track_onboarding_step'}, 'dismiss_woopayments_notice': {'dismiss_woopayments_notice'}, 'sites_requests_count': {'astra-sites-get-sites-request-count'}, 'activate_plugin': {'ast_block_templates_activate_plugin'}, 'import_sites': {'astra-sites-import-sites'}, 'import_blocks': {'astra-sites-import-blocks'}, 'hide_notices': {'ast_block_templates_hide_notices'}, 'download_selected_image': {'astra-sites-download-image'}, 'get_latest_credit_details': {'zip_ai_get_latest_credit_details'}, 'generate_ai_content': {'ast-block-templates-regenerate'}, 'get_fresh_credit_details': {'zip_ai_get_fresh_credit_details'}, 'send_plugin_deactivate_feedback': {'uds_plugin_deactivate_feedback'}, 'dismiss_notice': {'astra-notice-dismiss'}, 'import_sureforms': {'ast_block_templates_import_sureforms'}, 'get_color_palette': {'ast_block_templates_color_palette'}, 'update_library_complete': {'astra-sites-update-library-complete'}, 'verify_required_plugins': {'astra-sites-verify-required-plugins'}, 'import_block': {'ast_block_templates_import_block'}, 'sync_via_ajax': {'ast-block-templates-check-sync-library-status'}, 'import_all_categories': {'astra-sites-import-all-categories'}, 'save_auto_open_setting': {'ast_block_templates_save_auto_open_setting'}, 'import_wpforms': {'astra-sites-import-wpforms', 'ast_block_templates_import_wpforms'}, 'get_all_sites': {'astra-sites-get-all-sites'}, 'template_importer': {'ast_block_templates_importer', 'ast_block_templates_kit_importer'}, 'api_request': {'ast_block_templates_data_option'}, 'ajax_import_blocks': {'ast-block-templates-import-blocks'}, 'ajax_import_sites': {'ast-block-templates-import-sites'}, 'save_page_builder_on_ajax': {'astra-sites-change-page-builder'}, 'bsf_analytics_optin_status': {'astra_sites_usage_optin_status'}, 'zipwp_insert_image': {'zipwp_images_insert_image'}, 'import_cartflows': {'astra-sites-import-cartflows'}, 'blocks_requests_count': {'astra-sites-get-blocks-request-count'}, 'dismiss_ai_promotion': {'astra-sites-dismiss-ai-promotion'}, 'handle_dismiss_notice_ajax': {'dismiss_gs_notice'}, 'verify_authenticity': {'zip_ai_verify_authenticity'}, 'get_all_categories_and_tags': {'astra-sites-get-all-categories-and-tags'}, 'import_block_categories': {'astra-sites-import-block-categories'}, 'toggle_assistant_status_ajax': {'zip_ai_toggle_assistant_status_ajax'}, 'skip_spectra_pro_onboarding': {'ast_skip_zip_ai_onboarding'}, 'import_all_categories_and_tags': {'astra-sites-import-all-categories-and-tags'}, 'reset_business_details': {'ast-block-templates-reset-business-details'}, 'get_all_categories': {'astra-sites-get-all-categories'}, 'import_cart_abandonment_recovery': {'astra-sites-import-cart-abandonment-recovery'}, 'update_library': {'astra-sites-update-library'}, 'import_page_builders': {'astra-sites-import-page-builders'}, 'save_user_details': {'ast-block-templates-ai-content'}, 'import_template_kit': {'ast_block_templates_import_template_kit'}}
*
***/
...
/** Function import_wpforms() called by wp_ajax hooks: {'astra-sites-import-wpforms', 'ast_block_templates_import_wpforms'} **/
...
/** Function template_importer() called by wp_ajax hooks: {'ast_block_templates_importer', 'ast_block_templates_kit_importer'} **/
