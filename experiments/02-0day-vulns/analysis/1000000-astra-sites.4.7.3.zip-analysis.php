...
*Overview: {'reset_business_details': {'ast-block-templates-reset-business-details'}, 'dismiss_notice': {'astra-notice-dismiss'}, 'dismiss_ai_promotion': {'astra-sites-dismiss-ai-promotion'}, 'handle_dismiss_notice_ajax': {'dismiss_gs_notice'}, 'import_prepare_xml': {'astra-sites-import_prepare_xml'}, 'bsf_analytics_optin_status': {'astra_sites_usage_optin_status'}, 'import_sites': {'astra-sites-import-sites'}, 'disabler_ajax': {'zip_ai_disabler_ajax'}, 'get_fresh_credit_details': {'zip_ai_get_fresh_credit_details'}, 'import_template_kit': {'ast_block_templates_import_template_kit'}, 'ajax_import_blocks': {'ast-block-templates-import-blocks'}, 'import_block_categories': {'astra-sites-import-block-categories'}, 'dismiss_woopayments_notice': {'dismiss_woopayments_notice'}, 'hide_notices': {'ast_block_templates_hide_notices'}, 'save_auto_open_setting': {'ast_block_templates_save_auto_open_setting'}, 'get_all_categories_and_tags': {'astra-sites-get-all-categories-and-tags'}, 'get_latest_credit_details': {'zip_ai_get_latest_credit_details'}, 'update_library_complete': {'astra-sites-update-library-complete'}, 'get_all_sites': {'astra-sites-get-all-sites'}, 'zipwp_insert_image': {'zipwp_images_insert_image'}, 'import_block': {'ast_block_templates_import_block'}, 'import_latepoint': {'astra-sites-import-latepoint'}, 'import_all_categories': {'astra-sites-import-all-categories'}, 'get_all_categories': {'astra-sites-get-all-categories'}, 'skip_spectra_pro_onboarding': {'ast_skip_zip_ai_onboarding'}, 'track_onboarding_step': {'astra_sites_track_onboarding_step'}, 'blocks_requests_count': {'astra-sites-get-blocks-request-count'}, 'ajax_import_sites': {'ast-block-templates-import-sites'}, 'toggle_assistant_status_ajax': {'zip_ai_toggle_assistant_status_ajax'}, 'ajax_sites_requests_count': {'ast-block-templates-get-sites-request-count'}, 'get_color_palette': {'ast_block_templates_color_palette'}, 'save_page_builder_on_ajax': {'astra-sites-change-page-builder'}, 'import_sureforms': {'ast_block_templates_import_sureforms'}, 'save_user_details': {'ast-block-templates-ai-content'}, 'download_selected_image': {'astra-sites-download-image'}, 'import_wpforms': {'astra-sites-import-wpforms', 'ast_block_templates_import_wpforms'}, 'import_all_categories_and_tags': {'astra-sites-import-all-categories-and-tags'}, 'import_blocks': {'astra-sites-import-blocks'}, 'activate_plugin': {'ast_block_templates_activate_plugin'}, 'verify_authenticity': {'zip_ai_verify_authenticity'}, 'import_cart_abandonment_recovery': {'astra-sites-import-cart-abandonment-recovery'}, 'enable_other_builders': {'astra-sites-show-other-builders'}, 'sites_requests_count': {'astra-sites-get-sites-request-count'}, 'api_request': {'ast_block_templates_data_option'}, 'generate_ai_content': {'ast-block-templates-regenerate'}, 'sse_import': {'astra-wxr-import'}, 'import_cartflows': {'astra-sites-import-cartflows'}, 'send_plugin_deactivate_feedback': {'uds_plugin_deactivate_feedback'}, 'template_importer': {'ast_block_templates_importer', 'ast_block_templates_kit_importer'}, 'update_library': {'astra-sites-update-library'}, 'sync_via_ajax': {'ast-block-templates-check-sync-library-status'}, 'import_page_builders': {'astra-sites-import-page-builders'}, 'verify_required_plugins': {'astra-sites-verify-required-plugins'}, 'set_woopayments_analytics': {'astra_sites_set_woopayments_analytics'}}
*
***/
