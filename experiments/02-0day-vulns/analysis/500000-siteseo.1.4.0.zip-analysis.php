...
*Overview: {'\\SiteSEO\\Ajax::save_universal_metabox': {'siteseo_save_universal_metabox'}, '\\SiteSEO\\Ajax::instant_indexing': {'siteseo_url_submitter_submit'}, '\\SiteSEO\\Ajax::clear_indexing_history': {'siteseo_clear_indexing_history'}, '\\SiteSEO\\Ajax::refresh_seo_analysis': {'siteseo_refresh_analysis'}, '\\SiteSEO\\Ajax::handle_import': {'siteseo_migrate_seo'}, '\\SiteSEO\\Ajax::save_onboarding_settings': {'siteseo_save_onboarding_settings'}, '\\SiteSEO\\Ajax::generate_app_password': {'siteseo_generate_app_password'}, '\\SiteSEO\\Ajax::resolve_variables': {'siteseo_resolve_variables'}, '\\SiteSEO\\Ajax::generate_bing_api_key': {'siteseo_generate_bing_api_key'}, '\\SiteSEO\\Ajax::close_update_notice': {'siteseo_close_update_notice'}, '\\SiteSEO\\Ajax::dismiss_intro': {'siteseo_dismiss_intro'}, '\\SiteSEO\\Ajax::reset_settings': {'siteseo_reset_settings'}, '\\SiteSEO\\Ajax::save_test_status': {'siteseo_save_test_status'}, '\\SiteSEO\\Ajax::install_mcp_adapter': {'siteseo_install_mcp_adapter'}, '\\SiteSEO\\Ajax::export_settings': {'siteseo_export_settings'}, '\\SiteSEO\\Ajax::save_toggle_state': {'siteseo_save_sitemap_toggle', 'siteseo_save_abilities', 'siteseo_save_titles_meta_toggle', 'siteseo_save_analytics_toggle', 'siteseo_save_advanced_toggle', 'siteseo_save_indexing_toggle', 'siteseo_save_social_toggle'}, '\\SiteSEO\\Ajax::test_mcp_connection': {'siteseo_test_mcp_connection'}, '\\SiteSEO\\Ajax::import_settings': {'siteseo_import_settings'}}
*
***/
...
/** Function \SiteSEO\Ajax::save_toggle_state() called by wp_ajax hooks: {'siteseo_save_sitemap_toggle', 'siteseo_save_abilities', 'siteseo_save_titles_meta_toggle', 'siteseo_save_analytics_toggle', 'siteseo_save_advanced_toggle', 'siteseo_save_indexing_toggle', 'siteseo_save_social_toggle'} **/
