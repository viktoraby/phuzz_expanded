...
*Overview: {'view_file_diff': {'health-check-view-file-diff'}, 'Health_Check_Loopback': {'health-check-loopback-no-plugins', 'health-check-loopback-individual-plugins', 'health-check-loopback-default-theme'}, 'run_mail_check': {'health-check-mail-check'}, 'run_files_integrity_check': {'health-check-files-integrity-check'}}
*
***/
...
/** Function Health_Check_Loopback() called by wp_ajax hooks: {'health-check-loopback-no-plugins', 'health-check-loopback-individual-plugins', 'health-check-loopback-default-theme'} **/
/** No function found :-/ **/
