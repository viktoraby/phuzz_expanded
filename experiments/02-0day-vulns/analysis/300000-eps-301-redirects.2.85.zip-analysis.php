...
*Overview: {'dismiss_pointer_ajax': {'eps_dismiss_pointer'}, 'ajax_get_inline_edit_entry': {'eps_redirect_get_inline_edit_entry'}, 'ajax_eps_delete_entry': {'eps_redirect_delete_entry'}, 'ajax_get_entry': {'eps_redirect_get_new_entry'}, 'ajax_save_redirect': {'eps_redirect_save'}}
*
***/
