...
*Overview: {'generate_document_ajax': {'nopriv_generate_wpo_wcpdf', 'generate_wpo_wcpdf'}, 'set_number_store': {'wpo_wcpdf_set_next_number'}, 'ajax_get_shop_country_states': {'wcpdf_get_country_states'}, 'ajax_load_customer_order_identifiers': {'wpo_ips_edi_load_customer_order_identifiers'}, 'get_refund_order_ids_ajax': {'wpo_ips_get_refund_order_ids', 'nopriv_wpo_ips_get_refund_order_ids'}, 'ajax_edi_save_order_customer_peppol_identifiers': {'wpo_ips_edi_save_order_customer_peppol_identifiers'}, 'ajax_reload_tax_table': {'wpo_ips_edi_reload_tax_table'}, 'ajax_preview': {'wpo_wcpdf_preview'}, 'ajax_plugin_report': {'wpo_ips_plugin_report'}, 'document_printed_ajax': {'printed_wpo_wcpdf'}, 'sync_shop_address_with_woo': {'wpo_wcpdf_sync_address'}, 'get_media_upload_setting_html': {'wpo_wcpdf_get_media_upload_setting_html'}, 'ajax_process_settings_debug_tools': {'wpo_wcpdf_debug_tools'}, 'ajax_save_taxes': {'wpo_ips_edi_save_taxes'}, 'ajax_process_danger_zone_tools': {'wpo_wcpdf_danger_zone_tools'}, 'ajax_numbers_data': {'wpo_wcpdf_numbers_data'}, 'ajax_crud_document': {'wpo_wcpdf_delete_document', 'wpo_wcpdf_regenerate_document', 'wpo_wcpdf_save_document'}, 'ajax_preview_formatted_number': {'wpo_wcpdf_preview_formatted_number'}, 'preview_order_search': {'wpo_wcpdf_preview_order_search'}}
*
***/
...
/** Function get_refund_order_ids_ajax() called by wp_ajax hooks: {'wpo_ips_get_refund_order_ids', 'nopriv_wpo_ips_get_refund_order_ids'} **/
