...
/** Parameters found in function \SpeedyCache\Ajax::save_media_settings(): {"request": ["gravatar_cache", "lazy_load", "lazy_load_placeholder_custom_url", "exclude_above_fold", "lazy_load_keywords", "image_dimensions", "local_gfonts", "google_fonts", "font_rendering"]} **/
function save_media_settings(){
		check_ajax_referer('speedycache_ajax_nonce');
...
/** Parameters found in function \SpeedyCache\Ajax::save_object_settings(): {"request": ["enable_object", "persistent", "admin", "async_flush", "non_cache_group"]} **/
function save_object_settings(){
		check_ajax_referer('speedycache_ajax_nonce');
...
/** Function \SpeedyCache\Ajax::flush_objs() called by wp_ajax hooks: {'speedycache_flush_objects'} **/
/** No params detected :-/ **/
...
/** Parameters found in function \SpeedyCache\Ajax::add_preload_settings(): {"request": ["type", "settings"]} **/
function add_preload_settings(){
