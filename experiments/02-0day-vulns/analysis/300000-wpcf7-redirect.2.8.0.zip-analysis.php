...
*Overview: {'_retry_connectivity_test': {'fs_retry_connectivity_test_{$ajax_action_suffix}'}, 'Freemius': {'fs_toggle_debug_mode'}, 'send_debug_info': {'send_debug_info'}, 'delete_action_post': {'wpcf7r_delete_action'}, 'make_api_test': {'wpcf7r_make_api_test'}, 'duplicate_action': {'wpcf7r_duplicate_action'}, 'wpcf7r_reset_settings': {'wpcf7r_reset_settings'}, 'activate_extension': {'activate_wpcf7r_extension'}, 'add_action_post': {'wpcf7r_add_action'}, 'deactivate_plugin_license': {'deactivate_wpcf7r_extension'}, 'set_action_menu_order': {'wpcf7r_set_action_menu_order'}, 'dismiss_notice_ajax_callback': {'fs_dismiss_notice_action_{$ajax_action_suffix}'}, '_email_about_firewall_issue': {'fs_resolve_firewall_issues_{$ajax_action_suffix}'}, 'migrate_all_forms': {'wpcf7r_migrate_all_forms'}, 'get_coupon': {'get_coupon'}, 'get_action_template': {'wpcf7r_get_action_template'}, 'close_banner': {'close_ad_banner'}}
*
***/
