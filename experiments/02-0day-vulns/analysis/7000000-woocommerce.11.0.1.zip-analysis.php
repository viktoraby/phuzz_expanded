...
*Overview: {'ajax_remind_later': {'woocommerce_remind_later_product_usage_notice'}, 'delete_zone_count_transient': {'woocommerce_shipping_zone_methods_save_changes', 'woocommerce_shipping_zones_save_changes'}, 'handle_edit_review': {'edit-comment'}, 'ajax_dismiss': {'woocommerce_dismiss_product_usage_notice'}, 'do_ajax_product_export': {'woocommerce_do_ajax_product_export'}, 'do_ajax_product_import': {'woocommerce_do_ajax_product_import'}, 'ajax_tracks': {'jetpack_tracks'}, 'ajax_check_refund_fix_needed': {'woocommerce_check_refund_fix_needed'}, 'handle_ajax_dismiss': {'wc_egg_dismiss'}, 'handle_ajax_opt_out': {'wc_egg_opt_out'}, 'ajax_action_inbox_notification_search': {'woocommerce_json_inbox_notifications_search'}, 'post_add_dismissed_suggestion_handler': {'woocommerce_add_dismissed_marketplace_suggestion'}, 'sync_email_styles_with_theme': {'wp_save_styles'}, 'handle_reply_to_review': {'replyto-comment'}}
*
***/
