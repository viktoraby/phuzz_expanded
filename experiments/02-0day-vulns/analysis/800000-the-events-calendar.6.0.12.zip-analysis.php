...
*Overview: {'ajax_form_validate': {'tribe_event_validation'}, 'ajax_preview_import': {'tribe_aggregator_preview_import'}, '_email_about_firewall_issue': {'fs_resolve_firewall_issues_{$ajax_action_suffix}'}, 'handle_ajax_request': {'nopriv_{$action}', '{$action}'}, 'ajax_convert_ical_settings': {'tribe_convert_legacy_ical_settings'}, 'ajax': {'tribe_aggregator_realtime_update'}, 'listen': {'tribe_logging_controls'}, 'handle_request': {'{$js_action}'}, 'ajax_create_import': {'tribe_aggregator_create_import'}, '_retry_connectivity_test': {'fs_retry_connectivity_test_{$ajax_action_suffix}'}, 'maybe_dismiss': {'tribe_notice_dismiss'}, 'ajax_sysinfo_optin': {'tribe_toggle_sysinfo_optin'}, 'route': {'tribe_dropdown', 'nopriv_tribe_dropdown'}, 'ajax_updater': {'tribe_timezone_update'}, 'ajax_fetch_import': {'tribe_aggregator_fetch_import'}, 'Freemius': {'fs_toggle_debug_mode'}, 'ajax_convert_legacy_ignored_events': {'tribe_convert_legacy_ignored_events'}, 'ajax_save_credentials': {'tribe_aggregator_save_credentials'}, 'dismiss_notice_ajax_callback': {'fs_dismiss_notice_action_{$ajax_action_suffix}'}}
*
***/
