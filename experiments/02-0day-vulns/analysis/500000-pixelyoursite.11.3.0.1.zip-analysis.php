...
*Overview: {'PixelYourSite\\adminNoticeDismissHandler': {'pys_notice_dismiss'}, 'catchAjaxEvent': {'nopriv_pys_api_event', 'pys_api_event'}, 'PixelYourSite\\getAjaxTransformTitle': {'get_transform_title', 'nopriv_get_transform_title'}, 'allCloseNotice': {'pys_fixed_notice_opt_dismiss'}, 'pys_optin_add': {'pys_optin_add'}, 'PixelYourSite\\adminCapiNudgeDismissHandler': {'pys_capi_nudge_dismiss'}, 'get_pbid_ajax': {'nopriv_pys_get_pbid', 'pys_get_pbid'}, 'catchOnCloseNotice': {'pys_fixed_notice_dismiss'}, 'PixelYourSite\\adminNoticeCAPIDismissHandler': {'pys_notice_CAPI_dismiss'}, 'ajaxGetGdprFiltersValues': {'pys_get_gdpr_filters_values', 'nopriv_pys_get_gdpr_filters_values'}}
*
***/
