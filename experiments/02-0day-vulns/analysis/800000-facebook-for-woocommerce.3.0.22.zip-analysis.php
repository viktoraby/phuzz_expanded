...
*Overview: {'handle_set_excluded_terms_prompt': {'facebook_for_woocommerce_set_excluded_terms_prompt'}, 'ajax_render_enhanced_catalog_attributes_field': {'wc_facebook_enhanced_catalog_attributes'}, 'ajax_woo_infobanner_post_xout': {'ajax_woo_infobanner_post_xout'}, 'handle_connection_test_response': {'nopriv_{$this->identifier}_test'}, 'ajax_reset_single_fb_product': {'ajax_reset_single_fb_product'}, 'ajax_display_test_result': {'ajax_display_test_result'}, 'get_sync_status': {'wc_facebook_get_sync_status'}, 'ajax_reset_all_fb_products': {'ajax_reset_all_fb_products'}, 'ajax_check_feed_upload_status': {'ajax_check_feed_upload_status'}, 'ajax_fb_background_check_queue': {'ajax_fb_background_check_queue'}, 'ajax_woo_adv_bulk_edit_compat': {'wpmelon_adv_bulk_edit'}, 'ajax_sync_all_fb_products': {'ajax_sync_all_fb_products'}, 'handle_set_product_sync_bulk_action_prompt': {'facebook_for_woocommerce_set_product_sync_bulk_action_prompt'}, 'ajax_fb_toggle_visibility': {'ajax_fb_toggle_visibility'}, 'sync_products': {'wc_facebook_sync_products'}, 'handle_set_product_sync_prompt': {'facebook_for_woocommerce_set_product_sync_prompt'}, 'ajax_delete_fb_product': {'ajax_delete_fb_product'}, 'ajax_woo_infobanner_post_click': {'ajax_woo_infobanner_post_click'}}
*
***/
