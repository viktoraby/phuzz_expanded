...
*Overview: {'handle_plugin_action': {'mb_dashboard_plugin_action'}, 'ajax_delete_file': {'rwmb_delete_file'}, 'get_feed': {'mb_dashboard_feed'}, 'ajax_get_posts': {'rwmb_get_posts', 'nopriv_rwmb_get_posts'}, 'ajax_get_embed': {'rwmb_get_embed'}, 'ajax_get_users': {'nopriv_rwmb_get_users', 'rwmb_get_users'}, 'ajax_get_terms': {'rwmb_get_terms', 'nopriv_rwmb_get_terms'}}
*
***/
