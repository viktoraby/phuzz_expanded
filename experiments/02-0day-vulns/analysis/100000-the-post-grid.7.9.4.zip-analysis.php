...
*Overview: {'defaultFilterItem': {'defaultFilterItem'}, 'nonceID': {'install_plugin', 'activate_plugin'}, 'dismiss_summer_notice': {'dismiss_summer_notice'}, 'getCfGroupListAsField': {'getCfGroupListAsField'}, 'rttpg_get_el_layouts': {'rttpg_get_el_layouts'}, 'rtTPGTaxonomyListByPostType': {'rtTPGTaxonomyListByPostType'}, 'rttpg_get_layouts': {'rttpg_get_layouts'}, 'shortCodeList': {'rtTPGShortCodeList'}, 'get_posts_call': {'rttpg_block_css_get_posts'}, 'rttpg_el_layout_count': {'rttpg_el_layout_count'}, 'rttpg_guten_layout_count': {'rttpg_guten_layout_count'}, 'tpgPreviewAjaxCall': {'tpgPreviewAjaxCall'}, 'dismiss_eid_notice': {'dismiss_eid_notice'}, 'rtTPGIsotopeFilter': {'rtTPGIsotopeFilter'}, 'appended': {'rttpg_block_css_appended'}, 'rtTPGSaveSettings': {'rtTPGSettings'}, 'rtTPGTermListByTaxonomy': {'rtTPGTermListByTaxonomy'}, 'save_block_css': {'rttpg_block_css_save'}, 'dismiss_black_friday_notice': {'rttpg_dismiss_black_friday_notice'}}
*
***/

/** Function defaultFilterItem() called by wp_ajax hooks: {'defaultFilterItem'} **/
/** Parameters found in function defaultFilterItem(): {"request": ["filter", "include"]} **/
...
/** Function nonceID() called by wp_ajax hooks: {'install_plugin', 'activate_plugin'} **/
/** No function found :-/ **/


/** Function dismiss_summer_notice() called by wp_ajax hooks: {'dismiss_summer_notice'} **/
/** No params detected :-/ **/


/** Function getCfGroupListAsField() called by wp_ajax hooks: {'getCfGroupListAsField'} **/
/** Parameters found in function getCfGroupListAsField(): {"request": ["post_type"]} **/
...
/** Function rttpg_get_el_layouts() called by wp_ajax hooks: {'rttpg_get_el_layouts'} **/
/** Parameters found in function rttpg_get_el_layouts(): {"request": ["force"]} **/
function rttpg_get_el_layouts() {
...
/** Function rtTPGTaxonomyListByPostType() called by wp_ajax hooks: {'rtTPGTaxonomyListByPostType'} **/
/** Parameters found in function rtTPGTaxonomyListByPostType(): {"request": ["post_type", "taxonomy"]} **/
...
/** Function rttpg_get_layouts() called by wp_ajax hooks: {'rttpg_get_layouts'} **/
/** Parameters found in function rttpg_get_layouts(): {"request": ["force"]} **/
function rttpg_get_layouts() {
...
/** Function shortCodeList() called by wp_ajax hooks: {'rtTPGShortCodeList'} **/
/** No params detected :-/ **/


/** Function get_posts_call() called by wp_ajax hooks: {'rttpg_block_css_get_posts'} **/
/** Parameters found in function get_posts_call(): {"post": ["postId"]} **/
function get_posts_call() {
...
/** Function rttpg_el_layout_count() called by wp_ajax hooks: {'rttpg_el_layout_count'} **/
/** Parameters found in function rttpg_el_layout_count(): {"request": ["status", "layout_id"]} **/
function rttpg_el_layout_count() {
...
/** Function rttpg_guten_layout_count() called by wp_ajax hooks: {'rttpg_guten_layout_count'} **/
/** Parameters found in function rttpg_guten_layout_count(): {"request": ["status", "layout_id"]} **/
function rttpg_guten_layout_count() {
...
/** Function tpgPreviewAjaxCall() called by wp_ajax hooks: {'tpgPreviewAjaxCall'} **/
/** Parameters found in function tpgPreviewAjaxCall(): {"request": ["layout", "column", "tpg_tab_column", "tpg_mobile_column", "feature_image", "featured_image_size", "media_source", "tgp_excerpt_type", "tpg_title_limit_type", "excerpt_limit", "tpg_title_limit", "tgp_excerpt_more_text", "tgp_read_more_text", "tpg_show_all_text", "tpg_title_position", "tpg_read_more_button_alignment", "tpg_category_position", "tpg_category_style", "tpg_category_icon", "tpg_meta_position", "tpg_meta_icon", "tpg_meta_separator", "tpg_post_type", "post__in", "post__not_in", "limit", "offset", "pagination", "posts_loading_type", "posts_per_page", "post_filter", "tgp_filter_taxonomy", "tgp_filter_taxonomy_hierarchical", "tpg_taxonomy", "taxonomy_relation", "order_by", "order", "tpg_meta_key", "orderby", "tpg_post_status", "author", "s", "date_range_start", "date_range_end", "tgp_layout2_image_column", "grid_style", "tpg_category_bg", "tpg_image_animation", "margin_option", "tpg_image_type", "link_to_detail_page", "detail_page_link_type", "popup_type", "link_target", "parent_class", "default_preview_image", "custom_image_size", "featured_small_image_size", "custom_small_image_size", "item_fields", "sc_id", "ignore_sticky_posts", "tgp_filter", "tgp_default_filter", "tpg_hide_all_button", "title_tag", "primary_color", "button_bg_color", "button_active_bg_color", "button_hover_bg_color", "button_text_color", "button_text_bg_color", "button_border_color", "button_hover_text_color", "overlay_color", "overlay_opacity", "overlay_padding", "tgp_gutter", "tpg_read_more_button_border_radius", "tpg_full_area_bg", "tpg_full_area_margin", "tpg_content_wrap_bg", "tpg_content_wrap_border", "tpg_content_wrap_border_color", "tpg_content_wrap_border_radius", "tpg_content_wrap_shadow", "tpg_box_padding", "tpg_content_padding", "tpg_heading_bg", "tpg_heading_color", "tpg_heading_border_color", "tpg_heading_border_size", "tpg_heading_margin", "tpg_heading_padding", "tpg_category_color", "tpg_category_border_radius", "tpg_category_margin", "tpg_category_padding", "rt_tpg_category_font_size", "tpg_image_border_radius", "title_color", "title_size", "title_weight", "title_alignment", "title_hover_color", "excerpt_color", "excerpt_size", "excerpt_weight", "excerpt_alignment", "meta_data_color", "meta_data_size", "meta_data_weight", "meta_data_alignment", "tpg_heading_tag", "tpg_heading_style", "tpg_heading_alignment", "tpg_heading_link", "tgp_filter_type", "tpg_post_count", "carousel_property", "tpg_carousel_speed", "tpg_carousel_autoplay_timeout", "isotope_filter", "isotope_filter_dropdown", "isotope_default_filter", "isotope_filter_show_all", "isotope_filter_count", "isotope_filter_url", "isotope_search_filter", "tgp_not_found_text", "load_more_text"]} **/
...
/** Function dismiss_eid_notice() called by wp_ajax hooks: {'dismiss_eid_notice'} **/
/** No params detected :-/ **/


/** Function rtTPGIsotopeFilter() called by wp_ajax hooks: {'rtTPGIsotopeFilter'} **/
/** Parameters found in function rtTPGIsotopeFilter(): {"request": ["post_type"]} **/
...
/** Function appended() called by wp_ajax hooks: {'rttpg_block_css_appended'} **/
/** No params detected :-/ **/


/** Function rtTPGSaveSettings() called by wp_ajax hooks: {'rtTPGSettings'} **/
/** Parameters found in function rtTPGSaveSettings(): {"request": ["uid", "action", "_wp_http_referer"]} **/
...
/** Function rtTPGTermListByTaxonomy() called by wp_ajax hooks: {'rtTPGTermListByTaxonomy'} **/
/** Parameters found in function rtTPGTermListByTaxonomy(): {"request": ["taxonomy"]} **/
...
/** Function save_block_css() called by wp_ajax hooks: {'rttpg_block_css_save'} **/
/** Parameters found in function save_block_css(): {"post": ["post_id", "block_css", "has_block"]} **/
function save_block_css() {
...
/** Function dismiss_black_friday_notice() called by wp_ajax hooks: {'rttpg_dismiss_black_friday_notice'} **/
/** No params detected :-/ **/
