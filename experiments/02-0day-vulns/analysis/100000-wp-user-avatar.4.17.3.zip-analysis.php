...
*Found actions: 44
*Found functions:35
*Extracted functions:34
*Total parameter names extracted: 31
*Overview: {'dismiss_admin_notice': {'dismiss_admin_notice'}, 'form_type_selection': {'pp_form_type_selection'}, 'ajax_login_func': {'nopriv_pp_ajax_login', 'pp_ajax_login'}, 'get_content_condition_field': {'ppress_content_condition_field'}, 'payment_methods_sortable': {'ppress_payment_methods_sortable'}, 'delete_order_note': {'ppress_delete_order_note'}, 'profile_fields_sortable_func': {'pp_profile_fields_sortable'}, 'remove_discount': {'nopriv_ppress_checkout_remove_discount', 'ppress_checkout_remove_discount'}, 'create_form': {'pp_create_form'}, 'ppress_activate_plugin': {'ppress_activate_plugin'}, 'generate_url': {'ppress_connect_url'}, 'search_wp_users': {'ppress_mb_search_wp_users'}, 'ajax_check_plugin_status': {'ppress_mailoptin_page_check_plugin_status', 'ppress_fusewp_page_check_plugin_status'}, 'process_checkout_login': {'nopriv_ppress_process_checkout_login'}, 'ajax_delete_profile_cover_image': {'pp_del_cover_image'}, 'get_exempt_content_condition_field': {'ppress_exempt_content_condition_field'}, 'ajax_editprofile_func': {'pp_ajax_editprofile'}, 'ProfilePressVendor\\PAnD': {'dismiss_admin_notice'}, 'get_forms_by_builder_type': {'pp_get_forms_by_builder_type'}, 'replace_order_item_modal': {'ppress_modal_replace_order_item'}, 'apply_discount': {'ppress_checkout_apply_discount', 'nopriv_ppress_checkout_apply_discount'}, 'get_content_condition_search': {'ppress_cr_object_search'}, 'pp_contact_info_sortable_func': {'pp_contact_info_sortable'}, 'search_plan_coupon': {'ppress_mb_order_modal_search'}, 'process_checkout': {'ppress_process_checkout', 'nopriv_ppress_process_checkout'}, 'wpua_ajax_tinymce': {'wp_user_avatar_tinymce'}, 'ajax_passwordreset_func': {'pp_ajax_passwordreset', 'nopriv_pp_ajax_passwordreset'}, 'contextual_state_field': {'nopriv_ppress_contextual_state_field', 'ppress_contextual_state_field'}, 'process': {'nopriv_ppress_connect_process'}, 'search_customers': {'ppress_mb_search_customers'}, 'ajax_signup_func': {'nopriv_pp_ajax_signup', 'pp_ajax_signup'}, 'ajax_delete_avatar': {'pp_del_avatar'}, 'search_membership_plans': {'ppress_mb_search_plans'}, 'ppress_install_plugin': {'ppress_install_plugin'}, 'update_order_review': {'ppress_update_order_review', 'nopriv_ppress_update_order_review'}}
*
***/
...
/** Function ajax_login_func() called by wp_ajax hooks: {'nopriv_pp_ajax_login', 'pp_ajax_login'} **/
...
/** Function ajax_check_plugin_status() called by wp_ajax hooks: {'ppress_mailoptin_page_check_plugin_status', 'ppress_fusewp_page_check_plugin_status'} **/
/** No params detected :-/ **/
...
/** Function get_exempt_content_condition_field() called by wp_ajax hooks: {'ppress_exempt_content_condition_field'} **/
/** Parameters found in function get_exempt_content_condition_field(): {"post": ["field_type", "facetId", "facetListId", "condition_id"]} **/
function get_exempt_content_condition_field()
	{
		check_ajax_referer('ppress_cr_nonce', 'nonce');
...
/** Parameters found in function get_forms_by_builder_type(): {"post": ["is_member_directory", "data"]} **/
...
/** Parameters found in function process_checkout(): {"post": ["_ppress_timestamp", "_ppress_honeypot", "plan_id", "change_plan_sub_id", "ppress_payment_method"]} **/
...
/** Function contextual_state_field() called by wp_ajax hooks: {'nopriv_ppress_contextual_state_field', 'ppress_contextual_state_field'} **/
/** No params detected :-/ **/
...
/** Function ajax_signup_func() called by wp_ajax hooks: {'nopriv_pp_ajax_signup', 'pp_ajax_signup'} **/
