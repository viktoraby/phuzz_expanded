...
*Overview: {'email_domain_check_test': {'health-check-email-domain_check_test'}, 'update_settings': {'easy_wp_smtp_vue_update_settings'}, 'process_ajax_debug_event_preview': {'easy_wp_smtp_debug_event_preview'}, 'install_plugin': {'easy_wp_smtp_vue_install_plugin'}, 'process': {'nopriv_easy_wp_smtp_connect_process'}, 'get_settings': {'easy_wp_smtp_vue_get_settings'}, 'feedback_notice_dismiss': {'easy_wp_smtp_feedback_notice_dismiss'}, 'process_ajax': {'easy_wp_smtp_ajax'}, 'get_oauth_url': {'easy_wp_smtp_vue_get_oauth_url'}, 'upgrade_plugin': {'easy_wp_smtp_vue_upgrade_plugin'}, 'remove_oauth_connection': {'easy_wp_smtp_vue_remove_oauth_connection'}, 'check_mailer_configuration': {'easy_wp_smtp_vue_check_mailer_configuration'}, 'send_feedback': {'easy_wp_smtp_vue_send_feedback'}, 'clear_log': {'swpsmtp_clear_log'}, 'process_ajax_delete_all_debug_events': {'easy_wp_smtp_delete_all_debug_events'}, 'wizard_steps_started': {'easy_wp_smtp_vue_wizard_steps_started'}, 'dismiss': {'easy_wp_smtp_notification_dismiss'}, 'get_partner_plugins_info': {'easy_wp_smtp_vue_get_partner_plugins_info'}, 'subscribe_to_newsletter': {'easy_wp_smtp_vue_subscribe_to_newsletter'}, 'ajax_generate_url': {'easy_wp_smtp_connect_url'}}
*
***/
