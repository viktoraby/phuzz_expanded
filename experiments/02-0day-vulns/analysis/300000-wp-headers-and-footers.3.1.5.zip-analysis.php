...
*Overview: {'ajax_dismiss_verification_notice': {'wpb_sdk_dismiss_verification_notice'}, 'wp_headers_and_footers_log_download': {'wpheadersandfooters_log_download'}, 'ajax_resend_verification_email': {'wpb_sdk_resend_verification_email'}}
*
***/
