...
*Overview: {'get_search_result_pages_ajax': {'wpforms_admin_form_embed_wizard_search_pages_choicesjs'}, 'ajax_check_restricted_email': {'wpforms_restricted_email', 'nopriv_wpforms_restricted_email'}, 'preview': {'wpforms_divi_preview'}, 'ajax_submit': {'nopriv_wpforms_submit', 'wpforms_submit'}, 'field_new': {'wpforms_new_field_{$this->type}'}, 'wpforms_save_form': {'wpforms_save_form'}, 'wpforms_install_addon': {'wpforms_install_addon'}, 'review_dismiss': {'wpforms_review_dismiss'}, 'fetch_revisions_list': {'wpforms_get_form_revisions'}, 'ajax_sanitize_restricted_rules': {'wpforms_sanitize_restricted_rules'}, 'get_record': {'wpforms_get_log_record'}, 'wpforms_activate_addon': {'wpforms_activate_addon'}, 'wpforms_deactivate_addon': {'wpforms_deactivate_addon'}, 'process_ajax': {'wpforms_builder_provider_ajax_{$this->core->slug}', 'wpforms_provider_ajax_{$this->slug}'}, 'ajax_sanitize_default_email': {'wpforms_sanitize_default_email'}, 'wpforms_update_form_template': {'wpforms_update_form_template'}, 'delete_tags': {'wpforms_admin_forms_overview_delete_tags'}, 'import_form': {'wpforms_import_form_{$this->slug}'}, 'ajax_check_plugin_status': {'wpforms_analytics_page_check_plugin_status', 'wpforms_smtp_page_check_plugin_status'}, 'wpforms_verify_ssl': {'wpforms_verify_ssl'}, 'install': {'wpforms_icon_choices_install'}, 'wpforms_new_form': {'wpforms_new_form'}, 'integrations_tab_disconnect': {'wpforms_settings_provider_disconnect_{$this->slug}'}, 'wpforms_builder_increase_next_field_id': {'wpforms_builder_increase_next_field_id'}, 'ajax_get_form_selector_options': {'wpforms_admin_get_form_selector_options'}, 'save_challenge_option_ajax': {'wpforms_challenge_save_option'}, 'save_internal_information_checkbox': {'wpforms_builder_save_internal_information_checkbox'}, 'ajax_update_lite_connect_enabled_setting': {'wpforms_update_lite_connect_enabled_setting'}, 'ajax_dismiss': {'wpforms_education_dismiss'}, 'notification_from_email_validate': {'wpforms_builder_notification_from_email_validate'}, 'ajax_save_favorites': {'wpforms_templates_favorite'}, 'dismiss_ajax': {'wpforms_notice_dismiss'}, 'settings_cta_dismiss': {'wpforms_lite_settings_upgrade'}, 'mark_panel_viewed': {'wpforms_mark_panel_viewed'}, 'ajax_connect': {'wpforms_settings_provider_add_{$this->core->slug}'}, 'process': {'nopriv_wpforms_connect_process'}, 'captcha_field_callback': {'wpforms_update_field_captcha'}, 'wpforms_builder_dynamic_choices': {'wpforms_builder_dynamic_choices'}, 'dismiss': {'wpforms_notification_dismiss'}, 'ajax_disconnect': {'wpforms_settings_provider_disconnect_{$this->core->slug}'}, 'get_embed_page_url_ajax': {'wpforms_admin_form_embed_wizard_embed_page_url'}, 'save_tags': {'wpforms_admin_forms_overview_save_tags'}, 'wpforms_ajax_search_pages_for_dropdown': {'wpforms_ajax_search_pages_for_dropdown'}, 'generate_url': {'wpforms_connect_url'}, 'send_contact_form_ajax': {'wpforms_challenge_send_contact_form'}, 'wpforms_builder_dynamic_source': {'wpforms_builder_dynamic_source'}, 'save_widget_meta_ajax': {'wpforms_{$widget_slug}_save_widget_meta'}, 'integrations_tab_add': {'wpforms_settings_provider_add_{$this->slug}'}}
*
***/
