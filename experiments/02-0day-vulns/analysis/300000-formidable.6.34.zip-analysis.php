...
*Overview: {'process_events': {'frm_paypal_process_events', 'nopriv_frm_square_process_events', 'nopriv_frm_paypal_process_events', 'frm_square_process_events'}, 'FrmFieldsController::create': {'frm_insert_field'}, 'FrmWelcomeTourController::ajax_dismiss_welcome_tour': {'frm_dismiss_welcome_tour'}, 'FrmPayPalLiteConnectHelper::verify': {'nopriv_frm_paypal_lite_verify'}, 'FrmFieldsController::import_options': {'frm_import_options'}, 'FrmStylesController::load_css': {'nopriv_frmpro_load_css', 'frmpro_load_css'}, 'FrmFormsController::rename_form': {'frm_rename_form'}, 'FrmPayPalLiteAppController::get_amount': {'frm_paypal_get_amount', 'nopriv_frm_paypal_get_amount'}, 'FrmSquareLiteAppController::verify_buyer': {'frm_verify_buyer', 'nopriv_frm_verify_buyer'}, 'FrmFormMigratorsHelper::dismiss_migrator': {'frm_dismiss_migrator'}, 'FrmFormActionsController::add_form_action': {'frm_add_form_action'}, 'FrmSettingsController::page_search': {'frm_page_search'}, 'FrmStrpLiteConnectHelper::verify': {'nopriv_frm_strp_lite_verify'}, 'FrmSettingsController::load_settings_tab': {'frm_settings_tab'}, 'FrmUsageController::ajax_track_flows': {'frm_track_flows'}, 'FrmFieldsController::destroy': {'frm_delete_field'}, 'FrmAddonsController::ajax_uninstall_addon': {'frm_uninstall_addon'}, 'FrmAppController::dismiss_review': {'frm_dismiss_review'}, 'FrmInboxController::dismiss_message': {'frm_inbox_dismiss'}, 'FrmSettingsController::settings_cta_dismiss': {'frm_lite_settings_upgrade'}, 'FrmDashboardController::ajax_requests': {'dashboard_ajax_action'}, 'FrmApplicationsController::get_applications_data': {'frm_get_applications_data'}, 'FrmAddonsController::ajax_deactivate_addon': {'frm_deactivate_addon'}, 'FrmFormsController::route': {'frm_save_form'}, 'FrmFormsController::ajax_trash': {'frm_forms_trash'}, 'FrmAppController::small_screen_proceed': {'frm_small_screen_proceed'}, 'ajax_check_plugin_status': {'frm_smtp_page_check_plugin_status'}, 'FrmInstallPlugin::ajax_install_plugin': {'frm_install_plugin'}, 'FrmAppController::deauthorize': {'frm_deauthorize'}, 'FrmAddonsController::ajax_install_addon': {'frm_install_addon'}, 'FrmFormsController::get_shortcode_opts': {'frm_get_shortcode_opts'}, 'FrmStrpLiteAuth::update_intent_ajax': {'nopriv_frm_strp_amount', 'frm_strp_amount'}, 'FrmStylesController::reset_styling': {'frm_settings_reset'}, 'FrmFormsController::get_page_dropdown': {'get_page_dropdown'}, 'FrmSquareLiteAppController::handle_disconnect': {'frm_square_disconnect'}, 'FrmFormTemplatesController::ajax_add_or_remove_favorite': {'frm_add_or_remove_favorite_template'}, 'FrmAppController::ajax_install': {'frm_install'}, 'FrmSalesApi::dismiss_banner': {'frm_sale_banner_dismiss'}, 'FrmFormsController::preview': {'nopriv_frm_forms_preview', 'frm_forms_preview'}, 'FrmAddonsController::ajax_activate_addon': {'frm_activate_addon'}, 'FrmPayPalLiteConnectHelper::handle_render_seller_status': {'frm_paypal_render_seller_status'}, 'FrmFormsController::build_new_form': {'frm_install_form'}, 'FrmPayPalLiteActionsController::maybe_modify_new_action_post_data': {'frm_add_form_action'}, 'process_connect_events': {'nopriv_frm_strp_process_events', 'frm_strp_process_events'}, 'FrmEmailStylesController::ajax_preview': {'frm_email_style_preview'}, 'FrmXMLController::install_template': {'frm_install_template'}, 'FrmWelcomeTourController::ajax_mark_checklist_step_as_completed': {'frm_mark_checklist_step_as_completed'}, 'FrmPayPalLiteAppController::report_error': {'frm_paypal_report_error', 'nopriv_frm_paypal_report_error'}, 'FrmSquareLiteConnectHelper::verify': {'nopriv_frm_square_lite_verify'}, 'FrmTransLiteSubscriptionsController::cancel_subscription': {'frm_trans_cancel'}, 'FrmFieldsController::duplicate': {'frm_duplicate_field'}, 'FrmStylesController::change_styling': {'frm_change_styling'}, 'FrmXMLController::export_xml': {'frm_export_xml'}, 'FrmPayPalLiteAppController::create_order': {'frm_paypal_create_order', 'nopriv_frm_paypal_create_order'}, 'FrmPayPalLiteAppController::create_subscription': {'frm_paypal_create_subscription', 'nopriv_frm_paypal_create_subscription'}, 'FrmAppController::uninstall': {'frm_uninstall'}, 'FrmFormsController::get_email_html': {'frm_get_default_html'}, 'FrmInstallPlugin::ajax_check_plugin_activation': {'frm_check_plugin_activation'}, 'FrmEmailStylesController::ajax_send_test_email': {'frm_send_test_email'}, 'FrmFieldsController::load_field': {'frm_load_field'}, 'FrmFormsController::create_page_with_shortcode': {'frm_create_page_with_shortcode'}, 'FrmAddon::deactivate': {'frm_addon_deactivate'}, 'FrmOnboardingWizardController::ajax_consent_tracking': {'frm_onboarding_consent_tracking'}, 'FrmFormTemplatesController::ajax_create_template': {'frm_create_template'}, 'FrmStylesController::rename_style': {'frm_rename_style'}, 'FrmOnboardingWizardController::setup_usage_data': {'frm_onboarding_setup_usage_data'}, 'FrmStylesController::load_saved_css': {'frmpro_css', 'nopriv_frmpro_css'}, 'FrmPayPalLiteAppController::handle_oauth': {'frm_paypal_oauth'}, 'FrmStrpLiteLinkController::handle_return_url': {'nopriv_frmstrplinkreturn', 'frmstrplinkreturn'}, 'FrmAddon::activate': {'frm_addon_activate'}, 'FrmFormTemplatesController::ajax_get_free_templates': {'frm_get_free_templates'}, 'FrmTransLitePaymentsController::refund_payment': {'frm_trans_refund'}, 'FrmXMLController::csv': {'nopriv_frm_entries_csv', 'frm_entries_csv'}, 'FrmPayPalLiteAppController::handle_disconnect': {'frm_paypal_disconnect'}, 'FrmFormActionsController::fill_action': {'frm_form_action_fill'}, 'FrmSquareLiteAppController::handle_oauth': {'frm_square_oauth'}}
*
***/

/** Function process_events() called by wp_ajax hooks: {'frm_paypal_process_events', 'nopriv_frm_square_process_events', 'nopriv_frm_paypal_process_events', 'frm_square_process_events'} **/
/** No params detected :-/ **/
...
/** Function FrmPayPalLiteAppController::get_amount() called by wp_ajax hooks: {'frm_paypal_get_amount', 'nopriv_frm_paypal_get_amount'} **/
/** No params detected :-/ **/
...
/** Function FrmStrpLiteAuth::update_intent_ajax() called by wp_ajax hooks: {'nopriv_frm_strp_amount', 'frm_strp_amount'} **/
...
/** Function process_connect_events() called by wp_ajax hooks: {'nopriv_frm_strp_process_events', 'frm_strp_process_events'} **/
/** No params detected :-/ **/
...
/** Function FrmPayPalLiteAppController::report_error() called by wp_ajax hooks: {'frm_paypal_report_error', 'nopriv_frm_paypal_report_error'} **/
/** No params detected :-/ **/
...
/** Function FrmPayPalLiteAppController::create_order() called by wp_ajax hooks: {'frm_paypal_create_order', 'nopriv_frm_paypal_create_order'} **/
/** No params detected :-/ **/
