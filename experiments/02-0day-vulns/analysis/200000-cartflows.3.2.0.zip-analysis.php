...
*Overview: {'apply_coupon': {'wcf_woo_apply_coupon', 'nopriv_wcf_woo_apply_coupon'}, 'order_detail_form_shortcode': {'wpcf_order_detail_form_shortcode'}, 'dismiss_new_ui_notice': {'cartflows_dismiss_new_ui_notice'}, 'disable_weekly_report_email_notice': {'cartflows_disable_weekly_report_email_notice'}, 'ajax_dismiss': {'cartflows_pointer_dismiss'}, 'order_checkout_form_shortcode': {'wpcf_order_checkout_form_shortcode'}, 'ajax_should_show': {'cartflows_pointer_should_show'}, 'optin_form_shortcode': {'wpcf_optin_form_shortcode'}, 'upload_checkout_file': {'nopriv_wcf_upload_checkout_file', 'wcf_upload_checkout_file'}, 'fetch_whats_new_data': {'cartflows_fetch_whats_new_data'}, 'dismiss_script_migration_complete_notice': {'cartflows_dismiss_script_migration_complete_notice'}, 'dismiss_notice': {'astra-notice-dismiss'}, 'remove_coupon': {'wcf_woo_remove_coupon', 'nopriv_wcf_woo_remove_coupon'}, 'check_email_exists': {'nopriv_wcf_check_email_exists'}, 'ajax_get_product_meta': {'wcf_fbt_get_product_meta'}, 'ajax_accept': {'cartflows_pointer_accept'}, 'json_search_flows': {'wcf_json_search_flows'}, 'woocommerce_user_login': {'nopriv_wcf_woocommerce_login'}, 'wp_ajax_install_plugin': {'cartflows_install_plugin'}, 'ajax_save_course_template': {'cartflows_save_tutor_course_template'}, 'snooze_script_migration_notice': {'cartflows_snooze_script_migration'}, 'get_suretriggers_data': {'cartflows_get_suretriggers_data'}, 'ignore_gb_notice': {'cartflows_ignore_gutenberg_notice'}, 'ajax_add_to_cart': {'nopriv_wcf_fbt_add_to_cart', 'wcf_fbt_add_to_cart'}, 'wcf_woo_remove_cart_product': {'nopriv_wcf_woo_remove_cart_product', 'wcf_woo_remove_cart_product'}, 'send_plugin_deactivate_feedback': {'uds_plugin_deactivate_feedback'}}
*
***/
...
/** Function upload_checkout_file() called by wp_ajax hooks: {'nopriv_wcf_upload_checkout_file', 'wcf_upload_checkout_file'} **/
...
/** Function ajax_get_product_meta() called by wp_ajax hooks: {'wcf_fbt_get_product_meta'} **/
/** Parameters found in function ajax_get_product_meta(): {"post": ["product_id"]} **/
function ajax_get_product_meta() {
...
/** Function ajax_add_to_cart() called by wp_ajax hooks: {'nopriv_wcf_fbt_add_to_cart', 'wcf_fbt_add_to_cart'} **/
/** Parameters found in function ajax_add_to_cart(): {"post": ["source_id", "source_variation_id", "source_attributes", "items", "source_qty"]} **/
