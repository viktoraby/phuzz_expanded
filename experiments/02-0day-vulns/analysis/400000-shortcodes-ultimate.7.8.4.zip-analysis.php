...
*Overview: {'preview': {'su_generator_preview'}, 'settings': {'su_generator_settings'}, 'ajax_get_icons': {'su_generator_get_icons'}, 'ajax_search_posts': {'su_generator_search_posts'}, 'dismiss_notice_ajax_callback': {'fs_dismiss_notice_action_{$ajax_action_suffix}'}, 'ajax_add_preset': {'su_generator_add_preset'}, 'ajax_get_terms': {'su_generator_get_terms'}, 'ajax_search_users': {'su_generator_search_users'}, '_toggle_debug_mode': {'fs_toggle_debug_mode'}, 'ajax_get_preset': {'su_generator_get_preset'}, 'ajax_get_taxonomies': {'su_generator_get_taxonomies'}, 'ajax_remove_preset': {'su_generator_remove_preset'}}
*
***/
