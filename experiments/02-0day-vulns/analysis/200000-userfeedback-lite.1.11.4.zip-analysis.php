...
*Overview: {'userfeedback_onboarding_drop_opt_in': {'userfeedback_vue_onboarding_drip_opt_in'}, 'userfeedback_ajax_dismiss_notice': {'userfeedback_ajax_dismiss_notice'}, 'process': {'nopriv_userfeedback_connect_process'}, 'userfeedback_mark_admin_menu_tooltip_hidden': {'userfeedback_hide_admin_menu_tooltip'}, 'userfeedback_ajax_install_addon': {'userfeedback_install_addon'}, 'userfeedback_ajax_deactivate_addon': {'userfeedback_deactivate_addon'}, 'userfeedback_ajax_vue_remove_notice': {'userfeedback_ajax_vue_remove_notice'}, 'userfeedback_dismiss_settings_blurb': {'userfeedback_dismiss_settings_blurb'}, 'userfeedback_activate_plugin': {'userfeedback_activate_plugin'}, 'userfeedback_ajax_vue_remove_wp_notice': {'userfeedback_ajax_vue_remove_wp_notice'}, 'userfeedback_complete_onboarding': {'userfeedback_vue_onboarding_complete'}, 'userfeedback_get_plugins': {'userfeedback_get_plugins'}, 'userfeedback_install_plugin': {'userfeedback_install_plugin'}, 'send_test_email': {'userfeedback_send_test_summary_email'}, 'userfeedback_ajax_activate_addon': {'userfeedback_activate_addon'}, 'generate_connect_url': {'userfeedback_connect_url'}, 'userfeedback_vue_onboarding_step': {'userfeedback_vue_onboarding_step'}, 'review_dismiss': {'userfeedback_review_dismiss'}, 'userfeedback_validate_settings_blurb': {'userfeedback_validate_settings_blurb'}, 'userfeedback_ajax_get_addons': {'userfeedback_get_addons'}}
*
***/
