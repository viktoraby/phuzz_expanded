...
*Overview: {'gf_shortcode': {'uagb_gf_shortcode', 'nopriv_uagb_gf_shortcode'}, 'ajax_import_sites': {'ast-block-templates-import-sites'}, 'check_sync_status': {'ast-block-templates-check-sync-library-status'}, 'masonry_pagination': {'nopriv_uagb_get_posts', 'uagb_get_posts'}, 'confirm_svg_upload': {'uagb_svg_confirmation'}, 'render_masonry_pagination': {'nopriv_uag_load_image_gallery_masonry', 'uag_load_image_gallery_masonry'}, 'process_forms': {'nopriv_uagb_process_forms', 'uagb_process_forms'}, 'ajax_import_blocks': {'ast-block-templates-import-blocks'}, 'update_library_complete': {'ast-block-templates-update-sync-library-status'}, 'import_block': {'ast_block_templates_import_block'}, 'render_grid_pagination': {'nopriv_uag_load_image_gallery_grid_pagination', 'uag_load_image_gallery_grid_pagination'}, 'cf7_shortcode': {'uagb_cf7_shortcode', 'nopriv_uagb_cf7_shortcode'}, 'forms_recaptcha': {'uagb_forms_recaptcha'}, 'ajax_import_categories': {'ast-block-templates-import-categories'}, 'import_wpforms': {'ast_block_templates_import_wpforms'}, 'activate_plugin': {'ast_block_templates_activate_plugin'}, 'ajax_sites_requests_count': {'ast-block-templates-get-sites-request-count'}, 'dismiss_notice': {'astra-notice-dismiss'}, 'get_taxonomy': {'uagb_get_taxonomy'}, 'post_pagination': {'nopriv_uagb_post_pagination', 'uagb_post_pagination'}, 'ajax_blocks_requests_count': {'ast-block-templates-get-blocks-request-count'}, 'template_importer': {'ast_block_templates_importer'}}
*
***/
...
/** Function process_forms() called by wp_ajax hooks: {'nopriv_uagb_process_forms', 'uagb_process_forms'} **/
