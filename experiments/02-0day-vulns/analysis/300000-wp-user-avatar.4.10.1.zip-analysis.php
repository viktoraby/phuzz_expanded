...
*Overview: {'replace_order_item_modal': {'ppress_modal_replace_order_item'}, 'ajax_editprofile_func': {'pp_ajax_editprofile'}, 'ajax_check_plugin_status': {'ppress_mailoptin_page_check_plugin_status'}, 'process_checkout_login': {'nopriv_ppress_process_checkout_login'}, 'payment_methods_sortable': {'ppress_payment_methods_sortable'}, 'ppress_activate_plugin': {'ppress_activate_plugin'}, 'ProfilePressVendor\\PAnD': {'dismiss_admin_notice'}, 'get_content_condition_field': {'ppress_content_condition_field'}, 'ajax_signup_func': {'pp_ajax_signup', 'nopriv_pp_ajax_signup'}, 'get_content_condition_search': {'ppress_cr_object_search'}, 'process_checkout': {'ppress_process_checkout', 'nopriv_ppress_process_checkout'}, 'ajax_delete_avatar': {'pp_del_avatar'}, 'update_order_review': {'ppress_update_order_review', 'nopriv_ppress_update_order_review'}, 'search_customers': {'ppress_mb_search_customers'}, 'process': {'nopriv_ppress_connect_process'}, 'profile_fields_sortable_func': {'pp_profile_fields_sortable'}, 'remove_discount': {'ppress_checkout_remove_discount', 'nopriv_ppress_checkout_remove_discount'}, 'get_forms_by_builder_type': {'pp_get_forms_by_builder_type'}, 'ppress_install_plugin': {'ppress_install_plugin'}, 'create_form': {'pp_create_form'}, 'generate_url': {'ppress_connect_url'}, 'search_wp_users': {'ppress_mb_search_wp_users'}, 'search_membership_plans': {'ppress_mb_search_plans'}, 'search_plan_coupon': {'ppress_mb_order_modal_search'}, 'ajax_passwordreset_func': {'pp_ajax_passwordreset', 'nopriv_pp_ajax_passwordreset'}, 'delete_order_note': {'ppress_delete_order_note'}, 'wpua_ajax_tinymce': {'wp_user_avatar_tinymce'}, 'pp_contact_info_sortable_func': {'pp_contact_info_sortable'}, 'dismiss_admin_notice': {'dismiss_admin_notice'}, 'contextual_state_field': {'ppress_contextual_state_field', 'nopriv_ppress_contextual_state_field'}, 'apply_discount': {'nopriv_ppress_checkout_apply_discount', 'ppress_checkout_apply_discount'}, 'ajax_delete_profile_cover_image': {'pp_del_cover_image'}, 'form_type_selection': {'pp_form_type_selection'}, 'ajax_login_func': {'nopriv_pp_ajax_login', 'pp_ajax_login'}}
*
***/
...
/** Function remove_discount() called by wp_ajax hooks: {'ppress_checkout_remove_discount', 'nopriv_ppress_checkout_remove_discount'} **/
...
/** Function apply_discount() called by wp_ajax hooks: {'nopriv_ppress_checkout_apply_discount', 'ppress_checkout_apply_discount'} **/
