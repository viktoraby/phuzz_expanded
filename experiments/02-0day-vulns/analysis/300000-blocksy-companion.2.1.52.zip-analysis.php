...
*Overview: {'save_credentials': {'blocksy_ext_newsletter_subscribe_maybe_save_credentials'}, 'edit_posts': {'blocksy_get_dynamic_block_view', 'blocksy_get_tax_block_data', 'blocksy_get_posts_block_data'}, 'conditions': {'blc_retrieve_conditions_data'}, 'edit_theme_options': {'blocksy_fs_connect_again'}, 'dashboard': {'blocksy_dashboard_handle_incorrect_license'}, 'blocksy_companion_get_trending_posts': {'blocksy_get_trending_posts', 'nopriv_blocksy_get_trending_posts'}, 'implement_user_registration': {'blc_implement_user_registration', 'nopriv_blc_implement_user_registration'}, 'implement_user_login': {'nopriv_blc_implement_user_login', 'blc_implement_user_login'}, 'implement_user_lostpassword': {'blc_implement_user_lostpassword', 'nopriv_blc_implement_user_lostpassword'}, 'manage_options': {'blocksy_get_posts_block_patterns', 'blocksy_blocks_retrieve_dynamic_data_descriptor', 'blocksy_dynamic_data_block_custom_field_data', 'blocksy_customizer_copy_options', 'blocksy_get_terms_block_patterns', 'blocksy_blocks_retrieve_breadcrumbs_data_descriptor', 'blocksy_customizer_wipe_caches', 'blocksy_customizer_import'}, 'get_lists': {'blocksy_ext_newsletter_subscribe_maybe_get_lists'}, 'nonce': {'blocksy_customizer_export'}, 'get_actual_lists': {'blocksy_ext_newsletter_subscribe_get_actual_lists'}, 'newsletter_subscribe_process_ajax_subscribe': {'nopriv_blc_newsletter_subscribe_process_ajax_subscribe', 'blc_newsletter_subscribe_process_ajax_subscribe'}, 'load_cookies_consent_scripts': {'blocksy_companion_load_cookies_consent_scripts', 'nopriv_blocksy_companion_load_cookies_consent_scripts'}}
*
***/
...
/** Function edit_posts() called by wp_ajax hooks: {'blocksy_get_dynamic_block_view', 'blocksy_get_tax_block_data', 'blocksy_get_posts_block_data'} **/
/** No function found :-/ **/
...
/** Function blocksy_companion_get_trending_posts() called by wp_ajax hooks: {'blocksy_get_trending_posts', 'nopriv_blocksy_get_trending_posts'} **/
...
/** Function implement_user_login() called by wp_ajax hooks: {'nopriv_blc_implement_user_login', 'blc_implement_user_login'} **/
...
/** Function implement_user_lostpassword() called by wp_ajax hooks: {'blc_implement_user_lostpassword', 'nopriv_blc_implement_user_lostpassword'} **/
/** No params detected :-/ **/


/** Function manage_options() called by wp_ajax hooks: {'blocksy_get_posts_block_patterns', 'blocksy_blocks_retrieve_dynamic_data_descriptor', 'blocksy_dynamic_data_block_custom_field_data', 'blocksy_customizer_copy_options', 'blocksy_get_terms_block_patterns', 'blocksy_blocks_retrieve_breadcrumbs_data_descriptor', 'blocksy_customizer_wipe_caches', 'blocksy_customizer_import'} **/
/** No function found :-/ **/
...
/** Function newsletter_subscribe_process_ajax_subscribe() called by wp_ajax hooks: {'nopriv_blc_newsletter_subscribe_process_ajax_subscribe', 'blc_newsletter_subscribe_process_ajax_subscribe'} **/
