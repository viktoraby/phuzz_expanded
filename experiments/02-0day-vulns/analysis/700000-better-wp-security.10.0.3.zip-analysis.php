...
*Overview: {'ajax_new_code': {'two-factor-totp-get-code'}, 'ajax_generate_json': {'two_factor_backup_codes_generate'}, 'handle_user_setting': {'itsec-set-user-setting'}, 'handle_ajax_request': {'itsec_logs_page', 'itsec_help_page', 'itsec_debug_page'}, 'ajax_verify_code': {'two-factor-totp-verify-code'}}
*
***/
...
/** Function handle_ajax_request() called by wp_ajax hooks: {'itsec_logs_page', 'itsec_help_page', 'itsec_debug_page'} **/
/** No params detected :-/ **/
