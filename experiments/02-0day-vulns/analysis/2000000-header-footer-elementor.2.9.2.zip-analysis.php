...
*Overview: {'activate_widget': {'hfe_activate_widget'}, 'save_onboarding_analytics': {'hfe_save_onboarding_analytics'}, 'save_hfe_compatibility_option_callback': {'save_theme_compatibility_option'}, 'dismiss_notice': {'astra-notice-dismiss'}, 'hfe_flush_permalink_notice': {'hfe_flush_permalink_notice'}, 'hfe_admin_modal': {'hfe_admin_modal'}, 'hfe_get_posts_by_query': {'hfe_get_posts_by_query'}, 'update_permalink_notice_option': {'update_permalink_notice_option'}, 'bulk_activate_widgets': {'hfe_bulk_activate_widgets'}, 'update_subscription': {'hfe-update-subscription'}, 'hfe_plugin_install': {'hfe_recommended_plugin_install'}, 'hfe_activate_addon': {'hfe_recommended_plugin_activate'}, 'hfe_theme_install': {'hfe_recommended_theme_install'}, 'dismiss_upgrade_notice': {'hfe_dismiss_upgrade_notice'}, 'bulk_deactivate_widgets': {'hfe_bulk_deactivate_widgets'}, 'send_plugin_deactivate_feedback': {'uds_plugin_deactivate_feedback'}, 'bulk_deactivate_unused_widgets': {'hfe_bulk_deactivate_unused_widgets'}, 'deactivate_widget': {'hfe_deactivate_widget'}, 'save_analytics_option': {'save_analytics_option'}}
*
***/
