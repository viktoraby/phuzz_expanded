...
*Overview: {'wpsc_hide_boost_banner': {'wpsc-hide-boost-banner'}, 'wpsc_dismiss_boost_notice_ajax_handler': {'wpsc_dismiss_boost_notice'}, 'wp_ajax_install_plugin': {'wpsc_install_plugin'}, 'wpsc_ajax_activate_boost': {'wpsc_activate_boost'}, 'wpsc_ajax_get_preload_status': {'wpsc_get_preload_status'}, 'wpsc_admin_bar_delete_cache_ajax': {'ajax-delete-cache'}, 'wpsc_dismiss_indexhtml_warning': {'wpsc-index-dismiss'}, 'wpsc_dismiss_notice_on_activation': {'wpsc_activate_boost'}}
*
***/
