...
*Overview: {'add_action_post': {'wpcf7r_add_action'}, 'close_banner': {'close_ad_banner'}, 'duplicate_action': {'wpcf7r_duplicate_action'}, 'delete_action_post': {'wpcf7r_delete_action'}, 'disable_notification_ajax': {'themeisle_sdk_dismiss_black_friday_notice'}, 'dismiss_license_notice': {'themeisle_sdk_dismiss_license_notice'}, 'make_api_test': {'wpcf7r_make_api_test'}, 'ThemeisleSDK\\Modules\\Notification::regular_dismiss': {'themeisle_sdk_dismiss_notice'}, 'set_action_menu_order': {'wpcf7r_set_action_menu_order'}, 'dismiss': {'themeisle_sdk_dismiss_notice'}, 'dismiss_promotion': {'tisdk_update_option'}, 'get_action_template': {'wpcf7r_get_action_template'}}
*
***/
