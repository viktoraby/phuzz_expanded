...
*Overview: {'view_log_ajax': {'ps-view-log'}, 'export_log_ajax': {'ps-export-email-logs'}, 'update_post_smtp_pro_option_office365_callback': {'update_post_smtp_pro_option_office365'}, 'delete_lock_file': {'delete_lock_file'}, 'migrate_logs': {'ps-migrate-logs'}, 'test_mail': {'ps-mail-test'}, 'post_smtp_log_trash_all': {'post_smtp_log_trash_all'}, 'ajax_get_gmail_auth_url': {'ps_get_gmail_auth_url'}, 'dismiss_notice_ajax': {'dismiss_smtp_conflict_notice'}, 'get_logs_ajax': {'ps-get-email-logs'}, 'update_post_smtp_pro_option_callback': {'update_post_smtp_pro_option'}, 'dismiss_update_notice': {'ps-db-update-notice-dismiss'}, 'dismiss_version_notify': {'dismiss_version_notify'}, 'send_test_notification_ajax': {'postman_send_test_notification'}, 'ajax_get_office365_auth_url': {'ps_get_office365_auth_url'}, 'save_wizard': {'ps-save-wizard'}, 'discard_less_secure_notification': {'ps-discard-less-secure-notification'}, 'dismiss_notice_ajax_callback': {'fs_dismiss_notice_action_{$ajax_action_suffix}'}, 'post_user_feedback': {'post_user_feedback'}, 'dismiss_donation_notify': {'dismiss_donation_notify'}, 'post_smtp_save_widget_meta_ajax': {'post_smtp_dash_widget_lite_save_widget_meta'}, 'resend_email': {'ps-resend-email'}, '_toggle_debug_mode': {'fs_toggle_debug_mode'}, 'delete_logs_ajax': {'ps-delete-email-logs'}}
*
***/
