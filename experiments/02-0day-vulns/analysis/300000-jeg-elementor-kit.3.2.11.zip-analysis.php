...
*Overview: {'custom_term_option': {'jeg_get_custom_term_option'}, 'delete_element': {'jkit_delete_element'}, 'find_taxonomy': {'jkit_find_taxonomy'}, 'dismiss_notice_ajax_callback': {'fs_dismiss_notice_action_{$ajax_action_suffix}'}, 'find_ajax_author': {'jeg_find_author'}, 'find_ajax_custom_term': {'jeg_find_custom_term'}, 'find_ajax_post_tag': {'jeg_find_post_tag'}, 'update_element': {'jkit_update_element'}, 'get_lazy_menu': {'load_menu', 'nopriv_load_menu'}, 'cpt_option': {'jeg_get_cpt_option'}, 'close': {'jkit_notice_banner_close'}, 'find_posts': {'jkit_find_posts_object'}, 'find_ajax_category': {'jeg_find_category'}, 'find_ajax_tag': {'jeg_find_tag'}, '_toggle_debug_mode': {'fs_toggle_debug_mode'}, 'author_option': {'jeg_get_author_option'}, 'find_ajax_cpt': {'jeg_find_cpt'}, 'tag_option': {'jeg_get_tag_option'}, 'clone_element': {'jkit_clone_element'}, 'category_option': {'jeg_get_category_option'}, 'update_sequence': {'jkit_update_sequence'}, 'review': {'jkit_notice_banner_review'}, 'detail_element': {'jkit_detail_element'}, 'find_ajax_post': {'jeg_find_post'}, 'create_element': {'jkit_create_element'}, 'find_author': {'jkit_find_author'}, 'close_banner_upgrade': {'jkit_notice_banner_upgrade_close'}, 'post_option': {'jeg_get_post_option'}}
*
***/
...
/** Function get_lazy_menu() called by wp_ajax hooks: {'load_menu', 'nopriv_load_menu'} **/
