...
*Overview: {'ajax_verify_code': {'two-factor-totp-verify-code'}, 'ajax_new_code': {'two-factor-totp-get-code'}, 'handle_ajax_request': {'itsec_help_page', 'itsec_debug_page', 'itsec_logs_page'}, 'handle_user_setting': {'itsec-set-user-setting'}, 'ajax_generate_json': {'two_factor_backup_codes_generate'}}
*
***/
...
/** Function handle_ajax_request() called by wp_ajax hooks: {'itsec_help_page', 'itsec_debug_page', 'itsec_logs_page'} **/
/** No params detected :-/ **/
