...
*Overview: {'handle_dismiss': {'metform_dismiss_auto_install_notice'}, 'metform_onboard_plugins': {'mf_onboard_plugins'}, 'mf_setting_data_save': {'metform_admin_settings'}, '\\MetForm\\Utils\\Util': {'metform_admin_action'}, 'handle_feedback': {'metform_deactivation_feedback'}, 'handle_confirm': {'metform_confirm_auto_install_notice'}, 'never_show_message': {'wpmet_rating_never_show_message'}, 'ask_me_later_message': {'wpmet_rating_ask_me_later_message'}, 'metform_admin_action': {'mf_admin_action'}, 'form_id_for_emailkit': {'check_built_template'}, 'dismiss_ajax_call': {'wpmet-notices'}}
*
***/

/** Function handle_dismiss() called by wp_ajax hooks: {'metform_dismiss_auto_install_notice'} **/
/** No params detected :-/ **/
...
/** Function handle_confirm() called by wp_ajax hooks: {'metform_confirm_auto_install_notice'} **/
/** No params detected :-/ **/
