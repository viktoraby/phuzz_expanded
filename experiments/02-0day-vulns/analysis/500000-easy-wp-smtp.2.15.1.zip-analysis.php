...
*Overview: {'get_oauth_url': {'easy_wp_smtp_vue_get_oauth_url'}, 'email_domain_check_test': {'health-check-email-domain_check_test'}, 'clear_log': {'swpsmtp_clear_log'}, 'update_settings': {'easy_wp_smtp_vue_update_settings'}, 'ajax_init_connect': {'easy_wp_smtp_sendlayer_connect'}, 'wizard_steps_started': {'easy_wp_smtp_vue_wizard_steps_started'}, 'ajax_dismiss': {'easy_wp_smtp_activelayer_wc_dismiss', 'easy_wp_smtp_email_sending_errors_dismiss'}, 'process_ajax_delete_all_debug_events': {'easy_wp_smtp_delete_all_debug_events'}, 'check_mailer_configuration': {'easy_wp_smtp_vue_check_mailer_configuration'}, 'process_ajax_debug_event_preview': {'easy_wp_smtp_debug_event_preview'}, 'upgrade_plugin': {'easy_wp_smtp_vue_upgrade_plugin'}, 'ajax_check_plugin_status': {'easy_wp_smtp_page_check_{$plugin}_status'}, 'init_migrations_ajax_handler': {'nopriv_easy_wp_smtp_init_migrations'}, 'process_ajax': {'easy_wp_smtp_ajax'}, 'install_plugin': {'easy_wp_smtp_vue_install_plugin'}, 'ajax_generate_url': {'easy_wp_smtp_connect_url'}, 'ajax_disconnect': {'easy_wp_smtp_sendlayer_disconnect'}, 'get_partner_plugins_info': {'easy_wp_smtp_vue_get_partner_plugins_info'}, 'send_feedback': {'easy_wp_smtp_vue_send_feedback'}, 'get_settings': {'easy_wp_smtp_vue_get_settings'}, 'subscribe_to_newsletter': {'easy_wp_smtp_vue_subscribe_to_newsletter'}, 'process': {'nopriv_easy_wp_smtp_connect_process'}, 'feedback_notice_dismiss': {'easy_wp_smtp_feedback_notice_dismiss'}, 'remove_oauth_connection': {'easy_wp_smtp_vue_remove_oauth_connection'}, 'dismiss': {'easy_wp_smtp_notification_dismiss'}}
*
***/
