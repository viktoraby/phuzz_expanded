...
*Overview: {'YITH_WCWL_Ajax_Handler': {'load_fragments', 'nopriv_reload_wishlist_and_adding_elem', 'save_title', 'nopriv_load_fragments', 'reload_wishlist_and_adding_elem', 'nopriv_save_title', 'load_mobile', 'delete_item', 'nopriv_remove_from_wishlist', 'nopriv_delete_item', 'nopriv_add_to_wishlist', 'add_to_wishlist', 'remove_from_wishlist', 'nopriv_load_mobile'}, 'do_shortcode': {'yith_plugin_fw_gutenberg_do_shortcode'}, 'save_options': {'yith_bh_onboarding'}, 'save_toggle_element': {'yith_plugin_fw_save_toggle_element_metabox'}, 'create_log_file': {'yith_create_log_file'}, 'save_toggle_element_options': {'yith_plugin_fw_save_toggle_element'}}
*
***/

/** Function YITH_WCWL_Ajax_Handler() called by wp_ajax hooks: {'load_fragments', 'nopriv_reload_wishlist_and_adding_elem', 'save_title', 'nopriv_load_fragments', 'reload_wishlist_and_adding_elem', 'nopriv_save_title', 'load_mobile', 'delete_item', 'nopriv_remove_from_wishlist', 'nopriv_delete_item', 'nopriv_add_to_wishlist', 'add_to_wishlist', 'remove_from_wishlist', 'nopriv_load_mobile'} **/
/** No function found :-/ **/
