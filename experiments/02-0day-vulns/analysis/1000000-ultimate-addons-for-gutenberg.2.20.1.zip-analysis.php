...
*Overview: {'verify_authenticity': {'verify_zip_ai_authenticity'}, 'uagb_activate_addon': {'uagb_recommended_plugin_activate'}, 'confirm_svg_upload': {'uagb_svg_confirmation'}, 'get_taxonomy': {'uagb_get_taxonomy'}, 'uag_global_sidebar_enabled': {'uag_global_sidebar_enabled'}, 'skip_spectra_pro_onboarding': {'ast_skip_zip_ai_onboarding'}, 'uag_global_block_styles': {'uag_global_block_styles'}, 'get_fresh_credit_details': {'get_fresh_credit_details'}, 'reset_business_details': {'ast-block-templates-reset-business-details'}, 'uag_global_update_allowed_block': {'uag_global_update_allowed_block'}, 'process_forms': {'uagb_process_forms', 'nopriv_uagb_process_forms'}, 'wp_ajax_install_theme': {'uagb_recommended_theme_install'}, 'import_wpforms': {'ast_block_templates_import_wpforms'}, 'render_grid_pagination': {'uag_load_image_gallery_grid_pagination', 'nopriv_uag_load_image_gallery_grid_pagination'}, 'toggle_assistant_status_ajax': {'zip_ai_toggle_assistant_status_ajax'}, 'wp_ajax_install_plugin': {'uagb_recommended_plugin_install'}, 'track_first_pattern_imported': {'ast_block_templates_import_block'}, 'forms_recaptcha': {'uagb_forms_recaptcha'}, 'update_popup_status': {'uag_update_popup_status'}, 'dismiss_notice': {'astra-notice-dismiss'}, 'handle_migration_action_ajax': {'uag_migrate'}, 'ajax_import_blocks': {'ast-block-templates-import-blocks'}, 'track_design_library_opened': {'uagb_track_design_library_opened'}, 'sync_via_ajax': {'ast-block-templates-check-sync-library-status'}, 'ajax_import_sites': {'ast-block-templates-import-sites'}, 'masonry_pagination': {'uagb_get_posts', 'nopriv_uagb_get_posts'}, 'send_plugin_deactivate_feedback': {'uds_plugin_deactivate_feedback'}, 'get_color_palette': {'ast_block_templates_color_palette'}, 'disabler_ajax': {'zip_ai_disabler_ajax'}, 'generate_ai_content': {'ast-block-templates-regenerate'}, 'cf7_shortcode': {'nopriv_uagb_cf7_shortcode', 'uagb_cf7_shortcode'}, 'activate_plugin': {'ast_block_templates_activate_plugin'}, 'render_masonry_pagination': {'uag_load_image_gallery_masonry', 'nopriv_uag_load_image_gallery_masonry'}, 'track_first_template_imported': {'ast_block_templates_importer', 'ast_block_templates_import_template_kit'}, 'api_request': {'ast_block_templates_data_option'}, 'get_latest_credit_details': {'get_latest_credit_details'}, 'surecart_plugin_activator': {'uagb_surecart'}, 'post_pagination': {'uagb_post_pagination', 'nopriv_uagb_post_pagination'}, 'template_importer': {'ast_block_templates_kit_importer', 'ast_block_templates_importer'}, 'sureforms_plugin_activator': {'uagb_sureforms'}, 'save_user_details': {'ast-block-templates-ai-content'}, 'import_template_kit': {'ast_block_templates_import_template_kit'}, 'zipwp_insert_image': {'zipwp_images_insert_image'}, 'post_grid_pagination_ajax_callback': {'uagb_post_pagination_grid', 'nopriv_uagb_post_pagination_grid'}, 'gf_shortcode': {'uagb_gf_shortcode', 'nopriv_uagb_gf_shortcode'}, 'check_migration_status': {'check_migration_status'}, 'ajax_sites_requests_count': {'ast-block-templates-get-sites-request-count'}, 'hide_notices': {'ast_block_templates_hide_notices'}, 'import_block': {'ast_block_templates_import_block'}}
*
***/
...
/** Function render_masonry_pagination() called by wp_ajax hooks: {'uag_load_image_gallery_masonry', 'nopriv_uag_load_image_gallery_masonry'} **/
...
/** Function track_first_template_imported() called by wp_ajax hooks: {'ast_block_templates_importer', 'ast_block_templates_import_template_kit'} **/
/** No params detected :-/ **/
