...
*Overview: {'onDestroyUserSession': {'destroy-sessions'}, 'ajax_GetGitHubPluginInfo': {'SimplePluginLogger_GetGitHubPluginInfo'}, 'handle_auto_update_change': {'toggle-auto-updates'}, 'on_file_edit_ajax': {'edit-theme-plugin-file'}, 'on_admin_action_editpost_save_prev_post': {'inline-save'}}
*
***/
