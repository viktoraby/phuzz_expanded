...
*Overview: {'wpsc_hide_boost_banner': {'wpsc-hide-boost-banner'}, 'wpsc_dismiss_indexhtml_warning': {'wpsc-index-dismiss'}, 'wpsc_admin_bar_delete_cache_ajax': {'ajax-delete-cache'}, 'wpsc_ajax_activate_boost': {'wpsc_activate_boost'}, 'wp_ajax_install_plugin': {'wpsc_install_plugin'}}
*
***/
