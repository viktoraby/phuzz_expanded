...
*Overview: {'feedback_notice_dismiss': {'wp_mail_logging_feedback_notice_dismiss'}, 'ajax_check_plugin_status': {'wp_mail_logging_smtp_page_check_plugin_status'}, 'functionName': {'actionName', 'nopriv_actionName'}, 'ajax_install_wp_mail_smtp_plugin': {'wp_mail_logging_install_smtp'}, 'product_education_dismiss': {'wp_mail_logging_product_education_dismiss'}, 'ajax_dismiss_migration_notice': {'wp_mail_logging_dismiss_db_upgrade_notice'}, 'ajax_activate_wp_mail_smtp_plugin': {'wp_mail_logging_activate_smtp'}}
*
***/
...
/** Function functionName() called by wp_ajax hooks: {'actionName', 'nopriv_actionName'} **/
/** No function found :-/ **/
