...
*Overview: {'save_new_ui_option': {'wcf_ca_save_new_ui_option'}, 'fetch_whats_new': {'cart_abandonment_fetch_whats_new'}, 'update_email_toggle_button': {'activate_email_templates'}, 'update_ui_switch_option': {'wcar_switch_to_new_ui'}, 'skip_cart_tracking_by_gdpr': {'nopriv_cartflows_skip_cart_tracking_gdpr', 'cartflows_skip_cart_tracking_gdpr'}, 'cart_abandonment_activate_plugin': {'cart_abandonment_activate_plugin'}, 'delete_used_and_expired_coupons': {'wcf_ca_delete_garbage_coupons'}, 'send_preview_email': {'wcf_ca_preview_email_send'}, 'complete_onboarding': {'wcar_complete_onboarding'}, 'wp_ajax_install_plugin': {'cart_abandonment_install_plugin'}, 'send_plugin_deactivate_feedback': {'uds_plugin_deactivate_feedback'}, 'update_db_ajax': {'wcar_update_db'}, 'ajax_import_templates': {'wcf_ca_import_email_templates'}, 'disable_weekly_report_email_notice': {'wcar_disable_weekly_report_email_notice'}, 'ajax_export_templates': {'wcf_ca_export_email_templates'}, 'dismiss_notice': {'astra-notice-dismiss'}, 'save_cart_abandonment_data': {'nopriv_cartflows_save_cart_abandonment_data', 'cartflows_save_cart_abandonment_data'}}
*
***/
...
/** Function skip_cart_tracking_by_gdpr() called by wp_ajax hooks: {'nopriv_cartflows_skip_cart_tracking_gdpr', 'cartflows_skip_cart_tracking_gdpr'} **/
/** No params detected :-/ **/
