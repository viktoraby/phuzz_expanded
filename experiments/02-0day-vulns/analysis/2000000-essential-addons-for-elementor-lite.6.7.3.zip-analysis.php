...
*Overview: {'ajax_auto_active_even_not_installed': {'wpdeveloper_auto_active_even_not_installed'}, 'clear_cache_files': {'eael_clear_cache_files_with_ajax'}, 'ajax_dismiss_banner': {'eael_thinkrank_dismiss'}, 'get_compare_table': {'eael_product_grid', 'nopriv_eael_product_grid'}, 'eael_woo_pagination_ajax': {'nopriv_woo_product_pagination', 'woo_product_pagination'}, 'ajax_load_more': {'load_more', 'nopriv_load_more'}, 'ajax_skip': {'eael_thinkrank_skip'}, 'ajax_upgrade_plugin': {'wpdeveloper_upgrade_plugin'}, 'ajax_never_show': {'eael_thinkrank_never_show'}, 'eael_ajax_add_to_cart': {'nopriv_eael_ajax_add_to_cart', 'eael_ajax_add_to_cart'}, 'facebook_feed_render_items': {'facebook_feed_load_more', 'nopriv_facebook_feed_load_more'}, 'save_eael_elements_data': {'save_eael_elements_data'}, 'save_settings': {'eael_save_settings_with_ajax'}, 'ajax_snooze_banner': {'eael_thinkrank_snooze'}, 'ajax_deactivate_plugin': {'wpdeveloper_deactivate_plugin'}, 'woo_checkout_update_order_review': {'nopriv_woo_checkout_update_order_review', 'woo_checkout_update_order_review'}, 'ajax_install_plugin': {'wpdeveloper_install_plugin'}, 'eael_product_quickview_popup': {'eael_product_quickview_popup', 'nopriv_eael_product_quickview_popup'}, 'eael_checkout_cart_qty_update': {'nopriv_eael_checkout_cart_qty_update', 'eael_checkout_cart_qty_update'}, 'eael_product_add_to_cart': {'nopriv_eael_product_add_to_cart', 'eael_product_add_to_cart'}, 'eael_admin_promotion': {'eael_admin_promotion'}, 'eael_get_token': {'eael_get_token', 'nopriv_eael_get_token'}, 'eael_ajax_send_otp': {'eael_lr_send_otp', 'nopriv_eael_lr_send_otp'}, 'ajax_activate_plugin': {'wpdeveloper_activate_plugin'}, 'eael_woo_pagination_product_ajax': {'woo_product_pagination_product', 'nopriv_woo_product_pagination_product'}, 'enable_wpins_process': {'enable_wpins_process'}, 'eael_clear_widget_cache_data': {'eael_clear_widget_cache_data'}, 'ajax_eael_product_gallery': {'nopriv_eael_product_gallery', 'eael_product_gallery'}, 'select2_ajax_get_posts_value_titles': {'eael_select2_get_title'}, 'eael_ajax_verify_otp': {'nopriv_eael_lr_verify_otp', 'eael_lr_verify_otp'}, 'templately_promo_status': {'templately_promo_status'}, 'select2_ajax_posts_filter_autocomplete': {'eael_select2_search_post'}, 'save_setup_wizard_data': {'save_setup_wizard_data'}}
*
***/
...
/** Function get_compare_table() called by wp_ajax hooks: {'eael_product_grid', 'nopriv_eael_product_grid'} **/
...
/** Function woo_checkout_update_order_review() called by wp_ajax hooks: {'nopriv_woo_checkout_update_order_review', 'woo_checkout_update_order_review'} **/
...
/** Function eael_checkout_cart_qty_update() called by wp_ajax hooks: {'nopriv_eael_checkout_cart_qty_update', 'eael_checkout_cart_qty_update'} **/
...
/** Function eael_ajax_send_otp() called by wp_ajax hooks: {'eael_lr_send_otp', 'nopriv_eael_lr_send_otp'} **/
...
/** Function eael_woo_pagination_product_ajax() called by wp_ajax hooks: {'woo_product_pagination_product', 'nopriv_woo_product_pagination_product'} **/
...
/** Function ajax_eael_product_gallery() called by wp_ajax hooks: {'nopriv_eael_product_gallery', 'eael_product_gallery'} **/
...
/** Function eael_ajax_verify_otp() called by wp_ajax hooks: {'nopriv_eael_lr_verify_otp', 'eael_lr_verify_otp'} **/
