...
*Overview: {'get_posts_list': {'premium_update_filter'}, 'pa_delete_cart_items': {'nopriv_pa_delete_cart_items', 'pa_delete_cart_items'}, 'pa_apply_coupon': {'nopriv_pa_apply_coupon', 'pa_apply_coupon'}, 'get_shape_divider_svg': {'get_shape_divider_svg'}, 'pa_save_additional_settings': {'pa_save_additional_settings'}, 'pa_disable_oauth_connect': {'pa_disable_oauth_connect'}, 'cross_cp_fetch_content_data': {'premium_cross_cp_import'}, 'insert_inner_template': {'premium_inner_template'}, 'pa_get_editor_template': {'pa_get_editor_template'}, 'insert_cf_form': {'insert_cf_form'}, 'get_pinterest_boards': {'get_pinterest_boards'}, 'pa_save_elements_settings': {'pa_save_elements_settings'}, 'get_related_tax': {'premium_update_tax'}, 'dismiss_admin_notice': {'pa_dismiss_admin_notice'}, 'pa_save_ai_abilities': {'pa_save_ai_abilities'}, 'pa_update_mc_qty': {'nopriv_pa_update_mc_qty', 'pa_update_mc_qty'}, 'get_template_content': {'get_elementor_template_content', 'nopriv_get_elementor_template_content'}, 'handle_live_editor': {'handle_live_editor'}, 'pa_clear_cached_assets': {'pa_clear_cached_assets'}, 'send': {'pa_handle_feedback_action', 'pa_send_element_feedback'}, 'pa_check_unused_widgets': {'pa_check_unused_widgets'}, 'pa_enable_oauth_connect': {'pa_enable_oauth_connect'}, 'get_templates': {'premium_get_templates'}, 'get_search_results': {'premium_get_search_results', 'nopriv_premium_get_search_results'}, 'update_template_title': {'update_template_title'}, 'get_pa_element_data': {'get_pa_element_data'}, 'handle_pa_woo_cta_actions': {'handle_pa_woo_cta_actions', 'nopriv_handle_pa_woo_cta_actions'}, 'get_woo_product_quick_view': {'nopriv_get_woo_product_qv', 'get_woo_product_qv'}, 'get_pinterest_token': {'get_pinterest_token'}, 'get_woo_products': {'nopriv_get_woo_products', 'get_woo_products'}, 'check_temp_validity': {'check_temp_validity'}, 'pa_hide_unused_widgets_dialog': {'pa_hide_unused_widgets_dialog'}, 'pa_save_menu_item_settings': {'pa_save_menu_item_settings'}, 'add_product_to_cart': {'premium_woo_add_cart_product', 'nopriv_premium_woo_add_cart_product'}, 'subscribe_newsletter': {'subscribe_newsletter'}, 'pa_save_mega_item_content': {'pa_save_mega_item_content'}, 'reset_admin_notice': {'pa_reset_admin_notice'}, 'pa_delete_cart_item': {'nopriv_pa_delete_cart_item', 'pa_delete_cart_item'}, 'pa_disable_elementor_mc_template': {'pa_disable_elementor_mc_template'}, 'pa_get_menu_item_settings': {'pa_get_menu_item_settings'}, 'clear_site_cursor_settings': {'pa_clear_site_cursor_settings'}, 'get_tiktok_token': {'get_tiktok_token'}, 'pa_save_global_btn': {'pa_save_global_btn'}, 'pa_get_unused_widgets': {'pa_get_unused_widgets'}, 'get_acf_options': {'pa_acf_options'}, 'pa_remove_coupon': {'nopriv_pa_remove_coupon', 'pa_remove_coupon'}, 'get_posts_query': {'nopriv_pa_get_posts', 'pa_get_posts'}}
*
***/
...
/** Function pa_update_mc_qty() called by wp_ajax hooks: {'nopriv_pa_update_mc_qty', 'pa_update_mc_qty'} **/
...
/** Function get_woo_product_quick_view() called by wp_ajax hooks: {'nopriv_get_woo_product_qv', 'get_woo_product_qv'} **/
...
/** Function pa_get_unused_widgets() called by wp_ajax hooks: {'pa_get_unused_widgets'} **/
/** No params detected :-/ **/
...
/** Function pa_remove_coupon() called by wp_ajax hooks: {'nopriv_pa_remove_coupon', 'pa_remove_coupon'} **/
