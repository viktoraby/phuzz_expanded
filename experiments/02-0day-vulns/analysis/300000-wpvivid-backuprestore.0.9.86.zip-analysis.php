...
*Overview: {'download_backup_mainwp': {'wpvivid_download_backup_mainwp'}, 'generate_url': {'wpvivid_generate_url'}, 'check_import_file': {'wpvivid_check_import_file'}, 'wpvivid_scan_import_folder': {'wpvivid_scan_import_folder'}, 'get_log_list_page': {'wpvividstg_get_log_list_page'}, 'check_filesystem_permissions': {'wpvividstg_check_filesystem_permissions_free'}, 'download_log': {'wpvividstg_download_log'}, 'get_import_progress': {'wpvivid_get_import_progress'}, 'import_setting': {'wpvivid_import_setting'}, 'get_custom_exclude_path': {'wpvividstg_get_custom_exclude_path_free'}, 'get_backup_list': {'wpvivid_get_backup_list'}, 'delete_selected_image': {'wpvivid_delete_selected_image'}, 'get_list_page': {'wpvivid_get_post_list_page'}, 'get_custom_database_tables_info': {'wpvividstg_get_custom_database_tables_info_free'}, 'update_setting': {'wpvivid_update_setting'}, 'delete_site': {'wpvividstg_delete_site_free'}, 'check_staging_dir': {'wpvividstg_check_staging_dir_free'}, 'save_setting': {'wpvividstg_save_setting'}, 'delete_post_type': {'wpvivid_delete_post_type'}, 'delete_ready_task': {'wpvivid_delete_ready_task'}, 'restore_selected_image': {'wpvivid_restore_selected_image'}, 'delete_export_list': {'wpvivid_delete_export_list'}, 'view_backup_log': {'wpvivid_view_backup_log'}, 'download_backup': {'wpvivid_download_backup'}, 'get_restore_file_is_migrate': {'wpvivid_get_restore_file_is_migrate'}, 'check_remote_alias_exist': {'wpvivid_check_remote_alias_exist'}, 'test_additional_database_connect': {'wpvividstg_test_additional_database_connect_free'}, 'upload_files': {'wpvivid_upload_files'}, 'delete_transfer_key': {'wpvivid_delete_transfer_key'}, 'get_restore_progress': {'nopriv_wpvivid_get_restore_progress_2', 'wpvivid_get_restore_progress', 'nopriv_wpvivid_get_restore_progress', 'wpvivid_get_restore_progress_2'}, 'cancel_upload_backup_free': {'wpvivid_cancel_upload_backup_free'}, 'prepare_restore': {'wpvivid_prepare_restore'}, 'upload_files_finish': {'wpvivid_upload_files_finish'}, 'download_restore_file': {'wpvivid_download_restore'}, 'delete_snapshot': {'wpvivid_delete_snapshot'}, 'prepare_backup': {'wpvivid_prepare_backup'}, 'backup_now_2': {'wpvivid_backup_now_2'}, 'set_security_lock': {'wpvivid_set_security_lock'}, 'restore_snapshot': {'wpvivid_restore_snapshot'}, 'upload_import_file_complete': {'wpvivid_upload_import_file_complete'}, 'clean_local_storage': {'wpvivid_clean_local_storage'}, 'get_iso_list': {'wpvivid_get_iso_list'}, 'get_general_setting': {'wpvivid_get_general_setting'}, 'hide_wp_cron_notice': {'wpvivid_hide_wp_cron_notice'}, 'cancel_staging': {'wpvividstg_cancel_staging_free'}, 'start_staging': {'wpvividstg_start_staging_free', 'nopriv_wpvividstg_start_staging_free'}, 'get_staging_progress': {'wpvividstg_get_staging_progress_free', 'nopriv_wpvividstg_get_staging_progress_free'}, 'delete_cancel_staging_site': {'wpvividstg_delete_cancel_staging_site_free'}, 'export_post_step3': {'wpvivid_export_post_step3'}, 'get_custom_include_path': {'wpvividstg_get_custom_include_path_free'}, 'init_download_page': {'wpvivid_init_download_page'}, 'clean_out_of_date_backup': {'wpvivid_clean_out_of_date_backup'}, 'resume_create_snapshot': {'wpvivid_resume_create_snapshot'}, 'delete_all_image': {'wpvivid_delete_all_image', 'wpvivid_start_delete_all_image'}, 'shutdown_backup': {'wpvivid_shutdown_backup'}, 'isolate_selected_image': {'wpvivid_isolate_selected_image'}, 'list_tasks': {'wpvivid_list_tasks_2', 'wpvivid_list_upload_tasks', 'wpvivid_list_tasks', 'wpvivid_export_list_tasks'}, 'isolate_all_image': {'wpvivid_isolate_all_image'}, 'get_exclude_files_list': {'wpvivid_get_exclude_files_list'}, 'restore_all_image': {'wpvivid_start_restore_all_image', 'wpvivid_restore_all_image'}, 'start_scan_uploads_files_task': {'wpvivid_start_scan_uploads_files_task'}, 'get_schedule': {'wpvivid_get_schedule'}, 'get_default_remote_storage': {'wpvivid_get_default_remote_storage'}, 'get_restore_snapshot_status': {'wpvivid_get_restore_snapshot_status'}, 'test_connect_site': {'wpvivid_test_connect_site'}, 'delete_backup': {'wpvivid_delete_backup'}, 'rescan_local_folder_set_backup': {'wpvivid_rescan_local_folder'}, 'view_log_ex': {'wpvividstg_view_log_ex'}, 'get_snapshot_progress': {'wpvivid_get_snapshot_progress'}, 'init_restore_page': {'wpvivid_init_restore_page'}, 'get_export_list': {'wpvivid_get_export_list'}, 'wpvivid_download_export_backup': {'wpvivid_download_export_backup'}, 'export_setting': {'wpvivid_export_setting'}, 'get_download_progress': {'wpvivid_get_download_progress'}, 'set_restart_staging_id': {'wpvividstg_set_restart_staging_id_free'}, 'add_exclude_files': {'wpvivid_uc_add_exclude_files'}, 'start_isolate_all_image': {'wpvivid_start_isolate_all_image'}, 'restore_failed': {'nopriv_wpvivid_restore_failed_2', 'wpvivid_restore_failed_2'}, 'export_now': {'wpvivid_export_now'}, 'add_remote': {'wpvivid_add_remote'}, 'finish_restore': {'wpvivid_finish_restore_2', 'nopriv_wpvivid_finish_restore_2'}, 'set_default_remote_storage': {'wpvivid_set_default_remote_storage'}, 'junk_files_info': {'wpvivid_junk_files_info'}, 'delete_backup_array': {'wpvivid_delete_backup_array'}, 'delete_upload_incomplete_backup': {'wpvivid_delete_upload_incomplete_backup_free'}, 'get_custom_files_size': {'wpvividstg_get_custom_files_size_free'}, 'edit_remote': {'wpvivid_edit_remote'}, 'test_send_mail': {'wpvivid_test_send_mail'}, 'view_backup_task_log': {'wpvivid_view_backup_task_log'}, 'upload_import_files': {'wpvivid_upload_import_files'}, 'migrate_now': {'wpvivid_migrate_now_2', 'wpvivid_migrate_now'}, 'prepare_download_backup': {'wpvivid_prepare_download_backup'}, 'get_out_of_date_info': {'wpvivid_get_out_of_date_info'}, 'get_backup_count': {'wpvivid_get_backup_count'}, 'get_log_list': {'wpvivid_get_log_list'}, 'prepare_export_post': {'wpvivid_prepare_export_post'}, 'get_download_page_ex': {'wpvivid_get_download_page_ex'}, 'backup_cancel': {'wpvivid_backup_cancel'}, 'get_post_type_list': {'wpvivid_get_post_type_list'}, 'init_restore_task': {'wpvivid_init_restore_task_2'}, 'prepare_backup_2': {'wpvivid_prepare_backup_2'}, 'amazons3_notice': {'wpvivid_amazons3_notice'}, 'scan_uploads_files_from_post': {'wpvivid_scan_uploads_files_from_post'}, 'delete_ready_task_2': {'wpvivid_delete_ready_task_2'}, 'delete_remote': {'wpvivid_delete_remote'}, 'get_list': {'wpvivid_get_post_list'}, 'get_custom_themes_plugins_info_ex': {'wpvividstg_get_custom_themes_plugins_info_free'}, 'get_ini_memory_limit': {'wpvivid_get_ini_memory_limit'}, 'need_review': {'wpvivid_need_review'}, 'get_result_list': {'wpvivid_get_result_list'}, 'get_setting': {'wpvivid_get_setting'}, 'delete_task': {'wpvivid_delete_task_2', 'wpvivid_delete_task'}, 'task_monitor_ex': {'wpvivid_task_monitor'}, 'list_remote': {'wpvivid_list_remote'}, 'start_import': {'wpvivid_start_import'}, 'export_post_step2': {'wpvivid_export_post_step2'}, 'set_setting': {'wpvivid_set_snapshot_setting'}, 'test_remote_connection': {'wpvivid_test_remote_connection'}, 'set_general_setting': {'wpvivid_set_general_setting'}, 'wpvivid_send_debug_info': {'wpvivid_send_debug_info'}, 'get_custom_database_size': {'wpvividstg_get_custom_database_size_free'}, 'set_schedule': {'wpvivid_set_schedule'}, 'get_dir': {'wpvivid_get_dir'}, 'delete_exclude_files': {'wpvivid_delete_exclude_files'}, 'start_unused_files_task': {'wpvivid_start_unused_files_task'}, 'delete_last_restore_data': {'wpvivid_delete_last_restore_data'}, 'unused_files_task': {'wpvivid_unused_files_task'}, 'get_file_id': {'wpvivid_get_file_id'}, 'retrieve_remote': {'wpvivid_retrieve_remote'}, 'send_backup_to_site': {'wpvivid_send_backup_to_site', 'wpvivid_send_backup_to_site_2'}, 'clean_import_folder': {'wpvivid_clean_import_folder'}, 'do_restore': {'wpvivid_do_restore_2', 'nopriv_wpvivid_do_restore_2'}, 'create_snapshot': {'wpvivid_create_snapshot'}, 'update_staging_exclude_extension': {'wpvividstg_update_staging_exclude_extension_free'}, 'backup_now': {'wpvivid_backup_now'}, 'upload_files_finish_free': {'wpvivid_upload_files_finish_free'}, 'export_download_backup': {'wpvivid_export_download_backup'}, 'read_last_backup_log': {'wpvivid_read_last_backup_log'}, 'calc_import_folder_size': {'wpvivid_calc_import_folder_size'}, 'download_restore_progress': {'wpvivid_get_download_restore_progress'}, 'restore': {'wpvivid_restore', 'nopriv_wpvivid_restore'}, 'create_debug_package': {'wpvivid_create_debug_package'}, 'get_import_list_page': {'wpvivid_get_import_list_page'}, 'get_last_backup': {'wpvivid_get_last_backup'}, 'view_log': {'wpvivid_view_log'}, 'finish_add_remote': {'wpvivid_google_drive_add_remote', 'wpvivid_one_drive_add_remote', 'wpvivid_dropbox_add_remote'}, 'is_backup_file_free': {'wpvivid_is_backup_file_free'}, 'hide_mainwp_tab_page': {'wpvivid_hide_mainwp_tab_page'}}
*
***/
...
/** Function get_restore_progress() called by wp_ajax hooks: {'nopriv_wpvivid_get_restore_progress_2', 'wpvivid_get_restore_progress', 'nopriv_wpvivid_get_restore_progress', 'wpvivid_get_restore_progress_2'} **/
...
/** Function list_tasks() called by wp_ajax hooks: {'wpvivid_list_tasks_2', 'wpvivid_list_upload_tasks', 'wpvivid_list_tasks', 'wpvivid_export_list_tasks'} **/
/** No params detected :-/ **/
