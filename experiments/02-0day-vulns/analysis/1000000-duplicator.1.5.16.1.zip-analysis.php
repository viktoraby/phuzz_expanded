...
*Overview: {'duplicator_active_package_info': {'duplicator_active_package_info'}, 'dismissAjax': {'dup_notice_dismiss'}, 'duplicator_package_scan': {'duplicator_package_scan'}, 'duplicator_duparchive_package_build': {'duplicator_duparchive_package_build'}, 'duplicator_package_delete': {'duplicator_package_delete'}, 'duplicator_download_installer': {'duplicator_download_installer'}, 'set_admin_notice_viewed': {'duplicator_set_admin_notice_viewed'}, 'ajax_reset_all': {'duplicator_reset_all_settings'}, 'runScanValidator': {'DUP_CTRL_Tools_runScanValidator'}, 'getTraceLog': {'DUP_CTRL_Tools_getTraceLog'}, 'dismissNoticeBar': {'duplicator_notice_bar_dismiss'}, 'addQuickFilters': {'DUP_CTRL_Package_addQuickFilters'}, 'getActivePackageStatus': {'DUP_CTRL_Package_getActivePackageStatus'}, 'duplicator_package_build': {'duplicator_package_build'}, 'duplicator_submit_uninstall_reason_action': {'duplicator_submit_uninstall_reason_action'}, 'admin_notice_to_dismiss': {'duplicator_admin_notice_to_dismiss'}, 'SaveViewState': {'DUP_CTRL_UI_SaveViewState'}}
*
***/
