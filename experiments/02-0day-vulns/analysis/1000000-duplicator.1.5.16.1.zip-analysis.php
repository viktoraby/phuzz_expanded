...
*Overview: {'duplicator_download_installer': {'duplicator_download_installer'}, 'runScanValidator': {'DUP_CTRL_Tools_runScanValidator'}, 'duplicator_package_build': {'duplicator_package_build'}, 'dismissNoticeBar': {'duplicator_notice_bar_dismiss'}, 'getActivePackageStatus': {'DUP_CTRL_Package_getActivePackageStatus'}, 'duplicator_package_scan': {'duplicator_package_scan'}, 'SaveViewState': {'DUP_CTRL_UI_SaveViewState'}, 'duplicator_package_delete': {'duplicator_package_delete'}, 'dismissAjax': {'dup_notice_dismiss'}, 'ajax_reset_all': {'duplicator_reset_all_settings'}, 'set_admin_notice_viewed': {'duplicator_set_admin_notice_viewed'}, 'duplicator_submit_uninstall_reason_action': {'duplicator_submit_uninstall_reason_action'}, 'getTraceLog': {'DUP_CTRL_Tools_getTraceLog'}, 'duplicator_active_package_info': {'duplicator_active_package_info'}, 'admin_notice_to_dismiss': {'duplicator_admin_notice_to_dismiss'}, 'duplicator_duparchive_package_build': {'duplicator_duparchive_package_build'}, 'addQuickFilters': {'DUP_CTRL_Package_addQuickFilters'}}
*
***/
