...
*Overview: {'bulk_get_stats_callback': {'imagify_bulk_get_stats'}, 'missing_nextgen_callback': {'imagify_missing_nextgen_generation'}, 'bulk_info_seen_callback': {'imagify_bulk_info_seen'}, 'get_folder_type_data_callback': {'imagify_get_folder_type_data'}, 'core_handler': {'imagifybeat'}, 'admin_post_dismiss_notice': {'imagify_dismiss_notice'}, 'bulk_optimize_callback': {'imagify_bulk_optimize'}, 'prevent_auto_optimization_when_recovering_from_upload_failure': {'media-create-image-subsizes'}}
*
***/
