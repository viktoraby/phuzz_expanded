...
*Overview: {'post_smtp_log_trash_all': {'post_smtp_log_trash_all'}, 'delete_lock_file': {'delete_lock_file'}, 'dismiss_donation_notify': {'dismiss_donation_notify'}, 'Freemius': {'fs_toggle_debug_mode'}, 'dismiss_notice_ajax_callback': {'fs_dismiss_notice_action_{$ajax_action_suffix}'}, 'post_user_feedback': {'post_user_feedback'}, 'discard_less_secure_notification': {'ps-discard-less-secure-notification'}, 'dismiss_version_notify': {'dismiss_version_notify'}}
*
***/
