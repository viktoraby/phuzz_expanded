...
*Overview: {'seedprod_lite_v2_get_saved_templates': {'seedprod_lite_v2_get_saved_templates'}, 'seedprod_lite_v2_toggle_template_status': {'seedprod_lite_v2_toggle_template_status'}, 'seedprod_lite_archive_selected_lpages': {'seedprod_lite_archive_selected_lpages'}, 'seedprod_lite_v2_install_addon_setup': {'seedprod_lite_v2_install_addon_setup'}, 'seedprod_lite_get_mypaykit_code': {'seedprod_lite_get_mypaykit_code'}, 'seedprod_lite_v2_get_templates': {'seedprod_lite_v2_get_templates'}, 'seedprod_lite_subscribers_datatable': {'seedprod_lite_subscribers_datatable'}, 'seedprod_lite_v2_get_total_theme_pages': {'seedprod_lite_v2_get_total_theme_pages'}, 'seedprod_lite_template_subscribe': {'seedprod_lite_template_subscribe'}, 'seedprod_lite_get_plugins_list': {'seedprod_lite_get_plugins_list'}, 'seedprod_lite_plugin_nonce': {'seedprod_lite_plugin_nonce'}, 'seedprod_lite_duplicate_lpage': {'seedprod_lite_duplicate_lpage'}, 'seedprod_lite_get_edd_downloads': {'seedprod_lite_get_edd_downloads'}, 'seedprod_lite_v2_create_template': {'seedprod_lite_v2_create_template'}, 'seedprod_lite_slug_exists': {'seedprod_lite_slug_exists'}, 'seedprod_lite_v2_create_default_pages': {'seedprod_lite_v2_create_default_pages'}, 'seedprod_lite_v2_export_landing_pages': {'seedprod_lite_v2_export_landing_pages'}, 'seedprod_lite_v2_restore_lpage': {'seedprod_lite_v2_restore_lpage'}, 'seedprod_lite_v2_duplicate_template': {'seedprod_lite_v2_duplicate_template'}, 'seedprod_lite_get_wpforms': {'seedprod_lite_get_wpforms'}, 'seedprod_lite_v2_bulk_action_templates': {'seedprod_lite_v2_bulk_action_templates'}, 'seedprod_lite_v2_check_wizard_availability': {'seedprod_lite_v2_check_wizard_availability'}, 'seedprod_lite_v2_get_template_conditions': {'seedprod_lite_v2_get_template_conditions'}, 'seedprod_lite_v2_toggle_favorite_template': {'seedprod_lite_v2_toggle_favorite_template'}, 'seedprod_lite_get_rafflepress_code': {'seedprod_lite_get_rafflepress_code'}, 'seedprod_lite_v2_install_plugin': {'seedprod_lite_v2_install_plugin'}, 'seedprod_lite_v2_review_dismiss': {'seedprod_v2_review_dismiss'}, 'seedprod_lite_v2_trash_lpage': {'seedprod_lite_v2_trash_lpage'}, 'seedprod_lite_get_woocommerce_product_taxonomy': {'seedprod_lite_get_woocommerce_product_taxonomy'}, 'seedprod_lite_get_utc_offset': {'seedprod_lite_get_utc_offset'}, 'seedprod_lite_install_addon': {'seedprod_lite_install_addon'}, 'seedprod_lite_get_namespaced_custom_css': {'seedprod_lite_get_namespaced_custom_css'}, 'seedprod_lite_lpage_datatable': {'seedprod_lite_lpage_datatable'}, 'seedprod_lite_v2_check_existing_theme': {'seedprod_lite_v2_check_existing_theme'}, 'handle_license_activation': {'seedprod_lite_v2_save_api_key'}, 'seedprod_lite_v2_export_theme_files': {'seedprod_lite_v2_export_theme_files'}, 'seedprod_lite_v2_get_favorite_templates': {'seedprod_lite_v2_get_favorite_templates'}, 'seedprod_lite_v2_delete_subscribers': {'seedprod_lite_v2_delete_subscribers'}, 'seedprod_lite_v2_delete_lpage': {'seedprod_lite_v2_delete_lpage'}, 'seedprod_lite_v2_save_template_conditions': {'seedprod_lite_v2_save_template_conditions'}, 'seedprod_lite_v2_create_page_from_template': {'seedprod_lite_v2_create_page_from_template'}, 'seedprod_lite_get_woocommerce_product_attributes': {'seedprod_lite_get_woocommerce_product_attributes'}, 'seedprod_lite_activate_addon': {'seedprod_lite_activate_addon'}, 'seedprod_lite_v2_subscribe_free_templates': {'seedprod_lite_v2_subscribe_free_templates'}, 'seedprod_lite_v2_get_redirect_url': {'seedprod_lite_v2_get_redirect_url'}, 'seedprod_lite_delete_archived_lpages': {'seedprod_lite_delete_archived_lpages'}, 'seedprod_lite_get_envira_galleries': {'seedprod_lite_get_envira_galleries'}, 'seedprod_lite_get_post_custom_keys_array': {'seedprod_lite_get_post_custom_keys_array'}, 'seedprod_lite_update_subscriber_count': {'seedprod_lite_update_subscriber_count'}, 'seedprod_lite_v2_save_settings': {'seedprod_lite_v2_save_settings'}, 'seedprod_lite_get_stockimages': {'seedprod_lite_get_stockimages'}, 'seedprod_lite_dismiss_upsell': {'seedprod_lite_dismiss_upsell'}, 'seedprod_lite_v2_dismiss_setup_wizard': {'seedprod_lite_v2_dismiss_setup_wizard'}, 'seedprod_lite_get_lpage_list': {'seedprod_lite_get_lpage_list'}, 'seedprod_lite_v2_get_subscribers_datatable': {'seedprod_lite_v2_get_subscribers_datatable'}, 'seedprod_lite_v2_delete_theme_pages': {'seedprod_lite_v2_delete_theme_pages'}, 'seedprod_lite_save_template': {'seedprod_lite_save_template'}, 'seedprod_lite_get_revisisons': {'seedprod_lite_get_revisions'}, 'seedprod_lite_v2_complete_setup_wizard': {'seedprod_lite_v2_complete_setup_wizard'}, 'seedprod_lite_v2_export_subscribers': {'seedprod_lite_v2_export_subscribers'}, 'seedprod_lite_v2_trash_template': {'seedprod_lite_v2_trash_template'}, 'seedprod_lite_v2_delete_template': {'seedprod_lite_v2_delete_template'}, 'seedprod_lite_v2_import_theme_files': {'seedprod_lite_v2_import_theme_files'}, 'seedprod_lite_upgrade_license': {'seedprod_lite_upgrade_license'}, 'seedprod_lite_get_mypaykit': {'seedprod_lite_get_mypaykit'}, 'seedprod_lite_v2_update_theme_enabled': {'seedprod_lite_v2_update_theme_enabled'}, 'seedprod_lite_v2_save_app_settings': {'seedprod_lite_v2_save_app_settings'}, 'seedprod_lite_v2_get_theme_kits': {'seedprod_lite_v2_get_theme_kits'}, 'seedprod_lite_save_lpage': {'seedprod_lite_save_lpage'}, 'seedprod_lite_get_widget_wpresults': {'seedprod_lite_get_widget_wpresults'}, 'dismiss': {'seedprod_lite_notification_dismiss'}, 'seedprod_lite_save_app_settings': {'seedprod_lite_save_app_settings'}, 'seedprod_lite_v2_import_landing_pages': {'seedprod_lite_v2_import_landing_pages'}, 'seedprod_lite_dismiss_settings_lite_cta': {'seedprod_lite_dismiss_settings_lite_cta'}, 'seedprod_lite_v2_import_theme_by_url': {'seedprod_lite_v2_import_theme_by_url'}, 'seedprod_lite_v2_deactivate_api_key': {'seedprod_lite_v2_deactivate_api_key'}, 'seedprod_upgrade_license': {'seedprod_upgrade_license'}, 'seedprod_lite_v2_remove_post': {'seedprod_lite_v2_remove_post'}, 'seedprod_lite_save_settings': {'seedprod_lite_save_settings'}, 'seedprod_lite_get_widget_wpforms': {'seedprod_lite_get_widget_wpforms'}, 'seedprod_lite_get_rafflepress': {'seedprod_lite_get_rafflepress'}, 'seedprod_lite_v2_activate_plugin': {'seedprod_lite_v2_activate_plugin'}, 'seedprod_lite_v2_bulk_action_lpages': {'seedprod_lite_v2_bulk_action_lpages'}, 'seedprod_lite_get_edd_download_taxonomy': {'seedprod_lite_get_edd_download_taxonomy'}, 'seedprod_lite_save_api_key': {'seedprod_lite_save_api_key'}, 'seedprod_lite_v2_deactivate_plugin': {'seedprod_lite_v2_deactivate_plugin'}, 'seedprod_lite_import_cross_site_paste': {'seedprod_lite_import_cross_site_paste'}, 'seedprod_lite_v2_toggle_favorite_theme': {'seedprod_lite_v2_toggle_favorite_theme'}, 'seedprod_lite_v2_restore_template': {'seedprod_lite_v2_restore_template'}, 'seedprod_lite_get_woocommerce_products': {'seedprod_lite_get_woocommerce_products'}, 'seedprod_lite_unarchive_selected_lpages': {'seedprod_lite_unarchive_selected_lpages'}, 'seedprod_lite_v2_duplicate_lpage': {'seedprod_lite_v2_duplicate_lpage'}, 'seedprod_lite_run_one_click_upgrade': {'nopriv_seedprod_lite_run_one_click_upgrade'}, 'seedprod_lite_deactivate_addon': {'seedprod_lite_deactivate_addon'}, 'seedprod_lite_v2_get_plugins_list': {'seedprod_lite_v2_get_plugins_list'}, 'seedprod_lite_get_wpform': {'seedprod_lite_get_wpform'}, 'seedprod_lite_v2_check_default_pages': {'seedprod_lite_v2_check_default_pages'}, 'seedprod_lite_v2_import_theme_request': {'seedprod_lite_v2_import_theme_request'}, 'seedprod_lite_get_woocommerce_product_attribute_terms': {'seedprod_lite_get_woocommerce_product_attribute_terms'}}
*
***/
