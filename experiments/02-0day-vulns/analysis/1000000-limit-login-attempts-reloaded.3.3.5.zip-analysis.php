...
*Overview: {'app_acl_remove_rule_callback': {'app_acl_remove_rule'}, 'activate_micro_cloud_callback': {'activate_micro_cloud'}, 'dismiss_notify_notice_callback': {'dismiss_notify_notice'}, 'app_load_country_access_rules_callback': {'app_load_country_access_rules'}, 'subscribe_email_callback': {'subscribe_email'}, 'dismiss_review_notice_callback': {'dismiss_review_notice'}, 'app_load_successful_login_callback': {'app_load_successful_login'}, 'app_country_rule_callback': {'app_country_rule'}, 'app_load_lockouts_callback': {'app_load_lockouts'}, 'test_email_notifications_callback': {'test_email_notifications'}, 'dismiss_onboarding_popup_callback': {'dismiss_onboarding_popup'}, 'app_acl_add_rule_callback': {'app_acl_add_rule'}, 'ajax_unlock': {'limit-login-unlock'}, 'block_by_country_callback': {'block_by_country'}, 'ajax_generate_rescue_codes': {'llar_mfa_generate_rescue_codes'}, 'get_remaining_attempts_message_callback': {'nopriv_get_remaining_attempts_message'}, 'strong_account_policies_callback': {'strong_account_policies'}, 'app_setup_callback': {'app_setup'}, 'app_config_save_callback': {'app_config_save'}, 'app_log_action_callback': {'app_log_action'}, 'mfa_flow_send_code_callback': {'nopriv_llar_mfa_flow_send_code', 'llar_mfa_flow_send_code'}, 'app_load_acl_rules_callback': {'app_load_acl_rules'}, 'close_premium_message': {'close_premium_message'}, 'toggle_auto_update_callback': {'toggle_auto_update'}, 'app_load_log_callback': {'app_load_log'}, 'app_toggle_country_callback': {'app_toggle_country'}, 'onboarding_reset_callback': {'onboarding_reset'}, 'enable_notify_callback': {'enable_notify'}}
*
***/
...
/** Function mfa_flow_send_code_callback() called by wp_ajax hooks: {'nopriv_llar_mfa_flow_send_code', 'llar_mfa_flow_send_code'} **/
