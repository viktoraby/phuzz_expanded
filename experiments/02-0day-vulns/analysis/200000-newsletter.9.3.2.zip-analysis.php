...
*Overview: {'ajax_tnpc_regenerate_email': {'tnpc_regenerate_email'}, 'ajax_tnpc_render': {'tnpc_render'}, 'ajax_tnpc_block_form': {'tnpc_block_form'}, 'ajax_ai_subjects': {'newsletter_ai_subjects'}, 'tracking': {'tnptr', 'nopriv_tnptr'}, 'ajax_tnpc_test_raw_html': {'tnpc_test_raw_html'}, 'ajax_composer_ai_generate': {'newsletter_composer_ai_generate'}, 'newsletter-log': {'newsletter-log'}, 'ajax_get_preset': {'tnpc_get_preset'}, 'ajax_tnpc_preview': {'tnpc_preview'}, 'ajax_tnpc_css': {'tnpc_css'}, 'ajax_action': {'nopriv_tnp', 'tnp'}, 'ajax_get_all_presets': {'tnpc_get_all_presets'}, 'ajax_tnpc_test': {'tnpc_test'}, 'ajax_tnpc_options': {'tnpc_options'}}
*
***/
