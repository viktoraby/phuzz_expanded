...
*Overview: {'reset': {'reset_eb_admin_options'}, 'dismiss_pointer': {'eb_dismiss_pointer'}, 'hide_pattern_library': {'hide_pattern_library'}, 'templates': {'get_eb_admin_templates'}, 'callback': {'nopriv_$action', '$action'}, 'get': {'get_eb_admin_options'}, 'eb_admin_promotion': {'eb_admin_promotion'}, 'wp_ajax$action': set(), 'eb_save_quick_setup': {'eb_save_quick_setup'}, 'eb_quick_setup_save_tracking': {'eb_quick_setup_save_tracking'}, 'eb_save_quick_toolbar_blocks': {'eb_save_quick_toolbar_blocks'}, 'save': {'save_eb_admin_options'}, 'template_count': {'get_eb_admin_template_count'}}
*
***/
