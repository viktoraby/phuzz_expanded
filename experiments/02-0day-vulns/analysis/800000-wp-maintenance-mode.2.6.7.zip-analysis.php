...
*Overview: {'subscribe_newsletter': {'wpmm_subscribe'}, 'toggle_gutenberg': {'wpmm_toggle_gutenberg'}, 'select_page': {'wpmm_select_page'}, 'send_contact': {'wpmm_send_contact', 'nopriv_wpmm_send_contact'}, 'subscribers_empty_list': {'wpmm_subscribers_empty_list'}, 'reset_plugin_settings': {'wpmm_reset_settings'}, 'insert_template': {'wpmm_insert_template'}, 'wp_ajax_install_plugin': {'wp_ajax_install_plugin'}, 'change_template_category': {'wpmm_change_template_category'}, 'add_subscriber': {'wpmm_add_subscriber', 'nopriv_wpmm_add_subscriber'}, 'skip_wizard': {'wpmm_skip_wizard'}, 'dismiss': {'themeisle_sdk_dismiss_notice'}, 'dismiss_notices': {'wpmm_dismiss_notices'}, 'subscribers_export': {'wpmm_subscribers_export'}, 'wpmm_update_sdk_options': {'wpmm_update_sdk_options'}}
*
***/
