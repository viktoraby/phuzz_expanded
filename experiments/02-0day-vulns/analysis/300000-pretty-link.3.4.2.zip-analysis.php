...
*Overview: {'ajax_addon_activate': {'prli_addon_activate'}, 'search_results': {'prli_search_for_links'}, 'dismiss': {'prli_notification_dismiss'}, 'validate_tinymce_slug': {'prli_tinymce_validate_slug'}, 'display_tinymce_form': {'prli_tinymce_form'}, 'ajax_addon_install': {'prli_addon_install'}, 'ajax_deactivate_license': {'prli_deactivate_license'}, 'save_bulk_edit': {'prli_links_list_save_bulk_edit'}, 'ajax_validate_pretty_link': {'validate_pretty_link'}, 'ajax_addon_deactivate': {'prli_addon_deactivate'}, 'ajax_activate_license': {'prli_activate_license'}, 'ajax_reset_pretty_link': {'reset_pretty_link'}, 'ajax_quick_create': {'prli_quick_create'}, 'create_pretty_link': {'prli_create_pretty_link'}, 'dismiss_upgrade_header': {'pl_dismiss_upgrade_header'}, 'ajax_install_license_edition': {'prli_install_license_edition'}, 'ajax_stop_or_delay_popup': {'prli_delay_popup', 'prli_stop_popup'}, 'dismiss_review_prompt': {'pl_dismiss_review_prompt'}, 'plp_edge_updates': {'plp_edge_updates'}}
*
***/
