...
*Overview: {'dismiss_banner': {'wpmudev_bf_dismiss'}, 'dismiss_multisite_notification': {'wpmudev_blc_multisite_notification_dismiss'}, 'ajax_current_load': {'blc_current_load'}, 'ajax_work': {'blc_work'}, 'ajax_recheck': {'blc_recheck'}, 'ajax_deredirect': {'blc_deredirect'}, 'ajax_unlink': {'blc_unlink'}, 'ajax_undismiss': {'blc_undismiss'}, 'ajax_dashboard_status': {'blc_dashboard_status'}, 'ajax_full_status': {'blc_full_status'}, 'ajax_discard': {'blc_discard'}, 'ajax_edit': {'blc_edit'}, 'ajax_link_details': {'blc_link_details'}, 'ajax_dismiss': {'blc_dismiss'}}
*
***/

/** Function dismiss_banner() called by wp_ajax hooks: {'wpmudev_bf_dismiss'} **/
/** No params detected :-/ **/
