...
*Overview: {'ajax_cf7_ai_generate_form': {'cf7_ai_generate_form'}, '_toggle_debug_mode': {'fs_toggle_debug_mode'}, 'ajax_cf7_ai_refresh_usage': {'cf7_ai_refresh_usage'}, 'honeypot4cf7_dismiss_notice': {'honeypot4cf7_dismiss_notice'}, 'fetch_app_settings': {'nopriv_cf7apps_fetch_settings', 'cf7apps_fetch_settings'}, 'dismiss_notice_ajax_callback': {'fs_dismiss_notice_action_{$ajax_action_suffix}'}}
*
***/
...
/** Function fetch_app_settings() called by wp_ajax hooks: {'nopriv_cf7apps_fetch_settings', 'cf7apps_fetch_settings'} **/
