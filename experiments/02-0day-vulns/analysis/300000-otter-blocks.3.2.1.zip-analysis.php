...
*Overview: {'disable_notification_ajax': {'themeisle_sdk_dismiss_black_friday_notice', 'dismiss_themeisle_event_notice_otter'}, 'dismiss_dashboard_notice': {'dismiss_otter_notice'}, 'remove_welcome_notice': {'otter_animation_dismiss_welcome_notice'}, 'dismiss': {'themeisle_sdk_dismiss_notice'}, 'dismiss_promotion': {'tisdk_update_option'}, 'ThemeisleSDK\\Modules\\Notification::dismiss': {'themeisle_sdk_dismiss_notice'}, 'export_submissions': {'otter_form_submissions'}, 'dismiss_license_notice': {'themeisle_sdk_dismiss_license_notice'}}
*
***/
