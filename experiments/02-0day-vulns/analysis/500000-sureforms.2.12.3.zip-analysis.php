...
*Overview: {'create_payment_intent': {'srfm_create_payment_intent', 'nopriv_srfm_create_payment_intent'}, 'ajax_delete_log': {'srfm_delete_payment_log'}, 'handle_notice_response': {'srfm_notice_response'}, 'wp_ajax_install_plugin': {'sureforms_recommended_plugin_install'}, 'fetch_forms_list': {'srfm_fetch_forms_list'}, 'ajax_pause_subscription': {'srfm_stripe_pause_subscription'}, 'fetch_single_payment': {'srfm_fetch_single_payment'}, 'pointer_should_show': {'should_show_pointer'}, 'pointer_dismissed': {'sureforms_dismiss_pointer'}, 'generate_data_for_suretriggers_integration': {'sureforms_integration'}, 'dismiss_notice': {'astra-notice-dismiss'}, 'pointer_accepted_cta': {'sureforms_accept_cta'}, 'ajax_refund_payment': {'srfm_refund_payment'}, 'ajax_cancel_subscription': {'srfm_stripe_cancel_subscription', 'srfm_frontend_cancel_subscription'}, 'required_plugin_activate': {'sureforms_recommended_plugin_activate'}, 'fetch_payments': {'srfm_fetch_payments_transactions'}, 'handle_dismiss': {'srfm_editor_nudge_dismiss'}, 'fetch_subscription': {'srfm_fetch_subscription'}, 'track_ai_widget_usage': {'srfm_ai_widget_usage'}, 'srfm_global_sidebar_enabled': {'srfm_global_sidebar_enabled'}, 'srfm_global_update_allowed_block': {'srfm_global_update_allowed_block'}, 'ajax_bulk_delete_payments': {'srfm_bulk_delete_payments'}, 'send_plugin_deactivate_feedback': {'uds_plugin_deactivate_feedback'}, 'field_unique_validation': {'nopriv_validation_ajax_action', 'validation_ajax_action'}, 'download_export_file': {'srfm_download_export'}, 'ajax_delete_note': {'srfm_delete_payment_note'}, 'create_subscription_intent': {'srfm_create_subscription_intent', 'nopriv_srfm_create_subscription_intent'}, 'ajax_add_note': {'srfm_add_payment_note'}}
*
***/
...
/** Function ajax_cancel_subscription() called by wp_ajax hooks: {'srfm_stripe_cancel_subscription', 'srfm_frontend_cancel_subscription'} **/
