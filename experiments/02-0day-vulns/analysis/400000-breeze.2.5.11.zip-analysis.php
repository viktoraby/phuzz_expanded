...
*Overview: {'breeze_dismiss_cache_notice': {'breeze_dismiss_cache_notice'}, 'wp_ajax_breeze_purge_file': {'breeze_purge_varnish'}, 'update_options_for_advanced': {'save_settings_tab_advanced'}, 'update_options_for_basic': {'save_settings_tab_basic'}, 'breeze_option_tab_display': {'breeze_load_options_tab'}, 'clear_breeze_cache': {'shortpixel_ai_handle_page_action'}, 'regenerate_breeze_api_key': {'refresh_api_token_key'}, 'update_options_for_heartbeat': {'save_settings_tab_heartbeat'}, 'update_options_for_varnish': {'save_settings_tab_varnish'}, 'update_options_for_preload': {'save_settings_tab_preload'}, 'update_options_for_database': {'save_settings_tab_database'}, 'update_options_for_faq': {'save_settings_tab_faq'}, 'update_options_for_tools': {'save_settings_tab_tools'}, 'Breeze_Configuration': {'breeze_check_cdn_url', 'breeze_purge_opcache', 'breeze_reset_default', 'breeze_purge_database'}, 'update_options_for_inherit': {'save_settings_tab_inherit'}, 'update_options_for_file': {'save_settings_tab_file'}, 'breeze_check_the_files_permission': {'breeze_file_permission_check'}, 'export_json_settings': {'breeze_export_json'}, 'import_json_settings': {'breeze_import_json'}, 'compatibility_warning_close': {'compatibility_warning_close'}, 'Breeze_One_Click_Optimization': {'breeze_hide_optimization_notice', 'breeze_apply_optimization', 'breeze_check_compatibility', 'breeze_restore_settings'}, 'update_options_for_cdn': {'save_settings_tab_cdn'}, 'breeze_woocs_fetch_currency': {'nopriv_breeze_woocs_currency_get', 'breeze_woocs_currency_get'}, 'store_update_count': {'store_update_count'}}
*
***/
...
/** Function Breeze_Configuration() called by wp_ajax hooks: {'breeze_check_cdn_url', 'breeze_purge_opcache', 'breeze_reset_default', 'breeze_purge_database'} **/
/** No function found :-/ **/
...
/** Function Breeze_One_Click_Optimization() called by wp_ajax hooks: {'breeze_hide_optimization_notice', 'breeze_apply_optimization', 'breeze_check_compatibility', 'breeze_restore_settings'} **/
/** No function found :-/ **/
...
/** Function breeze_woocs_fetch_currency() called by wp_ajax hooks: {'nopriv_breeze_woocs_currency_get', 'breeze_woocs_currency_get'} **/
