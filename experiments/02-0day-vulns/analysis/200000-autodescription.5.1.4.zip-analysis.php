...
*Overview: {'prepare_columns_wp_ajax_inline_save': {'inline-save'}, 'get_author_slug': {'tsf_get_author_slug'}, 'prepare_columns_wp_ajax_add_tag': {'add-tag'}, 'prepare_columns_wp_ajax_inline_save_tax': {'inline-save-tax'}, 'get_post_parent_slugs': {'tsf_get_post_parent_slugs'}, 'crop_image': {'tsf_crop_image'}, 'get_post_data': {'tsf_update_post_data'}, 'dismiss_notice': {'tsf_dismiss_notice'}, 'get_term_parent_slugs': {'tsf_get_term_parent_slugs'}, 'update_counter_type': {'tsf_update_counter'}}
*
***/
