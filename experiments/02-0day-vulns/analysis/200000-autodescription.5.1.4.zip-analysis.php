...
*Overview: {'prepare_columns_wp_ajax_add_tag': {'add-tag'}, 'crop_image': {'tsf_crop_image'}, 'get_author_slug': {'tsf_get_author_slug'}, 'get_term_parent_slugs': {'tsf_get_term_parent_slugs'}, 'get_post_data': {'tsf_update_post_data'}, 'get_post_parent_slugs': {'tsf_get_post_parent_slugs'}, 'prepare_columns_wp_ajax_inline_save': {'inline-save'}, 'prepare_columns_wp_ajax_inline_save_tax': {'inline-save-tax'}, 'update_counter_type': {'tsf_update_counter'}, 'dismiss_notice': {'tsf_dismiss_notice'}}
*
***/
