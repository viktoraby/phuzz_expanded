...
*Overview: {'siteorigin_widget_image_import': {'so_widgets_image_import'}, 'siteorigin_widget_preview_widget_action': {'so_widgets_preview'}, 'siteorigin_widgets_dismiss_widget_action': {'so_dismiss_widget_teaser'}, 'admin_ajax_settings_form': {'so_widgets_setting_form'}, 'siteorigin_widget_get_posts_count_action': {'sow_get_posts_count'}, 'admin_ajax_settings_save': {'so_widgets_setting_save'}, 'siteorigin_widget_action_search_terms': {'so_widgets_search_terms'}, 'siteorigin_widget_get_icon_list': {'siteorigin_widgets_get_icons'}, 'siteorigin_widget_remote_image_search': {'so_widgets_image_search'}, 'ajax_render_widget_form': {'elementor_editor_get_wp_widget_form'}, 'sowb_vc_widget_render_form': {'sowb_vc_widget_render_form'}, 'admin_ajax_get_javascript_variables': {'sow_get_javascript_variables'}, 'sow_carousel_get_next_posts_page': {'sow_carousel_load', 'nopriv_sow_carousel_load'}, 'admin_ajax_manage_handler': {'so_widgets_bundle_manage'}, 'siteorigin_widget_action_search_posts': {'so_widgets_search_posts'}}
*
***/
