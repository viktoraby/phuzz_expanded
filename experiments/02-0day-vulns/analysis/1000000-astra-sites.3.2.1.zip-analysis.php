...
*Overview: {'check_sync_status': {'ast-block-templates-check-sync-library-status'}, 'import_all_categories_and_tags': {'astra-sites-import-all-categories-and-tags'}, 'set_start_flag': {'astra-sites-set-start-flag'}, 'activate_plugin': {'ast_block_templates_activate_plugin'}, 'delete_imported_terms': {'astra-sites-delete-terms'}, 'reset_site_options': {'astra-sites-reset-site-options'}, 'delete_imported_posts': {'astra-sites-delete-posts'}, 'ajax_import_sites': {'ast-block-templates-import-sites'}, 'import_cartflows': {'astra-sites-import-cartflows'}, 'import_end': {'astra-sites-import-end'}, 'ajax_blocks_requests_count': {'ast-block-templates-get-blocks-request-count'}, 'dismiss_notice': {'astra-notice-dismiss'}, 'report_error': {'report_error'}, 'update_library': {'astra-sites-update-library'}, 'import_all_categories': {'astra-sites-import-all-categories'}, 'reset_customizer_data': {'astra-sites-reset-customizer-data'}, 'prepare_xml_data': {'astra-sites-import-prepare-xml'}, 'check_import_status': {'astra_sites_check_import_status'}, 'import_options': {'astra-sites-import-options'}, 'set_site_data': {'astra_sites_set_site_data'}, 'reset_widgets_data': {'astra-sites-reset-widgets-data'}, 'delete_imported_wp_forms': {'astra-sites-delete-wp-forms'}, 'ajax_import_categories': {'ast-block-templates-import-categories'}, 'import_block_categories': {'astra-sites-import-block-categories'}, 'sites_requests_count': {'astra-sites-get-sites-request-count'}, 'get_all_categories_and_tags': {'astra-sites-get-all-categories-and-tags'}, 'import_block': {'ast_block_templates_import_block'}, 'import_wpforms': {'ast_block_templates_import_wpforms', 'astra-sites-import-wpforms'}, 'update_library_complete': {'ast-block-templates-update-sync-library-status', 'astra-sites-update-library-complete'}, 'ajax_import_blocks': {'ast-block-templates-import-blocks'}, 'get_all_categories': {'astra-sites-get-all-categories'}, 'import_blocks': {'astra-sites-import-blocks'}, 'import_widgets': {'astra-sites-import-widgets'}, 'save_page_builder_on_ajax': {'astra-sites-change-page-builder'}, 'import_sites': {'astra-sites-import-sites'}, 'import_customizer_settings': {'astra-sites-import-customizer-settings'}, 'import_page_builders': {'astra-sites-import-page-builders'}, 'ajax_sites_requests_count': {'ast-block-templates-get-sites-request-count'}, 'template_importer': {'ast_block_templates_importer'}, 'blocks_requests_count': {'astra-sites-get-blocks-request-count'}, 'sse_import': {'astra-wxr-import'}, 'import_spectra_settings': {'astra-sites-import-spectra-settings'}}
*
***/
