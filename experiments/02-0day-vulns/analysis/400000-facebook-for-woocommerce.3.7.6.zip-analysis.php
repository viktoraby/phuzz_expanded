...
*Overview: {'reset_plugin_updated_successfully_but_master_sync_off_banner': {'nopriv_wc_banner_post_update__master_sync_off_close_action', 'wc_banner_post_update__master_sync_off_close_action'}, 'handle_set_excluded_terms_prompt': {'facebook_for_woocommerce_set_excluded_terms_prompt'}, 'sync_shipping_profiles': {'wc_facebook_sync_shipping_profiles'}, 'sync_all_clicked': {'nopriv_wc_facebook_sync_all_products', 'wc_facebook_sync_all_products'}, 'product_set_banner_closed': {'wc_facebook_product_set_banner_closed'}, 'sync_navigation_menu': {'wc_facebook_sync_navigation_menu'}, 'ajax_dismiss_notice': {'wc_facebook_dismiss_notice', 'fb_dismiss_attribute_notice'}, 'ajax_woo_adv_bulk_edit_compat': {'wpmelon_adv_bulk_edit'}, 'ajax_display_test_result': {'ajax_display_test_result'}, 'handle_set_product_sync_bulk_action_prompt': {'facebook_for_woocommerce_set_product_sync_bulk_action_prompt'}, 'opt_out_of_sync_clicked': {'wc_facebook_opt_out_of_sync', 'nopriv_wc_facebook_opt_out_of_sync'}, 'ajax_reset_all_fb_products': {'ajax_reset_all_fb_products'}, 'ajax_dismiss_unmapped_attributes_banner': {'fb_dismiss_unmapped_attributes_banner'}, 'handle_connection_test_response': {'nopriv_{$this->identifier}_test'}, 'reset_upcoming_version_banners': {'wc_banner_close_action', 'nopriv_wc_banner_close_action'}, 'ajax_fb_background_check_queue': {'ajax_fb_background_check_queue'}, 'dismiss_banner': {'dismiss_fb_unmapped_attribute_banner'}, 'get_sync_status': {'wc_facebook_get_sync_status'}, 'reset_plugin_updated_successfully_banner': {'nopriv_wc_banner_post_update_close_action', 'wc_banner_post_update_close_action'}, 'ajax_get_facebook_product_data': {'get_facebook_product_data'}, 'ajax_test_banner': {'test_fb_banner'}, 'sync_products': {'wc_facebook_sync_products'}, 'ajax_check_feed_upload_status': {'ajax_check_feed_upload_status'}, 'sync_coupons': {'wc_facebook_sync_coupons'}, 'ajax_fb_toggle_visibility': {'ajax_fb_toggle_visibility'}, 'ajax_sync_facebook_attributes': {'sync_facebook_attributes'}, 'handle_dismiss_disabled_notice_ajax': {'wc_facebook_dismiss_disabled_notice'}, 'ajax_render_enhanced_catalog_attributes_field': {'wc_facebook_enhanced_catalog_attributes'}}
*
***/
...
/** Function reset_plugin_updated_successfully_banner() called by wp_ajax hooks: {'nopriv_wc_banner_post_update_close_action', 'wc_banner_post_update_close_action'} **/
/** No params detected :-/ **/
