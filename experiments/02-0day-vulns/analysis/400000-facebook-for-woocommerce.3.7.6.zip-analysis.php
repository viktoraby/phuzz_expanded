...
*Overview: {'sync_navigation_menu': {'wc_facebook_sync_navigation_menu'}, 'reset_upcoming_version_banners': {'nopriv_wc_banner_close_action', 'wc_banner_close_action'}, 'sync_coupons': {'wc_facebook_sync_coupons'}, 'sync_all_clicked': {'nopriv_wc_facebook_sync_all_products', 'wc_facebook_sync_all_products'}, 'handle_set_product_sync_bulk_action_prompt': {'facebook_for_woocommerce_set_product_sync_bulk_action_prompt'}, 'sync_products': {'wc_facebook_sync_products'}, 'ajax_check_feed_upload_status': {'ajax_check_feed_upload_status'}, 'ajax_woo_adv_bulk_edit_compat': {'wpmelon_adv_bulk_edit'}, 'ajax_reset_all_fb_products': {'ajax_reset_all_fb_products'}, 'opt_out_of_sync_clicked': {'wc_facebook_opt_out_of_sync', 'nopriv_wc_facebook_opt_out_of_sync'}, 'ajax_sync_facebook_attributes': {'sync_facebook_attributes'}, 'ajax_render_enhanced_catalog_attributes_field': {'wc_facebook_enhanced_catalog_attributes'}, 'reset_plugin_updated_successfully_banner': {'wc_banner_post_update_close_action', 'nopriv_wc_banner_post_update_close_action'}, 'ajax_dismiss_notice': {'fb_dismiss_attribute_notice', 'wc_facebook_dismiss_notice'}, 'dismiss_banner': {'dismiss_fb_unmapped_attribute_banner'}, 'sync_shipping_profiles': {'wc_facebook_sync_shipping_profiles'}, 'ajax_fb_background_check_queue': {'ajax_fb_background_check_queue'}, 'get_sync_status': {'wc_facebook_get_sync_status'}, 'ajax_dismiss_unmapped_attributes_banner': {'fb_dismiss_unmapped_attributes_banner'}, 'ajax_test_banner': {'test_fb_banner'}, 'handle_connection_test_response': {'nopriv_{$this->identifier}_test'}, 'reset_plugin_updated_successfully_but_master_sync_off_banner': {'nopriv_wc_banner_post_update__master_sync_off_close_action', 'wc_banner_post_update__master_sync_off_close_action'}, 'product_set_banner_closed': {'wc_facebook_product_set_banner_closed'}, 'handle_dismiss_disabled_notice_ajax': {'wc_facebook_dismiss_disabled_notice'}, 'ajax_display_test_result': {'ajax_display_test_result'}, 'ajax_get_facebook_product_data': {'get_facebook_product_data'}, 'ajax_fb_toggle_visibility': {'ajax_fb_toggle_visibility'}, 'handle_set_excluded_terms_prompt': {'facebook_for_woocommerce_set_excluded_terms_prompt'}}
*
***/
...
/** Function reset_upcoming_version_banners() called by wp_ajax hooks: {'nopriv_wc_banner_close_action', 'wc_banner_close_action'} **/
/** No params detected :-/ **/
...
/** Function sync_all_clicked() called by wp_ajax hooks: {'nopriv_wc_facebook_sync_all_products', 'wc_facebook_sync_all_products'} **/
/** No params detected :-/ **/
...
/** Function opt_out_of_sync_clicked() called by wp_ajax hooks: {'wc_facebook_opt_out_of_sync', 'nopriv_wc_facebook_opt_out_of_sync'} **/
/** No params detected :-/ **/
...
/** Function ajax_dismiss_notice() called by wp_ajax hooks: {'fb_dismiss_attribute_notice', 'wc_facebook_dismiss_notice'} **/
/** No params detected :-/ **/
