...
*Overview: {'save_popup_enabled_state': {'pum_save_enabled_state'}, 'process_batch_request': {'pum_process_batch_request'}, 'object_search': {'pum_object_search'}, 'process_upgrade_request': {'pum_process_upgrade_request'}, 'wp_ajax_pum_do_shortcode': {'pum_do_shortcode'}, 'do_shortcode': {'pum_do_shortcode'}, 'trigger_upgrades': {'pum_trigger_upgrades'}, 'ajax_handler': {'pum_review_action', 'pum_alerts_action'}, 'ajax_request': {'nopriv_pum_analytics', 'pum_analytics', 'nopriv_pum_sub_form', 'pum_sub_form'}}
*
***/
...
/** Function ajax_request() called by wp_ajax hooks: {'nopriv_pum_analytics', 'pum_analytics', 'nopriv_pum_sub_form', 'pum_sub_form'} **/
/** No params detected :-/ **/
