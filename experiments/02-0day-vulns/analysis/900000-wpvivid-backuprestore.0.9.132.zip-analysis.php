...
*Found actions: 166
*Found functions:147
*Extracted functions:147
*Total parameter names extracted: 98
*Overview: {'get_import_progress': {'wpvivid_get_import_progress'}, 'get_general_setting': {'wpvivid_get_general_setting'}, 'upload_import_file_complete': {'wpvivid_upload_import_file_complete'}, 'get_schedule': {'wpvivid_get_schedule'}, 'set_general_setting': {'wpvivid_set_general_setting'}, 'test_connect_site': {'wpvivid_test_connect_site'}, 'wpvivid_download_export_backup': {'wpvivid_download_export_backup'}, 'do_restore': {'wpvivid_do_restore_2', 'nopriv_wpvivid_do_restore_2'}, 'start_import': {'wpvivid_start_import'}, 'generate_url': {'wpvivid_generate_url'}, 'scan_uploads_files_from_post': {'wpvivid_scan_uploads_files_from_post'}, 'delete_remote': {'wpvivid_delete_remote'}, 'create_debug_package': {'wpvivid_create_debug_package'}, 'download_backup': {'wpvivid_download_backup'}, 'list_tasks': {'wpvivid_list_tasks', 'wpvivid_list_tasks_2', 'wpvivid_export_list_tasks', 'wpvivid_list_upload_tasks'}, 'delete_post_type': {'wpvivid_delete_post_type'}, 'start_staging': {'wpvividstg_start_staging_free', 'nopriv_wpvividstg_start_staging_free'}, 'upload_files': {'wpvivid_upload_files'}, 'calc_import_folder_size': {'wpvivid_calc_import_folder_size'}, 'unused_files_task': {'wpvivid_unused_files_task'}, 'get_restore_snapshot_status': {'wpvivid_get_restore_snapshot_status'}, 'get_backup_count': {'wpvivid_get_backup_count'}, 'backup_now': {'wpvivid_backup_now'}, 'get_last_backup': {'wpvivid_get_last_backup'}, 'restore_selected_image': {'wpvivid_restore_selected_image'}, 'upload_files_finish': {'wpvivid_upload_files_finish'}, 'set_default_remote_storage': {'wpvivid_set_default_remote_storage'}, 'save_setting': {'wpvividstg_save_setting'}, 'view_log': {'wpvivid_view_log'}, 'get_staging_progress': {'wpvividstg_get_staging_progress_free', 'nopriv_wpvividstg_get_staging_progress_free'}, 'cancel_staging': {'wpvividstg_cancel_staging_free'}, 'init_restore_task': {'wpvivid_init_restore_task_2'}, 'need_review': {'wpvivid_need_review'}, 'init_restore_page': {'wpvivid_init_restore_page'}, 'wpvivid_scan_import_folder': {'wpvivid_scan_import_folder'}, 'rescan_local_folder_set_backup': {'wpvivid_rescan_local_folder'}, 'migrate_now': {'wpvivid_migrate_now_2', 'wpvivid_migrate_now'}, 'check_staging_dir': {'wpvividstg_check_staging_dir_free'}, 'send_backup_to_site': {'wpvivid_send_backup_to_site_2', 'wpvivid_send_backup_to_site'}, 'amazons3_notice': {'wpvivid_amazons3_notice'}, 'delete_backup': {'wpvivid_delete_backup'}, 'delete_all_image': {'wpvivid_start_delete_all_image', 'wpvivid_delete_all_image'}, 'start_scan_uploads_files_task': {'wpvivid_start_scan_uploads_files_task'}, 'add_exclude_files': {'wpvivid_uc_add_exclude_files'}, 'finish_add_remote': {'wpvivid_google_drive_add_remote', 'wpvivid_one_drive_add_remote', 'wpvivid_dropbox_add_remote'}, 'delete_ready_task': {'wpvivid_delete_ready_task'}, 'prepare_restore': {'wpvivid_prepare_restore'}, 'delete_backup_array': {'wpvivid_delete_backup_array'}, 'delete_task': {'wpvivid_delete_task', 'wpvivid_delete_task_2'}, 'hide_wp_cron_notice': {'wpvivid_hide_wp_cron_notice'}, 'backup_cancel': {'wpvivid_backup_cancel'}, 'restore_failed': {'nopriv_wpvivid_restore_failed_2', 'wpvivid_restore_failed_2'}, 'list_remote': {'wpvivid_list_remote'}, 'delete_cancel_staging_site': {'wpvividstg_delete_cancel_staging_site_free'}, 'delete_site': {'wpvividstg_delete_site_free'}, 'download_log': {'wpvividstg_download_log'}, 'start_unused_files_task': {'wpvivid_start_unused_files_task'}, 'view_log_ex': {'wpvividstg_view_log_ex'}, 'export_now': {'wpvivid_export_now'}, 'prepare_export_post': {'wpvivid_prepare_export_post'}, 'import_setting': {'wpvivid_import_setting'}, 'get_iso_list': {'wpvivid_get_iso_list'}, 'get_custom_database_tables_info': {'wpvividstg_get_custom_database_tables_info_free'}, 'isolate_all_image': {'wpvivid_isolate_all_image'}, 'get_file_id': {'wpvivid_get_file_id'}, 'resume_create_snapshot': {'wpvivid_resume_create_snapshot'}, 'start_isolate_all_image': {'wpvivid_start_isolate_all_image'}, 'get_exclude_files_list': {'wpvivid_get_exclude_files_list'}, 'delete_selected_image': {'wpvivid_delete_selected_image'}, 'delete_transfer_key': {'wpvivid_delete_transfer_key'}, 'download_restore_progress': {'wpvivid_get_download_restore_progress'}, 'clean_out_of_date_backup': {'wpvivid_clean_out_of_date_backup'}, 'delete_snapshot': {'wpvivid_delete_snapshot'}, 'restore_all_image': {'wpvivid_start_restore_all_image', 'wpvivid_restore_all_image'}, 'export_post_step3': {'wpvivid_export_post_step3'}, 'check_import_file': {'wpvivid_check_import_file'}, 'get_ini_memory_limit': {'wpvivid_get_ini_memory_limit'}, 'retrieve_remote': {'wpvivid_retrieve_remote'}, 'delete_last_restore_data': {'wpvivid_delete_last_restore_data'}, 'download_restore_file': {'wpvivid_download_restore'}, 'export_post_step2': {'wpvivid_export_post_step2'}, 'get_log_list': {'wpvivid_get_log_list'}, 'prepare_download_backup': {'wpvivid_prepare_download_backup'}, 'get_snapshots_list': {'wpvivid_get_snapshots_list'}, 'cancel_upload_backup_free': {'wpvivid_cancel_upload_backup_free'}, 'get_restore_file_is_migrate': {'wpvivid_get_restore_file_is_migrate'}, 'clean_import_folder': {'wpvivid_clean_import_folder'}, 'finish_restore': {'wpvivid_finish_restore_2', 'nopriv_wpvivid_finish_restore_2'}, 'set_setting': {'wpvivid_set_snapshot_setting'}, 'test_remote_connection': {'wpvivid_test_remote_connection'}, 'get_download_page_ex': {'wpvivid_get_download_page_ex'}, 'download_check_has_zero_date': {'wpvivid_check_download_has_zero_date'}, 'get_export_list': {'wpvivid_get_export_list'}, 'set_schedule': {'wpvivid_set_schedule'}, 'get_snapshot_progress': {'wpvivid_get_snapshot_progress'}, 'delete_export_list': {'wpvivid_delete_export_list'}, 'view_backup_task_log': {'wpvivid_view_backup_task_log'}, 'restore': {'wpvivid_restore', 'nopriv_wpvivid_restore'}, 'get_custom_database_size': {'wpvividstg_get_custom_database_size_free'}, 'create_snapshot': {'wpvivid_create_snapshot'}, 'get_backup_list': {'wpvivid_get_backup_list'}, 'get_post_type_list': {'wpvivid_get_post_type_list'}, 'get_log_list_page': {'wpvividstg_get_log_list_page'}, 'prepare_backup_2': {'wpvivid_prepare_backup_2'}, 'set_restart_staging_id': {'wpvividstg_set_restart_staging_id_free'}, 'get_out_of_date_info': {'wpvivid_get_out_of_date_info'}, 'read_last_backup_log': {'wpvivid_read_last_backup_log'}, 'get_list_page': {'wpvivid_get_post_list_page'}, 'test_additional_database_connect': {'wpvividstg_test_additional_database_connect_free'}, 'is_backup_file_free': {'wpvivid_is_backup_file_free'}, 'delete_upload_incomplete_backup': {'wpvivid_delete_upload_incomplete_backup_free'}, 'edit_remote': {'wpvivid_edit_remote'}, 'get_custom_files_size': {'wpvividstg_get_custom_files_size_free'}, 'get_dir': {'wpvivid_get_dir'}, 'upload_import_files': {'wpvivid_upload_import_files'}, 'get_restore_progress': {'nopriv_wpvivid_get_restore_progress', 'wpvivid_get_restore_progress_2', 'wpvivid_get_restore_progress', 'nopriv_wpvivid_get_restore_progress_2'}, 'upload_files_finish_free': {'wpvivid_upload_files_finish_free'}, 'init_download_page': {'wpvivid_init_download_page'}, 'update_setting': {'wpvivid_update_setting'}, 'restore_snapshot': {'wpvivid_restore_snapshot'}, 'junk_files_info': {'wpvivid_junk_files_info'}, 'get_import_list_page': {'wpvivid_get_import_list_page'}, 'view_backup_log': {'wpvivid_view_backup_log'}, 'export_setting': {'wpvivid_export_setting'}, 'get_result_list': {'wpvivid_get_result_list'}, 'generate_url_ex': {'wpvivid_generate_url_ex'}, 'add_remote': {'wpvivid_add_remote'}, 'get_setting': {'wpvivid_get_setting'}, 'test_send_mail': {'wpvivid_test_send_mail'}, 'delete_ready_task_2': {'wpvivid_delete_ready_task_2'}, 'delete_exclude_files': {'wpvivid_delete_exclude_files'}, 'get_default_remote_storage': {'wpvivid_get_default_remote_storage'}, 'wpvivid_send_debug_info': {'wpvivid_send_debug_info'}, 'set_security_lock': {'wpvivid_set_security_lock'}, 'get_list': {'wpvivid_get_post_list'}, 'task_monitor_ex': {'wpvivid_task_monitor'}, 'export_download_backup': {'wpvivid_export_download_backup'}, 'prepare_backup': {'wpvivid_prepare_backup'}, 'backup_now_2': {'wpvivid_backup_now_2'}, 'clean_local_storage': {'wpvivid_clean_local_storage'}, 'shutdown_backup': {'wpvivid_shutdown_backup'}, 'get_download_progress': {'wpvivid_get_download_progress'}, 'check_remote_alias_exist': {'wpvivid_check_remote_alias_exist'}, 'isolate_selected_image': {'wpvivid_isolate_selected_image'}, 'hide_mainwp_tab_page': {'wpvivid_hide_mainwp_tab_page'}, 'download_backup_mainwp': {'wpvivid_download_backup_mainwp'}, 'update_staging_exclude_extension': {'wpvividstg_update_staging_exclude_extension_free'}}
*
***/
...
/** Function do_restore() called by wp_ajax hooks: {'wpvivid_do_restore_2', 'nopriv_wpvivid_do_restore_2'} **/
/** No params detected :-/ **/
...
/** Function list_tasks() called by wp_ajax hooks: {'wpvivid_list_tasks', 'wpvivid_list_tasks_2', 'wpvivid_export_list_tasks', 'wpvivid_list_upload_tasks'} **/
/** No params detected :-/ **/
...
/** Function start_staging() called by wp_ajax hooks: {'wpvividstg_start_staging_free', 'nopriv_wpvividstg_start_staging_free'} **/
...
/** Function get_staging_progress() called by wp_ajax hooks: {'wpvividstg_get_staging_progress_free', 'nopriv_wpvividstg_get_staging_progress_free'} **/
/** No params detected :-/ **/
...
/** Function migrate_now() called by wp_ajax hooks: {'wpvivid_migrate_now_2', 'wpvivid_migrate_now'} **/
...
/** Function send_backup_to_site() called by wp_ajax hooks: {'wpvivid_send_backup_to_site_2', 'wpvivid_send_backup_to_site'} **/
...
/** Function finish_add_remote() called by wp_ajax hooks: {'wpvivid_google_drive_add_remote', 'wpvivid_one_drive_add_remote', 'wpvivid_dropbox_add_remote'} **/
...
/** Function restore_all_image() called by wp_ajax hooks: {'wpvivid_start_restore_all_image', 'wpvivid_restore_all_image'} **/
...
/** Function get_snapshots_list() called by wp_ajax hooks: {'wpvivid_get_snapshots_list'} **/
/** Parameters found in function get_snapshots_list(): {"post": ["page_num"]} **/
function get_snapshots_list()
    {
        check_ajax_referer( 'wpvivid_ajax', 'nonce' );
        $check=current_user_can('manage_options');
        $check=apply_filters('wpvivid_ajax_check_security',$check);
...
/** Function finish_restore() called by wp_ajax hooks: {'wpvivid_finish_restore_2', 'nopriv_wpvivid_finish_restore_2'} **/
/** No params detected :-/ **/
...
/** Function download_check_has_zero_date() called by wp_ajax hooks: {'wpvivid_check_download_has_zero_date'} **/
/** Parameters found in function download_check_has_zero_date(): {"post": ["backup_id"]} **/
function download_check_has_zero_date()
    {
        try
        {
            check_ajax_referer( 'wpvivid_ajax', 'nonce' );
...
/** Function restore() called by wp_ajax hooks: {'wpvivid_restore', 'nopriv_wpvivid_restore'} **/
...
/** Function get_restore_progress() called by wp_ajax hooks: {'nopriv_wpvivid_get_restore_progress', 'wpvivid_get_restore_progress_2', 'wpvivid_get_restore_progress', 'nopriv_wpvivid_get_restore_progress_2'} **/
...
/** Function generate_url_ex() called by wp_ajax hooks: {'wpvivid_generate_url_ex'} **/
/** Parameters found in function generate_url_ex(): {"post": ["expires"]} **/
function generate_url_ex()
    {
        global $wpvivid_plugin;
        check_ajax_referer( 'wpvivid_ajax', 'nonce' );
        $check=current_user_can('manage_options');
