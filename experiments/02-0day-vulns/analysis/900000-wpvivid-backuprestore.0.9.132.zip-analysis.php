...
*Overview: {'clean_local_storage': {'wpvivid_clean_local_storage'}, 'get_restore_snapshot_status': {'wpvivid_get_restore_snapshot_status'}, 'export_download_backup': {'wpvivid_export_download_backup'}, 'upload_files': {'wpvivid_upload_files'}, 'start_scan_uploads_files_task': {'wpvivid_start_scan_uploads_files_task'}, 'restore_selected_image': {'wpvivid_restore_selected_image'}, 'set_default_remote_storage': {'wpvivid_set_default_remote_storage'}, 'download_restore_progress': {'wpvivid_get_download_restore_progress'}, 'delete_transfer_key': {'wpvivid_delete_transfer_key'}, 'add_remote': {'wpvivid_add_remote'}, 'retrieve_remote': {'wpvivid_retrieve_remote'}, 'need_review': {'wpvivid_need_review'}, 'download_backup': {'wpvivid_download_backup'}, 'get_import_list_page': {'wpvivid_get_import_list_page'}, 'rescan_local_folder_set_backup': {'wpvivid_rescan_local_folder'}, 'get_list': {'wpvivid_get_post_list'}, 'set_restart_staging_id': {'wpvividstg_set_restart_staging_id_free'}, 'delete_all_image': {'wpvivid_delete_all_image', 'wpvivid_start_delete_all_image'}, 'upload_files_finish_free': {'wpvivid_upload_files_finish_free'}, 'get_file_id': {'wpvivid_get_file_id'}, 'create_snapshot': {'wpvivid_create_snapshot'}, 'get_log_list': {'wpvivid_get_log_list'}, 'get_last_backup': {'wpvivid_get_last_backup'}, 'clean_import_folder': {'wpvivid_clean_import_folder'}, 'finish_restore': {'nopriv_wpvivid_finish_restore_2', 'wpvivid_finish_restore_2'}, 'migrate_now': {'wpvivid_migrate_now', 'wpvivid_migrate_now_2'}, 'get_restore_progress': {'wpvivid_get_restore_progress_2', 'nopriv_wpvivid_get_restore_progress', 'nopriv_wpvivid_get_restore_progress_2', 'wpvivid_get_restore_progress'}, 'set_security_lock': {'wpvivid_set_security_lock'}, 'download_log': {'wpvividstg_download_log'}, 'init_download_page': {'wpvivid_init_download_page'}, 'add_exclude_files': {'wpvivid_uc_add_exclude_files'}, 'download_check_has_zero_date': {'wpvivid_check_download_has_zero_date'}, 'check_import_file': {'wpvivid_check_import_file'}, 'read_last_backup_log': {'wpvivid_read_last_backup_log'}, 'export_post_step3': {'wpvivid_export_post_step3'}, 'upload_import_files': {'wpvivid_upload_import_files'}, 'start_staging': {'wpvividstg_start_staging_free', 'nopriv_wpvividstg_start_staging_free'}, 'delete_cancel_staging_site': {'wpvividstg_delete_cancel_staging_site_free'}, 'prepare_download_backup': {'wpvivid_prepare_download_backup'}, 'list_tasks': {'wpvivid_export_list_tasks', 'wpvivid_list_tasks', 'wpvivid_list_upload_tasks', 'wpvivid_list_tasks_2'}, 'update_setting': {'wpvivid_update_setting'}, 'export_setting': {'wpvivid_export_setting'}, 'get_snapshot_progress': {'wpvivid_get_snapshot_progress'}, 'prepare_backup': {'wpvivid_prepare_backup'}, 'delete_post_type': {'wpvivid_delete_post_type'}, 'amazons3_notice': {'wpvivid_amazons3_notice'}, 'view_backup_log': {'wpvivid_view_backup_log'}, 'upload_import_file_complete': {'wpvivid_upload_import_file_complete'}, 'view_log': {'wpvivid_view_log'}, 'backup_now': {'wpvivid_backup_now'}, 'isolate_all_image': {'wpvivid_isolate_all_image'}, 'test_send_mail': {'wpvivid_test_send_mail'}, 'backup_cancel': {'wpvivid_backup_cancel'}, 'get_out_of_date_info': {'wpvivid_get_out_of_date_info'}, 'get_staging_progress': {'nopriv_wpvividstg_get_staging_progress_free', 'wpvividstg_get_staging_progress_free'}, 'view_backup_task_log': {'wpvivid_view_backup_task_log'}, 'cancel_upload_backup_free': {'wpvivid_cancel_upload_backup_free'}, 'delete_backup_array': {'wpvivid_delete_backup_array'}, 'get_setting': {'wpvivid_get_setting'}, 'restore': {'nopriv_wpvivid_restore', 'wpvivid_restore'}, 'delete_last_restore_data': {'wpvivid_delete_last_restore_data'}, 'get_custom_files_size': {'wpvividstg_get_custom_files_size_free'}, 'check_staging_dir': {'wpvividstg_check_staging_dir_free'}, 'delete_snapshot': {'wpvivid_delete_snapshot'}, 'delete_ready_task': {'wpvivid_delete_ready_task'}, 'get_download_progress': {'wpvivid_get_download_progress'}, 'set_general_setting': {'wpvivid_set_general_setting'}, 'clean_out_of_date_backup': {'wpvivid_clean_out_of_date_backup'}, 'edit_remote': {'wpvivid_edit_remote'}, 'resume_create_snapshot': {'wpvivid_resume_create_snapshot'}, 'get_list_page': {'wpvivid_get_post_list_page'}, 'get_backup_count': {'wpvivid_get_backup_count'}, 'get_general_setting': {'wpvivid_get_general_setting'}, 'get_download_page_ex': {'wpvivid_get_download_page_ex'}, 'upload_files_finish': {'wpvivid_upload_files_finish'}, 'cancel_staging': {'wpvividstg_cancel_staging_free'}, 'delete_export_list': {'wpvivid_delete_export_list'}, 'test_connect_site': {'wpvivid_test_connect_site'}, 'start_isolate_all_image': {'wpvivid_start_isolate_all_image'}, 'delete_selected_image': {'wpvivid_delete_selected_image'}, 'generate_url_ex': {'wpvivid_generate_url_ex'}, 'delete_upload_incomplete_backup': {'wpvivid_delete_upload_incomplete_backup_free'}, 'view_log_ex': {'wpvividstg_view_log_ex'}, 'init_restore_page': {'wpvivid_init_restore_page'}, 'list_remote': {'wpvivid_list_remote'}, 'get_snapshots_list': {'wpvivid_get_snapshots_list'}, 'start_import': {'wpvivid_start_import'}, 'wpvivid_send_debug_info': {'wpvivid_send_debug_info'}, 'check_remote_alias_exist': {'wpvivid_check_remote_alias_exist'}, 'hide_mainwp_tab_page': {'wpvivid_hide_mainwp_tab_page'}, 'set_setting': {'wpvivid_set_snapshot_setting'}, 'send_backup_to_site': {'wpvivid_send_backup_to_site', 'wpvivid_send_backup_to_site_2'}, 'get_log_list_page': {'wpvividstg_get_log_list_page'}, 'delete_exclude_files': {'wpvivid_delete_exclude_files'}, 'get_post_type_list': {'wpvivid_get_post_type_list'}, 'restore_failed': {'wpvivid_restore_failed_2', 'nopriv_wpvivid_restore_failed_2'}, 'get_import_progress': {'wpvivid_get_import_progress'}, 'wpvivid_scan_import_folder': {'wpvivid_scan_import_folder'}, 'get_iso_list': {'wpvivid_get_iso_list'}, 'junk_files_info': {'wpvivid_junk_files_info'}, 'test_remote_connection': {'wpvivid_test_remote_connection'}, 'get_default_remote_storage': {'wpvivid_get_default_remote_storage'}, 'export_post_step2': {'wpvivid_export_post_step2'}, 'is_backup_file_free': {'wpvivid_is_backup_file_free'}, 'delete_site': {'wpvividstg_delete_site_free'}, 'start_unused_files_task': {'wpvivid_start_unused_files_task'}, 'create_debug_package': {'wpvivid_create_debug_package'}, 'get_exclude_files_list': {'wpvivid_get_exclude_files_list'}, 'restore_all_image': {'wpvivid_restore_all_image', 'wpvivid_start_restore_all_image'}, 'task_monitor_ex': {'wpvivid_task_monitor'}, 'do_restore': {'nopriv_wpvivid_do_restore_2', 'wpvivid_do_restore_2'}, 'isolate_selected_image': {'wpvivid_isolate_selected_image'}, 'export_now': {'wpvivid_export_now'}, 'generate_url': {'wpvivid_generate_url'}, 'download_backup_mainwp': {'wpvivid_download_backup_mainwp'}, 'scan_uploads_files_from_post': {'wpvivid_scan_uploads_files_from_post'}, 'get_schedule': {'wpvivid_get_schedule'}, 'delete_task': {'wpvivid_delete_task_2', 'wpvivid_delete_task'}, 'save_setting': {'wpvividstg_save_setting'}, 'hide_wp_cron_notice': {'wpvivid_hide_wp_cron_notice'}, 'calc_import_folder_size': {'wpvivid_calc_import_folder_size'}, 'update_staging_exclude_extension': {'wpvividstg_update_staging_exclude_extension_free'}, 'finish_add_remote': {'wpvivid_one_drive_add_remote', 'wpvivid_google_drive_add_remote', 'wpvivid_dropbox_add_remote'}, 'restore_snapshot': {'wpvivid_restore_snapshot'}, 'prepare_export_post': {'wpvivid_prepare_export_post'}, 'download_restore_file': {'wpvivid_download_restore'}, 'get_custom_database_tables_info': {'wpvividstg_get_custom_database_tables_info_free'}, 'delete_backup': {'wpvivid_delete_backup'}, 'get_restore_file_is_migrate': {'wpvivid_get_restore_file_is_migrate'}, 'get_backup_list': {'wpvivid_get_backup_list'}, 'unused_files_task': {'wpvivid_unused_files_task'}, 'set_schedule': {'wpvivid_set_schedule'}, 'wpvivid_download_export_backup': {'wpvivid_download_export_backup'}, 'get_ini_memory_limit': {'wpvivid_get_ini_memory_limit'}, 'import_setting': {'wpvivid_import_setting'}, 'init_restore_task': {'wpvivid_init_restore_task_2'}, 'shutdown_backup': {'wpvivid_shutdown_backup'}, 'test_additional_database_connect': {'wpvividstg_test_additional_database_connect_free'}, 'delete_remote': {'wpvivid_delete_remote'}, 'delete_ready_task_2': {'wpvivid_delete_ready_task_2'}, 'get_result_list': {'wpvivid_get_result_list'}, 'get_dir': {'wpvivid_get_dir'}, 'prepare_restore': {'wpvivid_prepare_restore'}, 'get_custom_database_size': {'wpvividstg_get_custom_database_size_free'}, 'get_export_list': {'wpvivid_get_export_list'}, 'backup_now_2': {'wpvivid_backup_now_2'}, 'prepare_backup_2': {'wpvivid_prepare_backup_2'}}
*
***/
...
/** Function delete_all_image() called by wp_ajax hooks: {'wpvivid_delete_all_image', 'wpvivid_start_delete_all_image'} **/
...
/** Function get_restore_progress() called by wp_ajax hooks: {'wpvivid_get_restore_progress_2', 'nopriv_wpvivid_get_restore_progress', 'nopriv_wpvivid_get_restore_progress_2', 'wpvivid_get_restore_progress'} **/
...
/** Function list_tasks() called by wp_ajax hooks: {'wpvivid_export_list_tasks', 'wpvivid_list_tasks', 'wpvivid_list_upload_tasks', 'wpvivid_list_tasks_2'} **/
/** No params detected :-/ **/
...
/** Function restore_failed() called by wp_ajax hooks: {'wpvivid_restore_failed_2', 'nopriv_wpvivid_restore_failed_2'} **/
/** No params detected :-/ **/
...
/** Function delete_task() called by wp_ajax hooks: {'wpvivid_delete_task_2', 'wpvivid_delete_task'} **/
/** No params detected :-/ **/
...
/** Function finish_add_remote() called by wp_ajax hooks: {'wpvivid_one_drive_add_remote', 'wpvivid_google_drive_add_remote', 'wpvivid_dropbox_add_remote'} **/
