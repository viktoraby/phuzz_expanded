...
*Overview: {'wpr_get_filtered_count_products': {'wpr_get_filtered_count_products', 'nopriv_wpr_get_filtered_count_products'}, 'ajax_ppc_verify_password': {'nopriv_wpr_ppc_verify_password', 'wpr_ppc_verify_password'}, 'update_mini_compare': {'nopriv_update_mini_compare', 'update_mini_compare'}, 'wpr_set_pending_template': {'wpr_set_pending_template'}, 'wpr_search_query_results': {'wpr_search_query_results'}, 'wpr_install_news_magazine_x_theme': {'wpr_install_news_magazine_x_theme'}, 'wpr_activate_required_plugins': {'wpr_activate_required_plugins'}, 'wpr_dismiss_backup_popup': {'wpr_dismiss_backup_popup'}, 'handle_file_upload': {'nopriv_wpr_addons_upload_file', 'wpr_addons_upload_file'}, 'wpr_delete_template': {'wpr_delete_template'}, 'count_wishlist_items': {'nopriv_count_wishlist_items', 'count_wishlist_items'}, 'wpr_fix_royal_compatibility': {'wpr_fix_royal_compatibility'}, 'update_mini_wishlist': {'nopriv_update_mini_wishlist', 'update_mini_wishlist'}, 'wpr_load_more_tweets_function': {'nopriv_wpr_load_more_tweets', 'wpr_load_more_tweets'}, 'wpr_rating_maybe_later': {'wpr_rating_maybe_later'}, '_toggle_debug_mode': {'fs_toggle_debug_mode'}, 'send_email': {'nopriv_wpr_form_builder_email'}, 'wpr_likes_init': {'wpr_likes_init', 'nopriv_wpr_likes_init'}, 'remove_from_wishlist': {'remove_from_wishlist', 'nopriv_remove_from_wishlist'}, 'wpr_backend_widget_search_query_results': {'wpr_backend_widget_search_query_results'}, 'wpr_get_page_content': {'wpr_get_page_content', 'nopriv_wpr_get_page_content'}, 'add_to_wishlist': {'nopriv_add_to_wishlist', 'add_to_wishlist'}, 'wpr_plugin_update_dismiss_notice': {'wpr_plugin_update_dismiss_notice'}, 'wpr_reset_previous_import': {'wpr_reset_previous_import'}, 'add_to_submissions': {'nopriv_wpr_form_builder_submissions'}, 'remove_from_compare': {'nopriv_remove_from_compare', 'remove_from_compare'}, 'wpr_get_media_filtered_count': {'nopriv_wpr_get_media_filtered_count', 'wpr_get_media_filtered_count'}, 'wpr_pro_features_dismiss_notice': {'wpr_pro_features_dismiss_notice'}, 'wpr_backend_freepro_search_query_results': {'wpr_backend_freepro_search_query_results'}, 'wpr_rating_dismiss_notice': {'wpr_rating_dismiss_notice'}, 'wpr_rating_need_help': {'wpr_rating_need_help'}, 'render_library_templates_blocks': {'render_library_templates_blocks'}, 'render_library_templates_pages': {'render_library_templates_pages'}, 'wpr_get_filtered_count_posts': {'nopriv_wpr_get_filtered_count_posts', 'wpr_get_filtered_count_posts'}, 'count_compare_items': {'nopriv_count_compare_items', 'count_compare_items'}, 'add_cart_single_product_ajax': {'wpr_addons_add_cart_single_product', 'nopriv_wpr_addons_add_cart_single_product'}, 'wpr_import_templates_kit': {'wpr_import_templates_kit'}, 'wpr_save_mega_menu_settings': {'wpr_save_mega_menu_settings'}, 'ajax_mailchimp_subscribe': {'mailchimp_subscribe', 'nopriv_mailchimp_subscribe'}, 'wpr_filter_grid_media': {'wpr_filter_grid_media', 'nopriv_wpr_filter_grid_media'}, 'get_dependent_terms': {'wpr_get_dependent_terms', 'nopriv_wpr_get_dependent_terms'}, 'wpr_rating_already_rated': {'wpr_rating_already_rated'}, 'add_to_compare': {'nopriv_add_to_compare', 'add_to_compare'}, 'send_webhook': {'nopriv_wpr_form_builder_webhook'}, 'check_product_in_wishlist_grid': {'nopriv_check_product_in_wishlist_grid', 'check_product_in_wishlist_grid'}, 'dismiss_notice_ajax_callback': {'fs_dismiss_notice_action_{$ajax_action_suffix}'}, 'wpr_form_builder_mailchimp': {'wpr_form_builder_mailchimp', 'nopriv_wpr_form_builder_mailchimp'}, 'wpr_update_form_action_meta': {'wpr_update_form_action_meta', 'nopriv_wpr_update_form_action_meta'}, 'wpr_install_activate_backup_plugin': {'wpr_install_activate_backup_plugin'}, 'wpr_activate_required_theme': {'wpr_activate_required_theme'}, 'wpr_create_mega_menu_template': {'wpr_create_mega_menu_template'}, 'get_custom_meta_keys': {'nopriv_wpr_get_custom_meta_keys'}, 'wpr_plugin_sale_dismiss_notice': {'wpr_plugin_sale_dismiss_notice'}, 'render_library_templates_popups': {'render_library_templates_popups'}, 'wpr_verify_recaptcha': {'wpr_verify_recaptcha', 'nopriv_wpr_verify_recaptcha'}, 'wpr_load_more_instagram_posts_function': {'wpr_load_more_instagram_posts', 'nopriv_wpr_load_more_instagram_posts'}, 'render_library_templates_sections': {'render_library_templates_sections'}, 'wpr_create_template': {'wpr_create_template'}, 'check_product_in_wishlist': {'nopriv_check_product_in_wishlist', 'check_product_in_wishlist'}, 'check_product_in_compare': {'nopriv_check_product_in_compare', 'check_product_in_compare'}, 'data_fetch': {'nopriv_wpr_data_fetch'}, 'wpr_sale_remind_me_later': {'wpr_sale_remind_me_later'}, 'wpr_final_settings_setup': {'wpr_final_settings_setup'}, 'wpr_import_library_template': {'wpr_import_library_template'}, 'wpr_save_template_conditions': {'wpr_save_template_conditions'}, 'wpr_grid_filters_ajax': {'nopriv_wpr_grid_filters_ajax', 'wpr_grid_filters_ajax'}, 'wpr_woo_grid_filters_ajax': {'nopriv_wpr_woo_grid_filters_ajax', 'wpr_woo_grid_filters_ajax'}, 'check_product_in_compare_grid': {'nopriv_check_product_in_compare_grid', 'check_product_in_compare_grid'}, 'render_library_templates_pages_grid_items': {'render_library_templates_pages_grid_items'}}
*
***/

/** Function wpr_get_filtered_count_products() called by wp_ajax hooks: {'wpr_get_filtered_count_products', 'nopriv_wpr_get_filtered_count_products'} **/
...
/** Function update_mini_compare() called by wp_ajax hooks: {'nopriv_update_mini_compare', 'update_mini_compare'} **/
...
/** Function count_wishlist_items() called by wp_ajax hooks: {'nopriv_count_wishlist_items', 'count_wishlist_items'} **/
...
/** Function update_mini_wishlist() called by wp_ajax hooks: {'nopriv_update_mini_wishlist', 'update_mini_wishlist'} **/
...
/** Function wpr_load_more_tweets_function() called by wp_ajax hooks: {'nopriv_wpr_load_more_tweets', 'wpr_load_more_tweets'} **/
...
/** Function add_to_wishlist() called by wp_ajax hooks: {'nopriv_add_to_wishlist', 'add_to_wishlist'} **/
...
/** Function ajax_mailchimp_subscribe() called by wp_ajax hooks: {'mailchimp_subscribe', 'nopriv_mailchimp_subscribe'} **/
...
/** Function wpr_filter_grid_media() called by wp_ajax hooks: {'wpr_filter_grid_media', 'nopriv_wpr_filter_grid_media'} **/
...
/** Function get_dependent_terms() called by wp_ajax hooks: {'wpr_get_dependent_terms', 'nopriv_wpr_get_dependent_terms'} **/
...
/** Function send_webhook() called by wp_ajax hooks: {'nopriv_wpr_form_builder_webhook'} **/
/** Parameters found in function send_webhook(): {"post": ["nonce", "form_content", "wpr_form_id", "form_name"]} **/
...
/** Function check_product_in_wishlist_grid() called by wp_ajax hooks: {'nopriv_check_product_in_wishlist_grid', 'check_product_in_wishlist_grid'} **/
/** No params detected :-/ **/
...
/** Function wpr_form_builder_mailchimp() called by wp_ajax hooks: {'wpr_form_builder_mailchimp', 'nopriv_wpr_form_builder_mailchimp'} **/
...
/** Function check_product_in_wishlist() called by wp_ajax hooks: {'nopriv_check_product_in_wishlist', 'check_product_in_wishlist'} **/
...
/** Parameters found in function data_fetch(): {"post": ["nonce", "wpr_show_attachments", "wpr_category", "wpr_option_post_type", "wpr_query_type", "wpr_taxonomy_type", "wpr_keyword", "wpr_exclude_without_thumb", "wpr_show_ps_pt", "wpr_number_of_results", "wpr_search_results_offset", "wpr_meta_query", "ajax_search_img_size", "wpr_show_ajax_thumbnail", "wpr_ajax_search_link_target", "ajax_search_link_target", "ajax_search_image_size", "wpr_show_description", "wpr_number_of_words", "wpr_show_product_price", "wpr_show_view_result_btn", "wpr_view_result_text", "wpr_no_results"]} **/
function data_fetch() {
...
/** Function check_product_in_compare_grid() called by wp_ajax hooks: {'nopriv_check_product_in_compare_grid', 'check_product_in_compare_grid'} **/
/** No params detected :-/ **/
