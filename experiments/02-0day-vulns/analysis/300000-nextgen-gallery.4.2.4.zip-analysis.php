...
*Overview: {'install_am_plugin': {'nextgen_install_am_plugin'}, 'createNewThumb': {'createNewThumb'}, 'activate_am_plugin': {'nextgen_activate_am_plugin'}, 'install_recommended_plugins': {'install_recommended_plugins'}, 'deactivate_am_plugin': {'nextgen_deactivate_am_plugin'}, 'ngg_ajax_operation': {'ngg_ajax_operation'}, 'ngg_rotateImage': {'rotateImage'}, 'ajax_set_post_thumbnail': {'ngg_set_post_thumbnail'}, 'mark_admin_menu_tooltip_hidden': {'ngg_hide_admin_menu_tooltip'}, 'save_selected_addons': {'save_selected_addons'}, 'dismiss': {'nextgen_notification_dismiss'}, 'ngg_plugin_verify_license_key': {'ngg_plugin_verify_license_key'}, 'save_onboarding_data': {'save_onboarding_data'}}
*
***/
