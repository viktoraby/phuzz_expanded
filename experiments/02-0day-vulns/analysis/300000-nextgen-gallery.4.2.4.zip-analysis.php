...
*Overview: {'ngg_plugin_verify_license_key': {'ngg_plugin_verify_license_key'}, 'ajax_set_post_thumbnail': {'ngg_set_post_thumbnail'}, 'activate_am_plugin': {'nextgen_activate_am_plugin'}, 'createNewThumb': {'createNewThumb'}, 'save_onboarding_data': {'save_onboarding_data'}, 'install_am_plugin': {'nextgen_install_am_plugin'}, 'ngg_ajax_operation': {'ngg_ajax_operation'}, 'ngg_rotateImage': {'rotateImage'}, 'save_selected_addons': {'save_selected_addons'}, 'deactivate_am_plugin': {'nextgen_deactivate_am_plugin'}, 'install_recommended_plugins': {'install_recommended_plugins'}, 'dismiss': {'nextgen_notification_dismiss'}, 'mark_admin_menu_tooltip_hidden': {'ngg_hide_admin_menu_tooltip'}}
*
***/
