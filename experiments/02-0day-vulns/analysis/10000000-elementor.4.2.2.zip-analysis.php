...
*Overview: {'ajax_elementor_deactivate_feedback': {'elementor_deactivate_feedback'}, 'ajax_elementor_replace_url': {'elementor_replace_url'}, 'get_product_images_ajax': {'elementor-ai-get-product-images'}, 'ajax_save_disabled_elements': {'elementor_element_manager_save_disabled_elements'}, 'handle_direct_actions': {'elementor_library_direct_actions'}, 'js_log': {'elementor_js_log'}, 'handle_ajax_request': {'elementor_ajax'}, 'ajax_reset_api_data': {'elementor_reset_library'}, 'ajax_set_admin_notice_viewed': {'elementor_set_admin_notice_viewed'}, 'ajax_elementor_recreate_kit': {'elementor_recreate_kit'}, 'download_file': {'elementor_system_info_download_file'}, 'ajax_get_widgets_usage': {'elementor_element_manager_get_widgets_usage'}, 'ajax_elementor_clear_cache': {'elementor_clear_cache'}, 'get_images_details': {'elementor_get_images_details'}, 'ajax_get_admin_page_data': {'elementor_element_manager_get_admin_app_data'}, 'handle_click_tracking': {'elementor_send_clicks', 'nopriv_elementor_send_clicks'}, 'set_product_images_ajax': {'elementor-ai-set-product-images'}}
*
***/
