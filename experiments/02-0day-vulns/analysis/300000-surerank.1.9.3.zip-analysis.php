...
*Overview: {'activate_theme': {'surerank_activate_theme'}, 'save_admin_settings': {'surerank_save_admin_settings'}, 'save_post_settings': {'surerank_save_post_settings'}, 'save_term_settings': {'surerank_save_term_settings'}, 'save_user_settings': {'surerank_save_user_settings'}, 'activate_plugin': {'surerank_activate_plugin'}, 'send_plugin_deactivate_feedback': {'uds_plugin_deactivate_feedback'}, 'dismiss_notice': {'astra-notice-dismiss'}, 'handle_notice_response': {'surerank_notice_response'}}
*
***/
