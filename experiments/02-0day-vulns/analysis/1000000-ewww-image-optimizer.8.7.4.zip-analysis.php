...
*Overview: {'ewww_image_optimizer_exactdn_activate_site_ajax': {'ewww_exactdn_activate_site'}, 'ewww_image_optimizer_bulk_async_init': {'ewww_bulk_async_init'}, 'ewww_image_optimizer_webp_loop': {'webp_loop'}, 'ewww_image_optimizer_webp_unwrite': {'ewww_webp_unwrite'}, 'ewww_image_optimizer_aux_images_table_count': {'bulk_aux_images_table_count'}, 'ewww_ngg_manual': {'ewww_ngg_manual'}, 'ewww_image_optimizer_cloud_key_verify_ajax': {'ewww_cloud_key_verify'}, 'dismiss_newsletter_signup_notice': {'ewww_dismiss_newsletter'}, 'ewww_flag_bulk_cleanup': {'bulk_flag_cleanup'}, 'dismiss_lightroom_sync_notice': {'ewww_dismiss_lr_sync'}, 'ewww_flag_manual': {'ewww_flag_manual'}, 'ewww_flag_bulk_loop': {'bulk_flag_loop'}, 'dismiss_exec_notice': {'ewww_dismiss_exec_notice'}, 'ewww_ngg_bulk_loop': {'bulk_ngg_loop'}, 'ewww_ngg_bulk_cleanup': {'bulk_ngg_cleanup'}, 'ewww_image_optimizer_get_bulk_info': {'ewww_get_bulk_info'}, 'dismiss_review_notice': {'ewww_dismiss_review_notice'}, 'ewww_ngg_cloud_restore': {'ewww_ngg_cloud_restore'}, 'ewww_image_optimizer_get_image_savings': {'ewww_get_image_savings'}, 'ewww_image_optimizer_bulk_quota_update': {'bulk_quota_update'}, 'dismiss_utf8_notice': {'ewww_dismiss_utf8_notice'}, 'ewww_image_optimizer_webp_cleanup': {'webp_cleanup'}, 'ewww_image_optimizer_bulk_restore_handler': {'bulk_aux_images_restore_original'}, 'ajax_add_ignore_scaling_rule': {'ewww_add_ignore_scaling_rule'}, 'ajax_add_lazy_exclusion': {'ewww_add_lazy_exclusion'}, 'check_for_optout': {'ewww_opt_out_of_tracking'}, 'ewww_image_optimizer_aux_images_clear_all': {'bulk_aux_images_table_clear'}, 'ewww_flag_image_restore': {'ewww_flag_image_restore'}, 'ewww_image_optimizer_exactdn_register_site_ajax': {'ewww_exactdn_register_site'}, 'ewww_image_optimizer_aux_meta_clean': {'bulk_aux_images_meta_clean'}, 'check_for_optin': {'ewww_opt_into_tracking'}, 'ewww_image_optimizer_bulk_loop': {'ewww_bulk_loop'}, 'ewww_image_optimizer_webp_attachment_count': {'ewwwio_webp_attachment_count'}, 'ewww_image_optimizer_exactdn_get_site_stats_ajax': {'exactdn_get_site_stats'}, 'dismiss_wc_regen_notice': {'ewww_dismiss_wc_regen'}, 'ewww_image_optimizer_delete_webp_handler': {'bulk_aux_images_delete_webp'}, 'ewww_image_optimizer_exactdn_deregister_site_ajax': {'ewww_exactdn_deregister_site'}, 'ewww_image_optimizer_webp_rewrite': {'ewww_webp_rewrite'}, 'ewww_image_optimizer_manual': {'ewww_manual_optimize', 'ewww_manual_restore', 'ewww_manual_image_restore'}, 'restore_single_image_handler': {'ewww_manual_image_restore_single'}, 'ewww_image_optimizer_exactdn_activate_ajax': {'ewww_exactdn_activate'}, 'ewww_image_optimizer_webp_initialize': {'webp_init'}, 'ewww_ngg_image_restore': {'ewww_ngg_image_restore'}, 'ewww_image_optimizer_aux_images_exclude': {'bulk_aux_images_exclude'}, 'ewww_image_optimizer_aux_images_remove': {'bulk_aux_images_remove'}, 'ewww_image_optimizer_bulk_scan_init': {'ewww_bulk_scan_init'}, 'dismiss_media_notice': {'ewww_dismiss_media_notice'}, 'ewww_image_optimizer_bulk_initialize': {'ewww_bulk_init'}, 'ewww_ngg_bulk_init': {'bulk_ngg_init'}, 'ewww_image_optimizer_aux_images_webp_clean_handler': {'bulk_aux_images_webp_clean'}, 'ewww_image_optimizer_ajax_retest_background_optimization': {'ewww_retest_async'}, 'ewww_image_optimizer_bulk_cleanup': {'ewww_bulk_cleanup'}, 'ewww_image_optimizer_aux_images_count_converted': {'bulk_aux_images_count_converted'}, 'ewww_image_optimizer_get_all_attachments': {'ewwwio_get_all_attachments'}, 'ewww_image_optimizer_bulk_update_meta': {'ewww_bulk_update_meta'}, 'ewww_image_optimizer_media_scan': {'ewww_bulk_scan'}, 'ewww_flag_bulk_init': {'bulk_flag_init'}, 'ewww_image_optimizer_aux_images_table': {'bulk_aux_images_table'}, 'ewww_image_optimizer_aux_images_clean': {'bulk_aux_images_table_clean'}, 'ewww_image_optimizer_ajax_get_attachment_status': {'ewww_manual_get_status'}, 'ewww_image_optimizer_ajax_delete_original': {'bulk_aux_images_delete_original'}, 'ewww_image_optimizer_bulk_async_get_status': {'ewww_bulk_async_get_status'}, 'ewww_image_optimizer_aux_images_converted_clean': {'bulk_aux_images_converted_clean'}}
*
***/
...
/** Function ewww_image_optimizer_manual() called by wp_ajax hooks: {'ewww_manual_optimize', 'ewww_manual_restore', 'ewww_manual_image_restore'} **/
