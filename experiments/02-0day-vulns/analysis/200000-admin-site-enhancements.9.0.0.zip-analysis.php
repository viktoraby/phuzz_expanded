...
*Overview: {'dismiss_smtp_password_admin_notice': {'asenha_dismiss_smtp_password_notice'}, 'ajax_get_submission': {'asenha_contact_form_get_submission'}, 'ajax_toggle_disabled': {'asenha_user_account_toggle_disabled'}, 'asenha_have_supported': {'have_supported'}, 'ajax_delete_submission': {'asenha_contact_form_delete_submission'}, 'asenha_dismiss_upgrade_nudge': {'dismiss_upgrade_nudge'}, 'save_custom_content_order': {'save_custom_order'}, 'save_admin_menu': {'save_admin_menu'}, 'handle_submit': {'asenha_contact_form_submit', 'nopriv_asenha_contact_form_submit'}, 'asenha_release_login_lock': {'asenha_release_login_lock'}, 'get_svg_attachment_url': {'svg_get_attachment_url'}, 'save_custom_menu_order': {'save_custom_menu_order'}, 'save_hidden_menu_items': {'save_hidden_menu_items'}, 'send_test_email': {'send_test_email'}, 'asenha_dismiss_support_nudge': {'dismiss_support_nudge'}, 'dismiss_recovery_url_refreshed_notice': {'asenha_dismiss_view_admin_as_recovery_notice'}, 'asenha_dismiss_promo_nudge': {'dismiss_promo_nudge'}}
*
***/
...
/** Function handle_submit() called by wp_ajax hooks: {'asenha_contact_form_submit', 'nopriv_asenha_contact_form_submit'} **/
/** No params detected :-/ **/
