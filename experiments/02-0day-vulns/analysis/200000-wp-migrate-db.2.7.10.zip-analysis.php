...
*Overview: {'ajax_flush': {'wpmdb_flush'}, 'ajax_delete_migration_profile': {'wpmdb_delete_migration_profile'}, 'ajax_migrate_table': {'wpmdb_migrate_table'}, 'ajax_save_profile': {'wpmdb_save_profile'}}
*
***/
...
/** Parameters found in function ajax_migrate_table(): {"post": ["form_data", "primary_keys"]} **/
