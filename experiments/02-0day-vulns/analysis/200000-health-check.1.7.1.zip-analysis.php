...
*Overview: {'run_mail_check': {'health-check-mail-check'}, 'Health_Check_Loopback': {'health-check-loopback-individual-plugins', 'health-check-loopback-default-theme', 'health-check-loopback-no-plugins'}, 'run_files_integrity_check': {'health-check-files-integrity-check'}, 'view_file_diff': {'health-check-view-file-diff'}}
*
***/
...
/** Function Health_Check_Loopback() called by wp_ajax hooks: {'health-check-loopback-individual-plugins', 'health-check-loopback-default-theme', 'health-check-loopback-no-plugins'} **/
/** No function found :-/ **/
