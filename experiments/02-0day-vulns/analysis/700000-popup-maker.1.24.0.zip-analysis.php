...
*Overview: {'process_batch_request': {'pum_process_batch_request'}, 'do_shortcode': {'pum_do_shortcode'}, 'ajax_handler': {'pum_review_action', 'pum_alerts_action'}, 'trigger_upgrades': {'pum_trigger_upgrades'}, 'process_upgrade_request': {'pum_process_upgrade_request'}, 'object_search': {'pum_object_search'}, 'save_popup_enabled_state': {'pum_save_enabled_state'}, 'ajax_request': {'pum_sub_form', 'nopriv_pum_sub_form', 'pum_analytics', 'nopriv_pum_analytics'}, 'wp_ajax_pum_do_shortcode': {'pum_do_shortcode'}}
*
***/
