...
*Overview: {'remove_past_data_ajax_callback': {'kadence_remove_past_import_data'}, 'ajax_reset': {'kadence_starter_reset'}, 'initial_install_ajax_callback': {'kadence_import_initial'}, 'import_customizer_data_ajax_callback': {'kadence_import_customizer_data'}, 'check_plugin_data_ajax_callback': {'kadence_check_plugin_data'}, 'import_demo_single_data_ajax_callback': {'kadence_import_single_data'}, 'template_data_ajax_callback': {'kadence_import_get_template_data'}, 'template_data_reload_ajax_callback': {'kadence_import_reload_template_data'}, 'subscribe_ajax_callback': {'kadence_import_subscribe'}, 'install_plugins_ajax_callback': {'kadence_import_install_plugins'}, 'import_demo_data_ajax_callback': {'kadence_import_demo_data'}, 'after_all_import_data_ajax_callback': {'kadence_after_import_data'}, 'ajax_dismiss_starter_notice': {'kadence_starter_dismiss_notice'}}
*
***/
