...
*Overview: {'import_images': {'ms_import_images'}, 'get_single_setting': {'ms_get_single_setting'}, 'save_single_slideshow_setting': {'ms_update_single_slideshow_setting'}, 'ajax_create_image_slides': {'create_image_slide'}, 'save_all_slideshow_settings': {'ms_update_all_slideshow_settings'}, 'get_global_settings': {'ms_get_global_settings'}, 'ajax_update_slide_image': {'update_slide_image'}, 'get_single_slideshow': {'ms_get_single_slideshow'}, 'duplicate_slideshow': {'ms_duplicate_slideshow'}, 'get_slideshows': {'ms_get_slideshows'}, 'get_image_ids_from_file_name': {'ms_get_image_ids_from_filenames'}, 'delete_slideshow': {'ms_delete_slideshow'}, 'ajax_resize_slide': {'resize_image_slide'}, 'get_preview': {'ms_get_preview'}, 'ajax_notice_handler': {'notice_handler'}, 'save_global_settings': {'ms_update_global_settings'}, 'get_custom_themes': {'ms_get_custom_themes'}, 'export_slideshows': {'ms_export_slideshows'}, 'set_tour_status': {'set_tour_status'}, 'save_user_setting': {'ms_update_user_setting'}, 'get_user_details': {'ms_get_user_details'}, 'get_all_free_themes': {'ms_get_all_free_themes'}, 'save_global_settings_single': {'ms_update_global_settings_single'}, 'ajax_undelete_slide': {'undelete_slide'}, 'get_slideshow_default_settings': {'ms_get_slideshow_default_settings'}, 'import_slideshows': {'ms_import_slideshows'}, 'save_slideshow': {'ms_save_slideshow'}, 'handleOptinDismiss': {'handle_optin_action'}, 'save_slideshow_default_settings': {'ms_save_slideshow_default_settings'}, 'ajax_delete_slide': {'delete_slide'}, 'set_theme': {'ms_set_theme'}, 'search_slideshows': {'ms_search_slideshows'}, 'list_slideshows': {'ms_list_slideshows'}}
*
***/
