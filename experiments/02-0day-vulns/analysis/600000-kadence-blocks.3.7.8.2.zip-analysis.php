...
*Overview: {'prebuilt_data_ajax_callback': {'kadence_import_get_prebuilt_data'}, 'prebuilt_pages_data_ajax_callback': {'kadence_import_get_prebuilt_pages_data'}, 'prebuilt_data_reload_ajax_callback': {'kadence_import_reload_prebuilt_data'}, 'prebuilt_pages_data_reload_ajax_callback': {'kadence_import_reload_prebuilt_pages_data'}, 'process_image_data_ajax_callback': {'kadence_import_process_image_data'}, 'process_pattern_ajax_callback': {'kadence_import_process_pattern'}, 'process_subscribe_ajax_callback': {'kadence_subscribe_process_data'}, 'ajax_default_editor_width': {'kadence_post_default_width'}, 'ajax_blocks_activate_deactivate': {'kadence_blocks_activate_deactivate'}, 'ajax_blocks_save_config': {'kadence_blocks_save_config'}, 'prebuilt_connection_info_ajax_callback': {'kadence_import_get_new_connection_data'}, 'process_data_ajax_callback': {'kadence_import_process_data'}, 'prebuilt_templates_data_ajax_callback': {'kadence_import_get_prebuilt_templates_data'}, 'process_ajax': {'kb_process_ajax_submit', 'kb_process_advanced_form_submit', 'nopriv_kb_process_ajax_submit', 'nopriv_kb_process_advanced_form_submit'}, 'prebuilt_templates_data_reload_ajax_callback': {'kadence_import_reload_prebuilt_templates_data'}}
*
***/
...
/** Function process_ajax() called by wp_ajax hooks: {'kb_process_ajax_submit', 'kb_process_advanced_form_submit', 'nopriv_kb_process_ajax_submit', 'nopriv_kb_process_advanced_form_submit'} **/
