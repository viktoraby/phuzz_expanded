...
*Overview: {'handle_optout_markup': {'privacy_optout_markup', 'nopriv_privacy_optout_markup'}, 'ajax_request': {'grunion-contact-form', 'nopriv_grunion-contact-form'}, 'ajax_delete_payment_button': {'customize-jetpack-simple-payments-button-delete'}, 'ajax_update_widget_token_id': {'wpcom_instagram_widget_update_widget_token_id'}, 'post_attachment_comment': {'nopriv_post_attachment_comment', 'post_attachment_comment'}, 'ajax_new_service': {'sharing_new_service'}, 'wp_ajax_jitm_dismiss': {'jitm_dismiss'}, 'plugin_edit_ajax': {'edit-theme-plugin-file'}, 'wp_ajax_videopress_get_upload_token': {'videopress-get-upload-token'}, 'ajax_local_testing_suite': {'health-check-jetpack-connection-health'}, 'delete_post_by_email_address': {'jetpack_post_by_email_disable'}, 'ajax_save_payment_button': {'customize-jetpack-simple-payments-button-save'}, 'ajax_save_options': {'sharing_save_options'}, 'wp_ajax_videopress_get_upload_jwt': {'videopress-get-upload-jwt'}, 'ajax_get_payment_buttons': {'customize-jetpack-simple-payments-buttons-get'}, 'theme_edit_ajax': {'edit-theme-plugin-file'}, 'ajax_get_connection': {'jetpack_get_external_connection'}, 'ajax_check_api_key': {'customize-contact-info-api-key'}, 'ajax_sidebar_state': {'sidebar_state'}, 'get_attachment_comments': {'get_attachment_comments', 'nopriv_get_attachment_comments'}, '\\handle_file_download': {'jetpack_unauth_file_download'}, 'ajax_delete_connection': {'jetpack_delete_external_connection'}, 'remote_request_handlers': {'nopriv_{$action}'}, 'export_to_gdrive': {'grunion_export_to_gdrive'}, 'ajax_save_services': {'sharing_save_services'}, 'create_post_by_email_address': {'jetpack_post_by_email_enable'}, 'wp_ajax_videopress_get_playback_jwt': {'nopriv_videopress-get-playback-jwt', 'videopress-get-playback-jwt'}, 'ajax_dismiss_handler': {'jetpack-protect-dismiss-multisite-banner'}, 'regenerate_post_by_email_address': {'jetpack_post_by_email_regenerate'}, '\\accept_tos': {'jetpack_accept_tos'}, 'wp_ajax_update_transcoding_status': {'videopress-update-transcoding-status'}, 'ajax_recheck_ssl': {'jetpack-recheck-ssl'}, 'ajax_tracks': {'jetpack_tracks'}, 'handle_optout_request': {'privacy_optout', 'nopriv_privacy_optout'}, 'ajax_delete_service': {'sharing_delete_service'}, 'track_newsletter_category_creation': {'add-tag'}, 'create_new_form': {'create_new_form'}, 'download_feedback_as_csv': {'feedback_export'}, 'validate_password_ajax': {'nopriv_validate_password_ajax', 'validate_password_ajax'}, 'handle_set_consent_request': {'nopriv_gdpr_set_consent', 'gdpr_set_consent'}}
*
***/
