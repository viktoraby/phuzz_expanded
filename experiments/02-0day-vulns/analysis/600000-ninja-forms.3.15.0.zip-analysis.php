...
*Overview: {'maybe_delete_field': {'nf_maybe_delete_field'}, 'delete_all_data': {'nf_delete_all_data'}, 'update': {'nf_update_saved_field', 'nf_preview_update'}, 'get_new_nonce': {'nf_ajax_get_new_nonce', 'nopriv_nf_ajax_get_new_nonce'}, 'resume': {'nopriv_nf_ajax_resume', 'nf_ajax_resume'}, 'wp_ajax_ninja_forms_sendwp_remote_install_handler': {'ninja_forms_sendwp_remote_install'}, 'warmProvider': {'nf_ai_warm_provider'}, 'duplicate': {'nf_duplicate'}, 'save': {'nf_save_form'}, 'remove_maintenance_mode': {'nf_remove_maintenance_mode'}, 'get_new_form_templates': {'nf_get_new_form_templates'}, 'handle': {'nf_onboarding_dismiss', 'nf_onboarding_complete', 'nf_onboarding_next', 'nf_onboarding_start'}, 'submit': {'nf_ajax_submit', 'nopriv_nf_ajax_submit'}, 'hide_columns': {'nf_hide_columns'}, 'maybe_opt_in': {'nf_optin'}, 'delete': {'nf_delete', 'nf_delete_form', 'nf_delete_saved_field'}, 'connect': {'nf_oauth_connect'}, 'ninja_forms_admin_all_forms_capabilities': {'nf_oauth'}, 'disconnect': {'nf_oauth_disconnect'}, 'log_error': {'nf_log_js_error', 'nopriv_nf_log_js_error'}, 'DashboardServices': {'nf_services'}, '<pre>': {'nf_services_install'}, 'ninja_forms_dashboard_nonce': {'nf_update_cache_mode'}, 'get_forms': {'nf_get_forms'}, 'create': {'nf_create_saved_field'}}
*
***/
...
/** Function handle() called by wp_ajax hooks: {'nf_onboarding_dismiss', 'nf_onboarding_complete', 'nf_onboarding_next', 'nf_onboarding_start'} **/
/** No params detected :-/ **/
