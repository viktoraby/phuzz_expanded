...
*Overview: {'ninja_forms_admin_all_forms_capabilities': {'nf_oauth'}, 'get_forms': {'nf_get_forms'}, 'save': {'nf_save_form'}, 'hide_columns': {'nf_hide_columns'}, 'submit': {'nf_ajax_submit', 'nopriv_nf_ajax_submit'}, 'get_new_nonce': {'nf_ajax_get_new_nonce', 'nopriv_nf_ajax_get_new_nonce'}, 'delete_all_data': {'nf_delete_all_data'}, '<pre>': {'nf_services_install'}, 'DashboardServices': {'nf_services'}, 'ninja_forms_dashboard_nonce': {'nf_update_cache_mode'}, 'handle': {'nf_onboarding_start', 'nf_onboarding_dismiss', 'nf_onboarding_next', 'nf_onboarding_complete'}, 'get_new_form_templates': {'nf_get_new_form_templates'}, 'log_error': {'nf_log_js_error', 'nopriv_nf_log_js_error'}, 'disconnect': {'nf_oauth_disconnect'}, 'duplicate': {'nf_duplicate'}, 'wp_ajax_ninja_forms_sendwp_remote_install_handler': {'ninja_forms_sendwp_remote_install'}, 'maybe_delete_field': {'nf_maybe_delete_field'}, 'create': {'nf_create_saved_field'}, 'remove_maintenance_mode': {'nf_remove_maintenance_mode'}, 'connect': {'nf_oauth_connect'}, 'update': {'nf_preview_update', 'nf_update_saved_field'}, 'maybe_opt_in': {'nf_optin'}, 'resume': {'nopriv_nf_ajax_resume', 'nf_ajax_resume'}, 'delete': {'nf_delete', 'nf_delete_form', 'nf_delete_saved_field'}, 'warmProvider': {'nf_ai_warm_provider'}}
*
***/
...
/** Function handle() called by wp_ajax hooks: {'nf_onboarding_start', 'nf_onboarding_dismiss', 'nf_onboarding_next', 'nf_onboarding_complete'} **/
/** No params detected :-/ **/
...
/** Function update() called by wp_ajax hooks: {'nf_preview_update', 'nf_update_saved_field'} **/
/** No params detected :-/ **/
...
/** Function delete() called by wp_ajax hooks: {'nf_delete', 'nf_delete_form', 'nf_delete_saved_field'} **/
/** No params detected :-/ **/


/** Function warmProvider() called by wp_ajax hooks: {'nf_ai_warm_provider'} **/
/** No params detected :-/ **/
