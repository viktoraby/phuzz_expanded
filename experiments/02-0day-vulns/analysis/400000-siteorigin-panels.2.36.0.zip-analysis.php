...
*Overview: {'action_import_layout': {'so_panels_import_layout'}, 'dismiss_admin_post_notice': {'so_panels_dismiss_post_notice'}, 'action_builder_content': {'so_panels_builder_content'}, 'dismiss_notice': {'so_installer_dismiss'}, 'action_builder_content_json': {'so_panels_builder_content_json'}, 'manage_product': {'siteorigin_installer_manage'}, 'action_export_layout': {'so_panels_export_layout'}, 'action_style_form': {'so_panels_style_form'}, 'action_live_editor_preview': {'so_panels_live_editor_preview'}, 'action_directory_enable': {'so_panels_directory_enable'}, 'installer_status_ajax': {'so_installer_status'}, 'action_widget_form': {'so_panels_widget_form'}, 'action_get_prebuilt_layout': {'so_panels_get_layout'}, 'layout_block_preview': {'so_panels_layout_block_preview'}, 'action_get_prebuilt_layouts': {'so_panels_layouts_query'}}
*
***/
