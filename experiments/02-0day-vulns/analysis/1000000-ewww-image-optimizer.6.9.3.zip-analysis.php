...
*Overview: {'ewww_image_optimizer_ajax_delete_original': {'bulk_aux_images_delete_original'}, 'ewww_image_optimizer_bulk_update_meta': {'ewww_bulk_update_meta'}, 'ewww_flag_bulk_filename': {'bulk_flag_filename'}, 'ewww_ngg_bulk_loop': {'bulk_ngg_loop'}, 'ewww_image_optimizer_webp_attachment_count': {'ewwwio_webp_attachment_count'}, 'ewww_image_optimizer_exactdn_deregister_site_ajax': {'ewww_exactdn_deregister_site'}, 'ewww_image_optimizer_webp_cleanup': {'webp_cleanup'}, 'ewww_image_optimizer_dismiss_review_notice': {'ewww_dismiss_review_notice'}, 'ewww_image_optimizer_cloud_key_verify_ajax': {'ewww_cloud_key_verify'}, 'ewww_image_optimizer_aux_meta_clean': {'bulk_aux_images_meta_clean'}, 'ewww_image_optimizer_exactdn_register_site_ajax': {'ewww_exactdn_register_site'}, 'ewww_image_optimizer_bulk_quota_update': {'bulk_quota_update'}, 'restore_single_image_handler': {'ewww_manual_image_restore_single'}, 'ewww_flag_bulk_init': {'bulk_flag_init'}, 'ewww_flag_bulk_cleanup': {'bulk_flag_cleanup'}, 'ewww_image_optimizer_webp_rewrite': {'ewww_webp_rewrite'}, 'ewww_image_optimizer_aux_images_count_converted': {'bulk_aux_images_count_converted'}, 'ewww_image_optimizer_exactdn_activate_ajax': {'ewww_exactdn_activate'}, 'ewww_ngg_bulk_filename': {'bulk_ngg_filename'}, 'ewww_image_optimizer_aux_images_converted_clean': {'bulk_aux_images_converted_clean'}, 'ewww_image_optimizer_bulk_cleanup': {'bulk_cleanup'}, 'ewww_image_optimizer_aux_images_table': {'bulk_aux_images_table'}, 'ewww_image_optimizer_aux_images_clear_all': {'bulk_aux_images_table_clear'}, 'ewww_image_optimizer_dismiss_newsletter_signup': {'ewww_dismiss_newsletter'}, 'ewww_image_optimizer_delete_webp_handler': {'bulk_aux_images_delete_webp'}, 'ewww_image_optimizer_aux_images_remove': {'bulk_aux_images_remove'}, 'ewww_image_optimizer_aux_images_webp_clean_handler': {'bulk_aux_images_webp_clean'}, 'ewww_ngg_bulk_cleanup': {'bulk_ngg_cleanup'}, 'ewww_ngg_bulk_init': {'bulk_ngg_init'}, 'ewww_ngg_cloud_restore': {'ewww_ngg_cloud_restore'}, 'ewww_image_optimizer_media_scan': {'bulk_scan'}, 'ewww_image_optimizer_webp_loop': {'webp_loop'}, 'ewww_flag_bulk_loop': {'bulk_flag_loop'}, 'ewww_image_optimizer_dismiss_exec_notice': {'ewww_dismiss_exec_notice'}, 'ewww_image_optimizer_bulk_initialize': {'bulk_init'}, 'ewww_image_optimizer_aux_images_clean': {'bulk_aux_images_table_clean'}, 'ewww_flag_image_restore': {'ewww_flag_image_restore'}, 'ewww_image_optimizer_aux_images_table_count': {'bulk_aux_images_table_count'}, 'ewww_image_optimizer_bulk_restore_handler': {'bulk_aux_images_restore_original'}, 'ewww_image_optimizer_get_all_attachments': {'ewwwio_get_all_attachments'}, 'ewww_flag_manual': {'ewww_flag_manual'}, 'ewww_image_optimizer_webp_initialize': {'webp_init'}, 'ewww_image_optimizer_dismiss_wc_regen': {'ewww_dismiss_wc_regen'}, 'ewww_image_optimizer_dismiss_media_notice': {'ewww_dismiss_media_notice'}, 'ewww_image_optimizer_webp_unwrite': {'ewww_webp_unwrite'}, 'ewww_image_optimizer_manual': {'ewww_manual_image_restore', 'ewww_manual_optimize', 'ewww_manual_restore'}, 'ewww_ngg_manual': {'ewww_ngg_manual'}, 'ewww_image_optimizer_dismiss_lr_sync': {'ewww_dismiss_lr_sync'}, 'ewww_image_optimizer_exactdn_activate_site_ajax': {'ewww_exactdn_activate_site'}, 'ewww_ngg_bulk_preview': {'bulk_ngg_preview'}, 'ewww_ngg_image_restore': {'ewww_ngg_image_restore'}, 'ewww_image_optimizer_bulk_filename': {'bulk_filename'}, 'ewww_image_optimizer_bulk_loop': {'bulk_loop'}}
*
***/
