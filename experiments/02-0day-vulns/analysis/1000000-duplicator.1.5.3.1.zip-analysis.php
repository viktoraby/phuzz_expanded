...
*Overview: {'duplicator_package_build': {'duplicator_package_build'}, 'duplicator_submit_uninstall_reason_action': {'duplicator_submit_uninstall_reason_action'}, 'admin_notice_to_dismiss': {'duplicator_admin_notice_to_dismiss'}, 'getPackageFile': {'DUP_CTRL_Package_getPackageFile'}, 'getTraceLog': {'DUP_CTRL_Tools_getTraceLog'}, 'addQuickFilters': {'DUP_CTRL_Package_addQuickFilters'}, 'duplicator_duparchive_package_build': {'duplicator_duparchive_package_build'}, 'dismissAjax': {'dup_notice_dismiss'}, 'duplicator_download_installer': {'duplicator_download_installer'}, 'runScanValidator': {'DUP_CTRL_Tools_runScanValidator'}, 'SaveViewState': {'DUP_CTRL_UI_SaveViewState'}, 'dismissNoticeBar': {'duplicator_notice_bar_dismiss'}, 'duplicator_package_scan': {'duplicator_package_scan'}, 'duplicator_active_package_info': {'duplicator_active_package_info'}, 'getActivePackageStatus': {'DUP_CTRL_Package_getActivePackageStatus'}, 'duplicator_package_delete': {'duplicator_package_delete'}, 'ajax_reset_all': {'duplicator_reset_all_settings'}, 'set_admin_notice_viewed': {'duplicator_set_admin_notice_viewed'}}
*
***/
