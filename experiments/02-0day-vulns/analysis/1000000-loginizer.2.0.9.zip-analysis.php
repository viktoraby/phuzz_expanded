...
*Overview: {'loginizer_dismiss_backuply': {'loginizer_dismiss_backuply'}, 'loginizer_dismiss_social_alert': {'loginizer_dismiss_social_alert'}, 'loginizer_dismiss_newsletter': {'loginizer_dismiss_newsletter'}, 'loginizer_social_order': {'loginizer_social_order'}, 'loginizer_dismiss_softwp_alert': {'loginizer_dismiss_softwp_alert'}, 'loginizer_close_update_notice': {'loginizer_close_update_notice'}, 'loginizer_dismiss_csrf': {'loginizer_dismiss_csrf'}, 'loginizer_dismiss_license_alert': {'loginizer_dismiss_license_alert'}, 'loginizer_export': {'loginizer_export'}, 'loginizer_failed_login_export': {'loginizer_failed_login_export'}}
*
***/
