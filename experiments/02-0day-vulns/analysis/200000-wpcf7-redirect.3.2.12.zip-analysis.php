...
*Overview: {'duplicate_action': {'wpcf7r_duplicate_action'}, 'close_banner': {'close_ad_banner'}, 'get_action_template': {'wpcf7r_get_action_template'}, 'disable_notification_ajax': {'themeisle_sdk_dismiss_black_friday_notice'}, 'dismiss_promotion': {'tisdk_update_option'}, 'dismiss': {'themeisle_sdk_dismiss_notice'}, 'dismiss_license_notice': {'themeisle_sdk_dismiss_license_notice'}, 'ThemeisleSDK\\Modules\\Notification::dismiss': {'themeisle_sdk_dismiss_notice'}, 'make_api_test': {'wpcf7r_make_api_test'}, 'set_action_menu_order': {'wpcf7r_set_action_menu_order'}, 'add_action_post': {'wpcf7r_add_action'}, 'delete_action_post': {'wpcf7r_delete_action'}}
*
***/
