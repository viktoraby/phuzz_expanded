...
*Overview: {'react_apply_languages': {'cn_react_apply_languages'}, 'get_dashboard': {'cn_react_dashboard'}, 'api_request': {'cn_api_request'}, 'get_api_environment': {'cn_get_api_environment'}, 'complete_setup_wizard': {'cn_react_complete_setup_wizard'}, 'ajax_dismiss_admin_notice': {'cn_dismiss_notice'}, 'deactivate_plugin': {'cn-deactivate-plugin'}, 'export_consent_logs': {'cn_react_export_consent_logs'}, 'save_options': {'cn_react_save_options'}, 'test_set_option': {'cn_react_test_set_option'}, 'display_table': {'cn_privacy_consent_display_table'}, 'get_group_rule_values': {'cn-get-group-rules-values'}, 'react_apply_template': {'cn_react_apply_template'}, 'dev_reset': {'cn_react_dev_reset'}, 'get_cookie_consent_logs': {'cn_get_cookie_consent_logs'}, 'welcome_screen': {'cn_welcome_screen'}, 'dismiss_welcome': {'cn_react_dismiss_welcome', 'cn_dismiss_welcome'}, 'get_config': {'cn_react_config'}, 'get_consent_logs': {'cn_react_consent_logs'}, 'rescan_scripts': {'cn_react_rescan_scripts'}, 'query_forms': {'cn_privacy_consent_get_forms'}, 'set_form_status': {'cn_privacy_consent_form_status'}, 'update_script': {'cn_react_script_update'}, 'test_get_option': {'cn_react_test_get_option'}, 'react_update_design': {'cn_react_update_design'}, 'ajax_review_notice': {'cn_review_notice'}, 'get_rule_values': {'cn_react_rule_values'}, 'ajax_purge_cache': {'cn_purge_cache'}, 'get_privacy_consent_logs': {'cn_get_privacy_consent_logs'}}
*
***/
...
/** Function dismiss_welcome() called by wp_ajax hooks: {'cn_react_dismiss_welcome', 'cn_dismiss_welcome'} **/
/** No params detected :-/ **/
