...
*Overview: {'ajax_tracks': {'jetpack_tracks'}, 'ajax_save_services': {'sharing_save_services'}, 'create_new_form': {'create_new_form'}, 'wp_ajax_videopress_get_playback_jwt': {'nopriv_videopress-get-playback-jwt', 'videopress-get-playback-jwt'}, 'ajax_check_api_key': {'customize-contact-info-api-key'}, 'export_to_gdrive': {'grunion_export_to_gdrive'}, 'wp_ajax_videopress_get_upload_token': {'videopress-get-upload-token'}, 'handle_optout_markup': {'nopriv_privacy_optout_markup', 'privacy_optout_markup'}, 'ajax_new_service': {'sharing_new_service'}, 'handle_set_consent_request': {'nopriv_gdpr_set_consent', 'gdpr_set_consent'}, 'ajax_get_payment_buttons': {'customize-jetpack-simple-payments-buttons-get'}, 'ajax_request': {'nopriv_grunion-contact-form', 'grunion-contact-form'}, '\\accept_tos': {'jetpack_accept_tos'}, 'theme_edit_ajax': {'edit-theme-plugin-file'}, 'remote_request_handlers': {'nopriv_{$action}'}, 'get_attachment_comments': {'get_attachment_comments', 'nopriv_get_attachment_comments'}, 'plugin_edit_ajax': {'edit-theme-plugin-file'}, 'create_post_by_email_address': {'jetpack_post_by_email_enable'}, 'delete_post_by_email_address': {'jetpack_post_by_email_disable'}, 'ajax_update_widget_token_id': {'wpcom_instagram_widget_update_widget_token_id'}, 'wp_ajax_videopress_get_upload_jwt': {'videopress-get-upload-jwt'}, 'validate_password_ajax': {'validate_password_ajax', 'nopriv_validate_password_ajax'}, 'ajax_dismiss_handler': {'jetpack-protect-dismiss-multisite-banner'}, 'download_feedback_as_csv': {'feedback_export'}, 'ajax_sidebar_state': {'sidebar_state'}, 'ajax_delete_payment_button': {'customize-jetpack-simple-payments-button-delete'}, 'handle_optout_request': {'privacy_optout', 'nopriv_privacy_optout'}, 'ajax_recheck_ssl': {'jetpack-recheck-ssl'}, 'ajax_delete_connection': {'jetpack_delete_external_connection'}, 'wp_ajax_update_transcoding_status': {'videopress-update-transcoding-status'}, 'track_newsletter_category_creation': {'add-tag'}, 'ajax_local_testing_suite': {'health-check-jetpack-connection-health'}, 'ajax_save_options': {'sharing_save_options'}, 'ajax_get_connection': {'jetpack_get_external_connection'}, 'ajax_save_payment_button': {'customize-jetpack-simple-payments-button-save'}, 'post_attachment_comment': {'nopriv_post_attachment_comment', 'post_attachment_comment'}, '\\handle_file_download': {'jetpack_unauth_file_download'}, 'ajax_delete_service': {'sharing_delete_service'}, 'wp_ajax_jitm_dismiss': {'jitm_dismiss'}, 'regenerate_post_by_email_address': {'jetpack_post_by_email_regenerate'}}
*
***/
...
/** Function handle_set_consent_request() called by wp_ajax hooks: {'nopriv_gdpr_set_consent', 'gdpr_set_consent'} **/
...
/** Function ajax_request() called by wp_ajax hooks: {'nopriv_grunion-contact-form', 'grunion-contact-form'} **/
