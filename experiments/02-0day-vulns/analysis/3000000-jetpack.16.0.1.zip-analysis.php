...
*Overview: {'remote_request_handlers': {'nopriv_{$action}'}, 'ajax_local_testing_suite': {'health-check-jetpack-connection-health'}, 'delete_post_by_email_address': {'jetpack_post_by_email_disable'}, 'create_new_form': {'create_new_form'}, 'validate_password_ajax': {'validate_password_ajax', 'nopriv_validate_password_ajax'}, 'wp_ajax_videopress_get_upload_jwt': {'videopress-get-upload-jwt'}, 'ajax_tracks': {'jetpack_tracks'}, 'wp_ajax_jitm_dismiss': {'jitm_dismiss'}, 'ajax_new_service': {'sharing_new_service'}, 'track_newsletter_category_creation': {'add-tag'}, 'ajax_delete_payment_button': {'customize-jetpack-simple-payments-button-delete'}, 'wp_ajax_videopress_get_upload_token': {'videopress-get-upload-token'}, 'wp_ajax_videopress_get_playback_jwt': {'nopriv_videopress-get-playback-jwt', 'videopress-get-playback-jwt'}, 'theme_edit_ajax': {'edit-theme-plugin-file'}, 'ajax_request': {'nopriv_grunion-contact-form', 'grunion-contact-form'}, 'post_attachment_comment': {'nopriv_post_attachment_comment', 'post_attachment_comment'}, 'plugin_edit_ajax': {'edit-theme-plugin-file'}, 'regenerate_post_by_email_address': {'jetpack_post_by_email_regenerate'}, 'ajax_save_payment_button': {'customize-jetpack-simple-payments-button-save'}, 'create_post_by_email_address': {'jetpack_post_by_email_enable'}, '\\accept_tos': {'jetpack_accept_tos'}, 'ajax_delete_service': {'sharing_delete_service'}, 'handle_optout_request': {'nopriv_privacy_optout', 'privacy_optout'}, 'ajax_sidebar_state': {'sidebar_state'}, 'ajax_recheck_ssl': {'jetpack-recheck-ssl'}, 'ajax_dismiss_handler': {'jetpack-protect-dismiss-multisite-banner'}, 'export_to_gdrive': {'grunion_export_to_gdrive'}, 'get_attachment_comments': {'nopriv_get_attachment_comments', 'get_attachment_comments'}, 'ajax_save_options': {'sharing_save_options'}, 'ajax_delete_connection': {'jetpack_delete_external_connection'}, 'ajax_save_services': {'sharing_save_services'}, 'handle_set_consent_request': {'gdpr_set_consent', 'nopriv_gdpr_set_consent'}, 'ajax_update_widget_token_id': {'wpcom_instagram_widget_update_widget_token_id'}, '\\handle_file_download': {'jetpack_unauth_file_download'}, 'ajax_get_payment_buttons': {'customize-jetpack-simple-payments-buttons-get'}, 'ajax_get_connection': {'jetpack_get_external_connection'}, 'wp_ajax_update_transcoding_status': {'videopress-update-transcoding-status'}, 'download_feedback_as_csv': {'feedback_export'}, 'ajax_check_api_key': {'customize-contact-info-api-key'}, 'handle_optout_markup': {'nopriv_privacy_optout_markup', 'privacy_optout_markup'}}
*
***/
