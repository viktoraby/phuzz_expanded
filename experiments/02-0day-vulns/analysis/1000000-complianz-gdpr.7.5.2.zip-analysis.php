...
*Overview: {'amp_endpoint': {'nopriv_cmplz_amp_endpoint', 'cmplz_amp_endpoint'}, 'process_ajax_install_plugin': {'rsp_upgrade_install_plugin'}, 'process_ajax_destination_clear': {'rsp_upgrade_destination_clear'}, 'dismiss_warning': {'cmplz_dismiss_admin_notice'}, 'process_ajax_activate_plugin': {'rsp_upgrade_activate_plugin'}, 'dismiss_review_notice_callback': {'cmplz_dismiss_review_notice'}, 'process_ajax_activate_license': {'rsp_upgrade_activate_license'}, 'process_ajax_package_information': {'rsp_upgrade_package_information'}, 'store_console_errors': {'cmplz_store_console_errors'}, 'cmplz_rest_api_fallback': {'cmplz_rest_api_fallback'}}
*
***/
