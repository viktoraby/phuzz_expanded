...
*Overview: {'ajax_get_forum_posts': {'trp_get_forum_posts'}, 'get_translations': {'trp_get_translations_regular'}, 'split_translation_block': {'trp_split_translation_block'}, 'save_editor_user_meta': {'trp_save_editor_user_meta'}, 'ajax_get_terms': {'trp_glossary_get_terms'}, 'ajax_save_language_switcher': {'trp_language_switcher_save'}, 'ajax_mark_forum_posts_read': {'trp_mark_forum_posts_read'}, 'trp_update_database': {'trp_update_database'}, 'trp_dismiss_gettext_notice': {'trp_dismiss_gettext_notice'}, 'gettext_save_translations': {'trp_save_translations_gettext'}, 'replace_in_dictionary': {'trp_glossary_replace_in_dictionary'}, 'delete_term': {'trp_glossary_delete_term'}, 'trp_ai_recheck_quota': {'trp_ai_recheck_quota'}, 'save_translations': {'trp_save_translations_regular'}, 'Content-Type: text/javascript': {'trp-block-ls-shortcode.js'}, 'scan_gettext': {'trp_scan_gettext'}, 'create_translation_block': {'trp_create_translation_block'}, 'install_plugins_request': {'trp_install_plugins'}, 'test_api_key': {'test_api_key'}, 'ajax_get_similar_string_translation': {'trp_get_similar_string_translation'}, 'gettext_get_translations': {'trp_get_translations_gettext'}, 'ajax_disable_legacy_language_switcher': {'trp_disable_legacy_language_switcher'}, 'process_js_strings_in_translation_editor': {'trp_process_js_strings_in_translation_editor'}, 'add_term': {'trp_glossary_add_term'}, 'get_translations_domchanges': {'nopriv_trp_get_translations_domchanges', 'trp_get_translations_domchanges'}, 'gettext': {'trp_string_translation_get_missing_gettext_strings', 'trp_string_translation_get_strings_by_original_ids_gettext'}, 'search_dictionary': {'trp_glossary_search_dictionary'}, 'edit_term': {'trp_glossary_edit_term'}}
*
***/
...
/** Function get_translations_domchanges() called by wp_ajax hooks: {'nopriv_trp_get_translations_domchanges', 'trp_get_translations_domchanges'} **/
