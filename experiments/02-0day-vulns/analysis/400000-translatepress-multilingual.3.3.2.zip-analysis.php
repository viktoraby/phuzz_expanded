...
*Overview: {'add_term': {'trp_glossary_add_term'}, 'ajax_mark_forum_posts_read': {'trp_mark_forum_posts_read'}, 'gettext_get_translations': {'trp_get_translations_gettext'}, 'install_plugins_request': {'trp_install_plugins'}, 'get_translations_domchanges': {'trp_get_translations_domchanges', 'nopriv_trp_get_translations_domchanges'}, 'trp_ai_recheck_quota': {'trp_ai_recheck_quota'}, 'ajax_get_similar_string_translation': {'trp_get_similar_string_translation'}, 'process_js_strings_in_translation_editor': {'trp_process_js_strings_in_translation_editor'}, 'save_translations': {'trp_save_translations_regular'}, 'test_api_key': {'test_api_key'}, 'gettext': {'trp_string_translation_get_strings_by_original_ids_gettext', 'trp_string_translation_get_missing_gettext_strings'}, 'ajax_disable_legacy_language_switcher': {'trp_disable_legacy_language_switcher'}, 'ajax_get_forum_posts': {'trp_get_forum_posts'}, 'trp_dismiss_gettext_notice': {'trp_dismiss_gettext_notice'}, 'gettext_save_translations': {'trp_save_translations_gettext'}, 'scan_gettext': {'trp_scan_gettext'}, 'delete_term': {'trp_glossary_delete_term'}, 'split_translation_block': {'trp_split_translation_block'}, 'edit_term': {'trp_glossary_edit_term'}, 'create_translation_block': {'trp_create_translation_block'}, 'search_dictionary': {'trp_glossary_search_dictionary'}, 'trp_update_database': {'trp_update_database'}, 'ajax_get_terms': {'trp_glossary_get_terms'}, 'save_editor_user_meta': {'trp_save_editor_user_meta'}, 'replace_in_dictionary': {'trp_glossary_replace_in_dictionary'}, 'ajax_save_language_switcher': {'trp_language_switcher_save'}, 'get_translations': {'trp_get_translations_regular'}, 'Content-Type: text/javascript': {'trp-block-ls-shortcode.js'}}
*
***/
...
/** Function get_translations_domchanges() called by wp_ajax hooks: {'trp_get_translations_domchanges', 'nopriv_trp_get_translations_domchanges'} **/
/** Parameters found in function get_translations_domchanges(): {"post": ["language", "originals", "skip_machine_translation"]} **/
function get_translations_domchanges() {
		if ( ! ( defined( 'DOING_AJAX' ) && DOING_AJAX ) ) {
			wp_die();
		}
...
/** Function gettext() called by wp_ajax hooks: {'trp_string_translation_get_strings_by_original_ids_gettext', 'trp_string_translation_get_missing_gettext_strings'} **/
/** No function found :-/ **/
...
/** Function get_translations() called by wp_ajax hooks: {'trp_get_translations_regular'} **/
