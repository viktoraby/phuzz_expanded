...
*Overview: {'scpo_ajax_reset_order': {'scpo_reset_order'}, 'scpo_ajax_set_position': {'scpo_set_position'}, 'ajax': {'epsilon_simple_review'}, 'update_menu_order': {'update-menu-order'}, 'update_menu_order_tags': {'update-menu-order-tags'}, 'dismiss_notices': {'scporder_dismiss_notices'}, 'refresh_nonce': {'scpo_refresh_nonce'}}
*
***/
