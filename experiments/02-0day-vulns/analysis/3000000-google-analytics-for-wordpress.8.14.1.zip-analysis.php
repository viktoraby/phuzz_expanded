...
*Overview: {'get_settings': {'monsterinsights_vue_get_settings'}, 'monsterinsights_mark_floatbar_hidden': {'monsterinsights_hide_floatbar'}, 'update_dual_tracking_id': {'monsterinsights_update_dual_tracking_id'}, 'monsterinsights_ajax_activate_addon': {'monsterinsights_activate_addon'}, 'process': {'nopriv_monsterinsights_connect_process'}, 'review_dismiss': {'monsterinsights_review_dismiss'}, 'monsterinsights_ajax_install_addon': {'monsterinsights_install_addon'}, 'get_posts': {'monsterinsights_get_posts'}, 'ajax_start_indexing': {'monsterinsights_sharedcount_start_indexing'}, 'update_settings_bulk': {'monsterinsights_vue_update_settings_bulk'}, 'maybe_add_notifications': {'monsterinsights_vue_get_notifications'}, 'get_notice_status': {'monsterinsights_vue_notice_status'}, 'dismiss_first_time_notice': {'monsterinsights_vue_dismiss_first_time_notice'}, 'generate_connect_url': {'monsterinsights_connect_url'}, 'monsterinsights_ajax_deactivate_addon': {'monsterinsights_deactivate_addon'}, 'maybe_reauthenticate': {'monsterinsights_maybe_reauthenticate'}, 'monsterinsights_handle_get_plugin_info': {'nopriv_monsterinsights_get_plugin_info'}, 'update_measurement_protocol_secret': {'monsterinsights_update_measurement_protocol_secret'}, 'check_popular_posts_report': {'monsterinsights_vue_grab_popular_posts_report'}, 'test_check_tracking_code': {'health-check-monsterinsights-test_tracking_code'}, 'dismiss_notice': {'monsterinsights_vue_notice_dismiss'}, 'handle_settings_import': {'monsterinsights_handle_settings_import'}, 'get_ajax_output': {'nopriv_monsterinsights_popular_posts_get_widget_output', 'monsterinsights_popular_posts_get_widget_output'}, 'get_addons': {'monsterinsights_vue_get_addons'}, 'monsterinsights_ajax_dismiss_notice': {'monsterinsights_ajax_dismiss_notice'}, 'maybe_verify': {'monsterinsights_maybe_verify'}, 'get_result': {'monsterinsights_gutenberg_headline_analyzer_get_results'}, 'ajax_get_notifications': {'monsterinsights_vue_get_notifications'}, 'maybe_authenticate': {'monsterinsights_maybe_authenticate'}, 'update_popular_posts_theme_setting': {'monsterinsights_vue_popular_posts_update_theme_setting'}, 'get_profile': {'monsterinsights_vue_get_profile'}, 'rauthenticate': {'nopriv_monsterinsights_rauthenticate'}, 'update_manual_ua': {'monsterinsights_update_manual_ua'}, 'save_widget_state': {'monsterinsights_save_widget_state'}, 'handle_relay_mp_token_push': {'nopriv_monsterinsights_push_mp_token'}, 'install_and_activate_wpforms': {'monsterinsights_onboarding_wpforms_install'}, 'get_taxonomy_terms': {'monsterinsights_get_terms'}, 'get_report_data': {'monsterinsights_vue_get_report_data'}, 'get_license': {'monsterinsights_vue_get_license'}, 'monsterinsights_ajax_dismiss_semrush_cta': {'monsterinsights_vue_dismiss_semrush_cta'}, 'get_post_types': {'monsterinsights_get_post_types'}, 'is_installed': {'nopriv_monsterinsights_is_installed'}, 'install_plugin': {'monsterinsights_vue_install_plugin'}, 'ajax_get_themes': {'monsterinsights_get_popular_posts_themes'}, 'get_install_errors': {'monsterinsights_onboarding_get_errors'}, 'monsterinsights_dismiss_tracking_notice': {'monsterinsights_dismiss_tracking_notice'}, 'monsterinsights_mark_admin_menu_tooltip_hidden': {'monsterinsights_hide_admin_menu_tooltip'}, 'dismiss': {'monsterinsights_notification_dismiss'}, 'update_settings': {'monsterinsights_vue_update_settings'}, 'mark_notice_closed': {'monsterinsights_mark_notice_closed'}, 'ajax_get_index_progress': {'monsterinsights_sharedcount_get_index_progress'}, 'monsterinsights_handle_ga_queue_response': {'nopriv_monsterinsights_handle_ga_queue_response'}, 'update_manual_v4': {'monsterinsights_update_manual_v4'}, 'test_check_connection': {'health-check-monsterinsights-test_connection'}, 'monsterinsights_get_sem_rush_cta_status': {'monsterinsights_get_sem_rush_cta_status'}, 'monsterinsights_get_floatbar': {'monsterinsights_get_floatbar'}, 'maybe_delete': {'monsterinsights_maybe_delete'}, 'empty_cache': {'monsterinsights_popular_posts_empty_cache'}}
*
***/
