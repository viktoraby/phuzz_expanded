...
*Overview: {'process': {'nopriv_aioseo_connect_process'}, 'dismissNotice': {'aioseo-dismiss-conflicting-plugins-notice', 'aioseo-dismiss-deprecated-wordpress-notice', 'aioseo-dismiss-review-plugin-cta'}, 'isInstalled': {'nopriv_aioseo_is_installed'}, 'deactivateConflictingPlugins': {'aioseo-deactivate-conflicting-plugins-notice'}, 'reauthenticate': {'nopriv_aioseo_rauthenticate'}, 'dismissActiveMenuTooltips': {'aioseo-dismiss-active-menu-tooltip'}}
*
***/
...
/** Function dismissNotice() called by wp_ajax hooks: {'aioseo-dismiss-conflicting-plugins-notice', 'aioseo-dismiss-deprecated-wordpress-notice', 'aioseo-dismiss-review-plugin-cta'} **/
