...
*Overview: {'term_lang_choice': {'term_lang_choice'}, 'deactivate_license': {'pll_deactivate_license'}, 'ajax_update_post_rows': {'pll_update_post_rows'}, 'post_lang_choice': {'post_lang_choice'}, 'ajax_terms_not_translated': {'pll_terms_not_translated'}, 'ajax_posts_not_translated': {'pll_posts_not_translated'}, 'ajax_update_term_rows': {'pll_update_term_rows'}, 'inline_edit_post': {'inline-save'}, 'save_options': {'pll_save_options'}}
*
***/
