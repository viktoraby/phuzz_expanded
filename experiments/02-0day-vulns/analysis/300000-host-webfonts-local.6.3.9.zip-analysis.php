...
*Overview: {'download_log': {'omgf_download_log'}, 'remove_stylesheet_from_db': {'omgf_remove_stylesheet_from_db'}, 'empty_directory': {'omgf_empty_dir'}, 'refresh_cache': {'omgf_refresh_cache'}, 'delete_log': {'omgf_delete_log'}, 'hide_notice': {'omgf_hide_notice'}}
*
***/
