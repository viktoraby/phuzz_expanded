...
*Overview: {'sbi_activate_addon': {'sbi_activate_addon'}, 'InstagramFeed\\Builder\\SBI_Feed_Builder': {'sbi_other_plugins_modal', 'sbi_dismiss_onboarding'}, 'sbi_get_next_post_set': {'nopriv_sbi_load_more_clicked', 'sbi_load_more_clicked'}, 'sbi_do_locator': {'sbi_do_locator', 'nopriv_sbi_do_locator'}, 'sbi_deactivate_addon': {'sbi_deactivate_addon'}, 'dismiss_upgrade_notice': {'sbi_dismiss_upgrade_notice'}, 'handle_unused_feed_usage': {'sbi_reset_unused_feed_usage'}, 'sbi_check_license': {'sbi_check_license'}, 'sbi_install_addon': {'sbi_install_addon'}, 'sbi_recheck_connection': {'sbi_recheck_connection'}, 'review_notice_consent': {'sbi_review_notice_consent_update'}, 'sbi_process_submitted_resize_ids': {'nopriv_sbi_resized_images_submit', 'sbi_resized_images_submit'}, 'sbi_clear_image_resize_cache': {'sbi_clear_image_resize_cache'}, 'sbi_test_connection': {'sbi_test_connection'}, 'sbi_import_settings_json': {'sbi_import_settings_json'}, 'InstagramFeed\\Builder\\SBI_Source': {'sbi_source_builder_update_multiple', 'sbi_source_builder_update', 'sbi_source_get_page'}, 'sbi_clear_error_log': {'sbi_clear_error_log'}, 'disable_facebook_oembed_from_instagram': {'disable_facebook_oembed_from_instagram'}, 'sbi_retry_db': {'sbi_retry_db'}, 'InstagramFeed\\Builder\\SBI_Feed_Saver_Manager': {'sbi_feed_saver_manager_get_feed_settings', 'sbi_feed_saver_manager_recache_feed', 'sbi_feed_saver_manager_delete_source', 'sbi_feed_saver_manager_clear_comments_cache', 'sbi_feed_saver_manager_get_locations_page', 'sbi_feed_saver_manager_fly_preview', 'sbi_feed_saver_manager_get_feed_list_page', 'sbi_feed_saver_manager_builder_update', 'sbi_update_personal_account', 'sbi_feed_saver_manager_delete_feeds', 'sbi_feed_saver_manager_clear_single_feed_cache', 'sbi_feed_saver_manager_duplicate_feed', 'sbi_feed_saver_manager_retrieve_comments', 'sbi_feed_saver_manager_importer'}, 'dismiss': {'sbi_dashboard_notification_dismiss'}, 'sbi_deactivate_license': {'sbi_deactivate_license'}, 'sbi_activate_license': {'sbi_activate_license'}, 'sbi_dpa_reset': {'sbi_dpa_reset'}, 'InstagramFeed\\Admin\\SBI_Upgrader': {'nopriv_sbi_run_one_click_upgrade', 'sbi_maybe_upgrade_redirect'}, 'sbi_save_settings': {'sbi_save_settings'}, 'sbi_reset_log': {'sbi_reset_log'}, 'disable_instagram_oembed_from_instagram': {'disable_instagram_oembed_from_instagram'}, 'sbi_export_settings_json': {'sbi_export_settings_json'}, 'sbi_dismiss_critical_notice': {'sbi_dismiss_critical_notice'}, 'sbi_clear_cache': {'sbi_clear_cache'}}
*
***/
...
/** Function sbi_get_next_post_set() called by wp_ajax hooks: {'nopriv_sbi_load_more_clicked', 'sbi_load_more_clicked'} **/
...
/** Function InstagramFeed\Builder\SBI_Feed_Saver_Manager() called by wp_ajax hooks: {'sbi_feed_saver_manager_get_feed_settings', 'sbi_feed_saver_manager_recache_feed', 'sbi_feed_saver_manager_delete_source', 'sbi_feed_saver_manager_clear_comments_cache', 'sbi_feed_saver_manager_get_locations_page', 'sbi_feed_saver_manager_fly_preview', 'sbi_feed_saver_manager_get_feed_list_page', 'sbi_feed_saver_manager_builder_update', 'sbi_update_personal_account', 'sbi_feed_saver_manager_delete_feeds', 'sbi_feed_saver_manager_clear_single_feed_cache', 'sbi_feed_saver_manager_duplicate_feed', 'sbi_feed_saver_manager_retrieve_comments', 'sbi_feed_saver_manager_importer'} **/
/** No function found :-/ **/
