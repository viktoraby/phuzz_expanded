...
*Overview: {'cff_ppca_token_check_flag': {'cff_ppca_token_check_flag'}, 'preview': {'sb_facebookfeed_divi_preview'}, 'process_wizard_data': {'cff_feed_saver_manager_process_wizard'}, 'cff_activate_license': {'cff_activate_license'}, 'dismiss_wizard': {'cff_feed_saver_manager_dismiss_wizard'}, 'cff_review_notice_dismiss': {'cff_review_notice_dismiss'}, 'cff_export_settings_json': {'cff_export_settings_json'}, 'cff_feed_locator': {'feed_locator', 'nopriv_feed_locator'}, 'dismiss': {'cff_dashboard_notification_dismiss'}, 'handle_ajax': {'sb_feature_suggestion', 'sb_deactivation_feedback'}, 'cff_deactivate_extension_license': {'cff_deactivate_extension_license'}, 'cff_lite_dismiss': {'cff_lite_dismiss'}, 'ajax_record_session': {'cff_smash_usage_record_session'}, 'CustomFacebookFeed\\Builder\\CFF_Feed_Builder': {'sb_other_plugins_modal', 'cff_dismiss_onboarding'}, 'cff_clear_image_resize_cache': {'cff_clear_image_resize_cache'}, 'delete_temp_user_ajax_call': {'cff_delete_temp_user'}, 'CustomFacebookFeed\\Builder\\CFF_Feed_Saver_Manager': {'cff_feed_saver_manager_importer', 'cff_feed_saver_manager_delete_feeds', 'cff_feed_saver_manager_delete_source', 'cff_feed_saver_manager_fly_preview', 'cff_feed_saver_manager_get_feed_settings', 'cff_feed_saver_manager_get_locations_page', 'cff_feed_saver_manager_clear_single_feed_cache', 'cff_feed_saver_manager_duplicate_feed', 'cff_feed_saver_manager_get_feed_list_page', 'cff_feed_saver_manager_builder_update', 'cff_feed_saver_manager_retrieve_comments'}, 'cff_activate_extension_license': {'cff_activate_extension_license'}, 'cff_import_settings_json': {'cff_import_settings_json'}, 'cff_dismiss_custom_cssjs_notice': {'cff_dismiss_custom_cssjs_notice'}, 'cff_install_addon': {'cff_install_addon'}, 'dismiss_critical_notice': {'cff_dismiss_critical_notice'}, 'disable_facebook_oembed': {'disable_facebook_oembed'}, 'dismiss_upgrade_notice': {'cff_dismiss_upgrade_notice'}, 'cff_oembed_disable': {'cff_oembed_disable'}, 'disable_instagram_oembed': {'disable_instagram_oembed'}, 'cff_dpa_reset': {'cff_dpa_reset'}, 'oembed_connect_init': {'cff_oembed_connect_init'}, 'cff_activate_addon': {'cff_activate_addon'}, 'ajax_record_event': {'cff_smash_usage_record_event'}, 'install_plugin': {'am_recommended_block_install'}, 'cff_deactivate_license': {'cff_deactivate_license'}, 'create_temp_user_ajax_call': {'cff_create_temp_user'}, 'cff_test_connection': {'cff_test_connection'}, 'CustomFacebookFeed\\Builder\\CFF_Source': {'cff_source_get_playlist_post_preview', 'cff_source_builder_update', 'cff_source_builder_update_multiple', 'cff_source_get_page', 'cff_source_get_featured_post_preview'}, 'cff_deactivate_addon': {'cff_deactivate_addon'}, 'handle_unused_feed_usage': {'cff_reset_unused_feed_usage'}, 'cff_clear_cache': {'cff_clear_cache'}, 'review_notice_consent': {'cff_review_notice_consent_update'}, 'cff_save_settings': {'cff_save_settings'}, 'CustomFacebookFeed\\Admin\\CFF_Upgrader': {'cff_maybe_upgrade_redirect', 'nopriv_cff_run_one_click_upgrade'}}
*
***/
...
/** Function CustomFacebookFeed\Builder\CFF_Feed_Saver_Manager() called by wp_ajax hooks: {'cff_feed_saver_manager_importer', 'cff_feed_saver_manager_delete_feeds', 'cff_feed_saver_manager_delete_source', 'cff_feed_saver_manager_fly_preview', 'cff_feed_saver_manager_get_feed_settings', 'cff_feed_saver_manager_get_locations_page', 'cff_feed_saver_manager_clear_single_feed_cache', 'cff_feed_saver_manager_duplicate_feed', 'cff_feed_saver_manager_get_feed_list_page', 'cff_feed_saver_manager_builder_update', 'cff_feed_saver_manager_retrieve_comments'} **/
/** No function found :-/ **/
...
/** Function CustomFacebookFeed\Builder\CFF_Source() called by wp_ajax hooks: {'cff_source_get_playlist_post_preview', 'cff_source_builder_update', 'cff_source_builder_update_multiple', 'cff_source_get_page', 'cff_source_get_featured_post_preview'} **/
/** No function found :-/ **/
