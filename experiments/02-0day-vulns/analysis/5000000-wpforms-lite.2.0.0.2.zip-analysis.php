...
*Overview: {'save_chart_preference_settings': {'wpforms_payments_overview_save_chart_preference_settings'}, 'ajax_submit': {'nopriv_wpforms_submit', 'wpforms_submit'}, 'wpforms_save_form': {'wpforms_save_form'}, 'captcha_field_callback': {'wpforms_update_field_captcha'}, 'notification_from_email_validate': {'wpforms_builder_notification_from_email_validate'}, 'rate_response': {'wpforms_rate_ai_response'}, 'wpforms_install_addon': {'wpforms_install_addon'}, 'ajax_payment_refund': {'wpforms_paypal_commerce_payments_refund', 'wpforms_square_payments_refund'}, 'save_internal_information_checkbox': {'wpforms_builder_save_internal_information_checkbox'}, 'ajax_start_migration': {'wpforms_constant_contact_migration_prompt'}, 'wpforms_builder_increase_next_field_id': {'wpforms_builder_increase_next_field_id'}, 'wpforms_new_form': {'wpforms_new_form'}, 'ajax_lite_connect_finalize': {'wpforms_lite_connect_finalize'}, 'wpforms_deactivate_addon': {'wpforms_deactivate_addon'}, 'ajax_remove_user_template': {'wpforms_user_template_remove'}, 'install': {'wpforms_icon_choices_install'}, 'refresh_connection_manual': {'wpforms_square_refresh_connection'}, 'save_challenge_option_ajax': {'wpforms_challenge_save_option'}, 'get_embed_page_url_ajax': {'wpforms_admin_form_embed_wizard_embed_page_url'}, 'preview': {'wpforms_divi_preview'}, 'get_form': {'wpforms_get_ai_form'}, 'connect': {'wpforms_square_create_webhook'}, 'dismiss': {'wpforms_dismiss_ai_form', 'wpforms_woocommerce_dismiss', 'wpforms_notification_dismiss'}, 'import_form': {'wpforms_import_form_{$this->slug}'}, 'handle_snapshot_ajax': {'wpforms_analytics_snapshot', 'nopriv_wpforms_analytics_snapshot'}, 'wpforms_ajax_search_pages_for_dropdown': {'wpforms_ajax_search_pages_for_dropdown'}, 'ajax_get_templates_batch': {'wpforms_get_templates_batch'}, 'create_subscription_order_ajax': {'nopriv_wpforms_paypal_commerce_create_subscription', 'wpforms_paypal_commerce_create_subscription'}, 'ajax_handle_auth': {'wpforms_constant_contact_popup_auth'}, 'send_contact_form_ajax': {'wpforms_challenge_send_contact_form'}, 'ajax_connect': {'wpforms_settings_provider_add_{$this->core->slug}'}, 'save_order': {'wpforms_admin_forms_overview_save_columns_order'}, 'ajax_check_plugin_status': {'wpforms_page_check_{$plugin}_status'}, 'get_chart_dataset_data': {'wpforms_payments_overview_refresh_chart_dataset_data'}, 'ajax_get_token': {'nopriv_wpforms_get_token', 'wpforms_get_token'}, 'ajax_payments_cancel': {'wpforms_paypal_commerce_payments_cancel', 'wpforms_square_payments_cancel'}, 'integrations_tab_add': {'wpforms_settings_provider_add_$this->slug'}, 'process': {'nopriv_wpforms_connect_process', 'wpforms_ai_form_editor_process'}, 'settings_cta_dismiss': {'wpforms_lite_settings_upgrade'}, 'wpforms_update_form_template': {'wpforms_update_form_template'}, 'get_choices': {'wpforms_get_ai_choices'}, 'ajax_single_payment_cancel': {'wpforms_stripe_payments_cancel'}, 'ajax_save_favorites': {'wpforms_templates_favorite'}, 'reset': {'wpforms_ai_form_editor_reset'}, 'ajax_update_lite_connect_enabled_setting': {'wpforms_update_lite_connect_enabled_setting'}, 'mark_panel_viewed': {'wpforms_mark_panel_viewed'}, 'ajax_get_form_selector_options': {'wpforms_admin_get_form_selector_options'}, 'dismiss_notice': {'wpforms_paypal_commerce_dismiss_domain_notice'}, 'dismiss_callback': {'wpforms_education_pointers_dismiss'}, 'get_record': {'wpforms_get_log_record'}, 'wpforms_builder_dynamic_source': {'wpforms_builder_dynamic_source'}, 'dismiss_ajax': {'wpforms_notice_dismiss'}, 'ajax_dismiss': {'wpforms_education_dismiss'}, 'delete_tags': {'wpforms_admin_forms_overview_delete_tags'}, 'process_ajax': {'wpforms_builder_provider_ajax_{$this->core->slug}', 'wpforms_provider_ajax_$this->slug'}, 'ajax_check_restricted_email': {'nopriv_wpforms_restricted_email', 'wpforms_restricted_email'}, 'field_new': {'wpforms_new_field_{$this->type}'}, 'get_field_preview': {'wpforms_get_ai_form_field_preview'}, 'wpforms_verify_ssl': {'wpforms_verify_ssl'}, 'wpforms_recreate_tables': {'wpforms_recreate_tables'}, 'subscription_processor_create_ajax': {'nopriv_wpforms_paypal_commerce_subscription_processor_create', 'wpforms_paypal_commerce_subscription_processor_create'}, 'generate_url': {'wpforms_connect_url'}, 'save_tags': {'wpforms_admin_forms_overview_save_tags'}, 'single_checkout_create_order_ajax': {'nopriv_wpforms_paypal_commerce_create_order', 'wpforms_paypal_commerce_create_order'}, 'ajax_single_payment_refund': {'wpforms_stripe_payments_refund'}, 'engagement_callback': {'wpforms_education_pointers_engagement'}, 'ajax_toggle_write': {'wpforms_ai_mcp_toggle_write'}, 'ajax_sanitize_restricted_rules': {'wpforms_sanitize_restricted_rules'}, 'ajax_sanitize_default_email': {'wpforms_sanitize_default_email'}, 'integrations_tab_disconnect': {'wpforms_settings_provider_disconnect_$this->slug'}, 'wpforms_activate_addon': {'wpforms_activate_addon'}, 'ajax_disconnect': {'wpforms_settings_provider_disconnect_{$this->core->slug}'}, 'get_search_result_pages_ajax': {'wpforms_admin_form_embed_wizard_search_pages_choicesjs'}, 'fetch_revisions_list': {'wpforms_get_form_revisions'}, 'load_panel_content': {'wpforms_builder_load_panel'}, 'use_form': {'wpforms_use_ai_form'}, 'save_widget_meta_ajax': {'wpforms_{$widget_slug}_save_widget_meta'}, 'wpforms_builder_dynamic_choices': {'wpforms_builder_dynamic_choices'}}
*
***/
...
/** Function ajax_submit() called by wp_ajax hooks: {'nopriv_wpforms_submit', 'wpforms_submit'} **/
...
/** Function dismiss() called by wp_ajax hooks: {'wpforms_dismiss_ai_form', 'wpforms_woocommerce_dismiss', 'wpforms_notification_dismiss'} **/
...
/** Function ajax_check_restricted_email() called by wp_ajax hooks: {'nopriv_wpforms_restricted_email', 'wpforms_restricted_email'} **/
/** No params detected :-/ **/
...
/** Function single_checkout_create_order_ajax() called by wp_ajax hooks: {'nopriv_wpforms_paypal_commerce_create_order', 'wpforms_paypal_commerce_create_order'} **/
