...
*Found actions: 91
*Found functions:78
*Extracted functions:78
*Total parameter names extracted: 42
*Overview: {'connect': {'wpforms_square_create_webhook'}, 'get_search_result_pages_ajax': {'wpforms_admin_form_embed_wizard_search_pages_choicesjs'}, 'wpforms_builder_increase_next_field_id': {'wpforms_builder_increase_next_field_id'}, 'save_tags': {'wpforms_admin_forms_overview_save_tags'}, 'get_record': {'wpforms_get_log_record'}, 'dismiss_notice': {'wpforms_paypal_commerce_dismiss_domain_notice'}, 'ajax_save_favorites': {'wpforms_templates_favorite'}, 'rate_response': {'wpforms_rate_ai_response'}, 'subscription_processor_create_ajax': {'wpforms_paypal_commerce_subscription_processor_create', 'nopriv_wpforms_paypal_commerce_subscription_processor_create'}, 'ajax_single_payment_cancel': {'wpforms_stripe_payments_cancel'}, 'ajax_dismiss': {'wpforms_education_dismiss'}, 'field_new': {'wpforms_new_field_{$this->type}'}, 'fetch_revisions_list': {'wpforms_get_form_revisions'}, 'generate_url': {'wpforms_connect_url'}, 'ajax_submit': {'wpforms_submit', 'nopriv_wpforms_submit'}, 'dismiss': {'wpforms_dismiss_ai_form', 'wpforms_notification_dismiss', 'wpforms_woocommerce_dismiss'}, 'wpforms_verify_ssl': {'wpforms_verify_ssl'}, 'get_field_preview': {'wpforms_get_ai_form_field_preview'}, 'wpforms_update_form_template': {'wpforms_update_form_template'}, 'wpforms_recreate_tables': {'wpforms_recreate_tables'}, 'wpforms_ajax_search_pages_for_dropdown': {'wpforms_ajax_search_pages_for_dropdown'}, 'single_checkout_create_order_ajax': {'wpforms_paypal_commerce_create_order', 'nopriv_wpforms_paypal_commerce_create_order'}, 'save_chart_preference_settings': {'wpforms_payments_overview_save_chart_preference_settings'}, 'get_embed_page_url_ajax': {'wpforms_admin_form_embed_wizard_embed_page_url'}, 'install': {'wpforms_icon_choices_install'}, 'ajax_remove_user_template': {'wpforms_user_template_remove'}, 'create_subscription_order_ajax': {'nopriv_wpforms_paypal_commerce_create_subscription', 'wpforms_paypal_commerce_create_subscription'}, 'process_ajax': {'wpforms_builder_provider_ajax_{$this->core->slug}', 'wpforms_provider_ajax_$this->slug'}, 'save_order': {'wpforms_admin_forms_overview_save_columns_order'}, 'dismiss_ajax': {'wpforms_notice_dismiss'}, 'ajax_get_form_selector_options': {'wpforms_admin_get_form_selector_options'}, 'integrations_tab_disconnect': {'wpforms_settings_provider_disconnect_$this->slug'}, 'refresh_connection_manual': {'wpforms_square_refresh_connection'}, 'ajax_payments_cancel': {'wpforms_square_payments_cancel', 'wpforms_paypal_commerce_payments_cancel'}, 'ajax_lite_connect_finalize': {'wpforms_lite_connect_finalize'}, 'ajax_start_migration': {'wpforms_constant_contact_migration_prompt'}, 'wpforms_install_addon': {'wpforms_install_addon'}, 'wpforms_save_form': {'wpforms_save_form'}, 'captcha_field_callback': {'wpforms_update_field_captcha'}, 'get_form': {'wpforms_get_ai_form'}, 'engagement_callback': {'wpforms_education_pointers_engagement'}, 'handle_snapshot_ajax': {'nopriv_wpforms_analytics_snapshot', 'wpforms_analytics_snapshot'}, 'wpforms_builder_dynamic_choices': {'wpforms_builder_dynamic_choices'}, 'save_widget_meta_ajax': {'wpforms_{$widget_slug}_save_widget_meta'}, 'load_panel_content': {'wpforms_builder_load_panel'}, 'notification_from_email_validate': {'wpforms_builder_notification_from_email_validate'}, 'ajax_disconnect': {'wpforms_settings_provider_disconnect_{$this->core->slug}'}, 'preview': {'wpforms_divi_preview'}, 'send_contact_form_ajax': {'wpforms_challenge_send_contact_form'}, 'ajax_sanitize_default_email': {'wpforms_sanitize_default_email'}, 'dismiss_callback': {'wpforms_education_pointers_dismiss'}, 'ajax_payment_refund': {'wpforms_paypal_commerce_payments_refund', 'wpforms_square_payments_refund'}, 'reset': {'wpforms_ai_form_editor_reset'}, 'use_form': {'wpforms_use_ai_form'}, 'ajax_toggle_write': {'wpforms_ai_mcp_toggle_write'}, 'settings_cta_dismiss': {'wpforms_lite_settings_upgrade'}, 'process': {'wpforms_ai_form_editor_process', 'nopriv_wpforms_connect_process'}, 'ajax_single_payment_refund': {'wpforms_stripe_payments_refund'}, 'ajax_sanitize_restricted_rules': {'wpforms_sanitize_restricted_rules'}, 'ajax_check_restricted_email': {'wpforms_restricted_email', 'nopriv_wpforms_restricted_email'}, 'get_chart_dataset_data': {'wpforms_payments_overview_refresh_chart_dataset_data'}, 'ajax_update_lite_connect_enabled_setting': {'wpforms_update_lite_connect_enabled_setting'}, 'save_challenge_option_ajax': {'wpforms_challenge_save_option'}, 'ajax_check_plugin_status': {'wpforms_page_check_{$plugin}_status'}, 'mark_panel_viewed': {'wpforms_mark_panel_viewed'}, 'wpforms_new_form': {'wpforms_new_form'}, 'delete_tags': {'wpforms_admin_forms_overview_delete_tags'}, 'import_form': {'wpforms_import_form_{$this->slug}'}, 'integrations_tab_add': {'wpforms_settings_provider_add_$this->slug'}, 'save_internal_information_checkbox': {'wpforms_builder_save_internal_information_checkbox'}, 'ajax_handle_auth': {'wpforms_constant_contact_popup_auth'}, 'ajax_connect': {'wpforms_settings_provider_add_{$this->core->slug}'}, 'wpforms_deactivate_addon': {'wpforms_deactivate_addon'}, 'get_choices': {'wpforms_get_ai_choices'}, 'wpforms_activate_addon': {'wpforms_activate_addon'}, 'ajax_get_token': {'nopriv_wpforms_get_token', 'wpforms_get_token'}, 'ajax_get_templates_batch': {'wpforms_get_templates_batch'}, 'wpforms_builder_dynamic_source': {'wpforms_builder_dynamic_source'}}
*
***/
...
/** Function subscription_processor_create_ajax() called by wp_ajax hooks: {'wpforms_paypal_commerce_subscription_processor_create', 'nopriv_wpforms_paypal_commerce_subscription_processor_create'} **/
...
/** Function process_ajax() called by wp_ajax hooks: {'wpforms_builder_provider_ajax_{$this->core->slug}', 'wpforms_provider_ajax_$this->slug'} **/
...
/** Function ajax_payments_cancel() called by wp_ajax hooks: {'wpforms_square_payments_cancel', 'wpforms_paypal_commerce_payments_cancel'} **/
/** No params detected :-/ **/
...
/** Function handle_snapshot_ajax() called by wp_ajax hooks: {'nopriv_wpforms_analytics_snapshot', 'wpforms_analytics_snapshot'} **/
/** No params detected :-/ **/
...
/** Function process() called by wp_ajax hooks: {'wpforms_ai_form_editor_process', 'nopriv_wpforms_connect_process'} **/
...
/** Function ajax_get_token() called by wp_ajax hooks: {'nopriv_wpforms_get_token', 'wpforms_get_token'} **/
/** No params detected :-/ **/
