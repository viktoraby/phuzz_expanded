...
*Overview: {'create_setup_intent_ajax': {'create_setup_intent', 'nopriv_create_setup_intent'}, 'disable_auto_renew': {'wcs_disable_auto_renew'}, 'ajax_tracks': {'platform_tracks', 'nopriv_platform_tracks', 'jetpack_tracks'}, 'save_increased_price_lock': {'wcs_order_price_lock'}, 'enable_auto_renew': {'wcs_enable_auto_renew'}, 'save_upe_appearance_ajax': {'save_upe_appearance', 'nopriv_save_upe_appearance'}, 'add_wc_price_args_filter_for_ajax': {'wc_bookings_calculate_costs', 'nopriv_wc_bookings_calculate_costs'}, '::check_product_variations_for_syncd_or_trial': {'wcs_product_has_trial_or_is_synced'}, '::remove_variations': {'woocommerce_remove_variations', 'woocommerce_remove_variation'}, 'validate_variation_deletion': {'wcs_validate_variation_deletion'}, '::maybe_update_one_time_shipping_on_variation_edits': {'wcs_update_one_time_shipping'}, 'update_order_status': {'update_order_status', 'nopriv_update_order_status'}, '::ajax_upgrade': {'wcs_upgrade'}, 'show_error_notice': {'woopay_express_checkout_button_show_error_notice', 'nopriv_woopay_express_checkout_button_show_error_notice'}, 'theme_edit_ajax': {'edit-theme-plugin-file'}, 'get_customer_orders': {'wcs_get_customer_orders'}, 'plugin_edit_ajax': {'edit-theme-plugin-file'}}
*
***/

/** Function create_setup_intent_ajax() called by wp_ajax hooks: {'create_setup_intent', 'nopriv_create_setup_intent'} **/
/** No params detected :-/ **/
...
/** Function ajax_tracks() called by wp_ajax hooks: {'platform_tracks', 'nopriv_platform_tracks', 'jetpack_tracks'} **/
...
/** Function save_upe_appearance_ajax() called by wp_ajax hooks: {'save_upe_appearance', 'nopriv_save_upe_appearance'} **/
