...
*Overview: {'ThemeisleSDK\\Modules\\Notification::dismiss': {'themeisle_sdk_dismiss_notice'}, 'fetch_logs_ajax_handler': {'optml_fetch_logs'}, 'dismiss': {'themeisle_sdk_dismiss_notice'}, 'dismiss_promotion': {'tisdk_update_option'}, 'disable_notification_ajax': {'themeisle_sdk_dismiss_black_friday_notice'}, 'dismiss_license_notice': {'themeisle_sdk_dismiss_license_notice'}, 'replace_file': {'optml_replace_file'}, 'dismiss_notice': {'optml_dismiss_conflict_notice'}}
*
***/
