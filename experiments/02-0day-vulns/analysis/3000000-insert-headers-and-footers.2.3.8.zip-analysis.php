...
*Overview: {'process': {'nopriv_wpcode_connect_process'}, 'wpcode_filter_snippets_by_type': {'wpcode_filter_snippets_by_type'}, 'wpcode_save_preview_css': {'wpcode_save_preview_css'}, 'dismiss': {'wpcode_notification_dismiss'}, 'wpcode_verify_ssl': {'wpcode_verify_ssl'}, 'wpcode_sync_snippet': {'wpcode_sync_snippet'}, 'wpcode_ajax_install_pack': {'wpcode_install_pack'}, 'dismiss_ajax': {'wpcode_notice_dismiss'}, 'delete_auth': {'wpcode_library_delete_auth'}, 'wpcode_save_editor_height': {'wpcode_save_editor_height'}, 'wpcode_get_shortcode_locations': {'wpcode_get_shortcode_locations'}, 'wpcode_set_preview_css': {'wpcode_set_preview_css'}, 'wpcode_ajax_remove_pack': {'wpcode_remove_pack'}, 'wpcode_search_terms': {'wpcode_search_terms'}, 'store_auth_key': {'wpcode_library_store_auth'}, 'wpcode_generate_snippet': {'wpcode_generate_snippet'}, 'wpcode_save_generated_snippet': {'wpcode_save_generated_snippet'}, 'wpcode_update_snippet_status': {'wpcode_update_snippet_status'}, 'wpcode_ajax_toggle_pack_option': {'wpcode_toggle_pack_option'}, 'generate_url': {'wpcode_connect_url'}, 'install_plugin': {'wpcode_install_plugin'}, 'import_snippet': {'wpcode_import_snippet_{$this->slug}'}, 'wpcode_clear_preview_css': {'wpcode_clear_preview_css'}, 'wpcode_ajax_add_pack_option': {'wpcode_add_pack_option'}}
*
***/
