...
*Overview: {'create_temp_user_ajax_call': {'sbi_create_temp_user'}, 'sbi_clear_image_resize_cache': {'sbi_clear_image_resize_cache'}, 'sbi_do_locator': {'nopriv_sbi_do_locator', 'sbi_do_locator'}, 'sbi_dpa_reset': {'sbi_dpa_reset'}, 'disable_facebook_oembed_from_instagram': {'disable_facebook_oembed_from_instagram'}, 'InstagramFeed\\Builder\\SBI_Feed_Saver_Manager': {'sbi_feed_saver_manager_clear_single_feed_cache', 'sbi_feed_saver_manager_get_feed_settings', 'sbi_feed_saver_manager_importer', 'sbi_feed_saver_manager_delete_source', 'sbi_update_personal_account', 'sbi_feed_saver_manager_fly_preview', 'sbi_feed_saver_manager_clear_comments_cache', 'sbi_feed_saver_manager_recache_feed', 'sbi_feed_saver_manager_get_locations_page', 'sbi_feed_saver_manager_retrieve_comments', 'sbi_feed_saver_manager_get_feed_list_page', 'sbi_feed_saver_manager_duplicate_feed', 'sbi_feed_saver_manager_builder_update', 'sbi_feed_saver_manager_delete_feeds'}, 'InstagramFeed\\Builder\\SBI_Source': {'sbi_source_builder_update', 'sbi_source_builder_update_multiple', 'sbi_source_get_page'}, 'sbi_retry_db': {'sbi_retry_db'}, 'sbi_recheck_connection': {'sbi_recheck_connection'}, 'sbi_deactivate_license': {'sbi_deactivate_license'}, 'dismiss_upgrade_notice': {'sbi_dismiss_upgrade_notice'}, 'sbi_activate_addon': {'sbi_activate_addon'}, 'sbi_clear_error_log': {'sbi_clear_error_log'}, 'sbi_process_submitted_resize_ids': {'nopriv_sbi_resized_images_submit', 'sbi_resized_images_submit'}, 'sbi_check_license': {'sbi_check_license'}, 'InstagramFeed\\Builder\\SBI_Feed_Builder': {'sbi_other_plugins_modal', 'sbi_dismiss_onboarding'}, 'sbi_test_connection': {'sbi_test_connection'}, 'sbi_get_next_post_set': {'sbi_load_more_clicked', 'nopriv_sbi_load_more_clicked'}, 'sbi_activate_license': {'sbi_activate_license'}, 'dismiss': {'sbi_dashboard_notification_dismiss'}, 'sbi_import_settings_json': {'sbi_import_settings_json'}, 'handle_unused_feed_usage': {'sbi_reset_unused_feed_usage'}, 'disable_instagram_oembed_from_instagram': {'disable_instagram_oembed_from_instagram'}, 'InstagramFeed\\Admin\\SBI_Upgrader': {'sbi_maybe_upgrade_redirect', 'nopriv_sbi_run_one_click_upgrade'}, 'review_notice_consent': {'sbi_review_notice_consent_update'}, 'process_wizard_data': {'sbi_feed_saver_manager_process_wizard'}, 'sbi_deactivate_addon': {'sbi_deactivate_addon'}, 'dismiss_wizard': {'sbi_feed_saver_manager_dismiss_wizard'}, 'sbi_export_settings_json': {'sbi_export_settings_json'}, 'sbi_install_addon': {'sbi_install_addon'}, 'delete_temp_user_ajax_call': {'sbi_delete_temp_user'}, 'handle_ajax': {'sb_deactivation_feedback', 'sb_feature_suggestion'}, 'get_api_calls_handler': {'sbi_get_api_calls_handler'}, 'preview': {'sb_instagramfeed_divi_preview'}, 'ajax_record_session': {'sbi_smash_usage_record_session'}, 'install_plugin': {'am_recommended_block_install'}, 'sbi_dismiss_critical_notice': {'sbi_dismiss_critical_notice'}, 'sbi_save_settings': {'sbi_save_settings'}, 'ajax_record_event': {'sbi_smash_usage_record_event'}, 'sbi_reset_log': {'sbi_reset_log'}, 'sbi_clear_cache': {'sbi_clear_cache'}}
*
***/
...
/** Function InstagramFeed\Builder\SBI_Feed_Saver_Manager() called by wp_ajax hooks: {'sbi_feed_saver_manager_clear_single_feed_cache', 'sbi_feed_saver_manager_get_feed_settings', 'sbi_feed_saver_manager_importer', 'sbi_feed_saver_manager_delete_source', 'sbi_update_personal_account', 'sbi_feed_saver_manager_fly_preview', 'sbi_feed_saver_manager_clear_comments_cache', 'sbi_feed_saver_manager_recache_feed', 'sbi_feed_saver_manager_get_locations_page', 'sbi_feed_saver_manager_retrieve_comments', 'sbi_feed_saver_manager_get_feed_list_page', 'sbi_feed_saver_manager_duplicate_feed', 'sbi_feed_saver_manager_builder_update', 'sbi_feed_saver_manager_delete_feeds'} **/
/** No function found :-/ **/


/** Function InstagramFeed\Builder\SBI_Source() called by wp_ajax hooks: {'sbi_source_builder_update', 'sbi_source_builder_update_multiple', 'sbi_source_get_page'} **/
/** No function found :-/ **/
