...
class Fuzzer:
    def __init__(self, fuzzer_id):
        ...
        self.ldapi_errors_folder = os.path.join(
            "/shared-tmpfs/", "ldapi-error-reports")
        self.ssti_errors_folder = os.path.join(
            "/shared-tmpfs/", "ssti-error-reports")
        self.httphi_errors_folder = os.path.join(
            "/shared-tmpfs/", "httphi-error-reports")
        self.ssrf_errors_folder = os.path.join(
            "/shared-tmpfs/", "ssrf-error-reports")
        self.nosqli_errors_folder = os.path.join(
            "/shared-tmpfs/", "nosqli-error-reports")
        ...
        self.vulnchecker = ParamBasedVulnChecker(
            ...
            ldapi_errors_folder=self.ldapi_errors_folder,
            ssti_errors_folder=self.ssti_errors_folder,
            httphi_errors_folder=self.httphi_errors_folder,
            ssrf_errors_folder=self.ssrf_errors_folder,
            nosqli_errors_folder=self.nosqli_errors_folder
            )
        ### 
